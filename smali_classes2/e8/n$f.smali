...
.method public constructor <init>(Le8/n;)V
    ...
    invoke-static {p1}, Le8/n;->Ol(Le8/n;)Lcom/android/camera/panorama/MorphoPanoramaGP3;
    ...
    invoke-interface {v0}, Lv8/c2;->Ye()Landroid/view/ViewGroup;

    move-result-object v5

    iget v6, p1, Le8/d0;->q1:I

    invoke-static {p1}, Le8/n;->Vl(Le8/n;)Lcom/android/camera/panorama/direction/DirectionFunction;
    ...
    invoke-static {p1}, Le8/n;->Pl(Le8/n;)I

    move-result v8

    invoke-static {p1}, Le8/n;->Rl(Le8/n;)I
...
.method public static synthetic a(Landroid/graphics/Point;IIILv8/c2;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Le8/n$f;->j(Landroid/graphics/Point;IIILv8/c2;)V
...
.method public static synthetic c(Le8/n$f;Lv8/c2;)V
    .locals 0

    invoke-direct {p0, p1}, Le8/n$f;->l(Lv8/c2;)V
...
.method public static synthetic e(Le8/n$f;ILv8/c2;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Le8/n$f;->k(ILv8/c2;)V
...
.method public static synthetic j(Landroid/graphics/Point;IIILv8/c2;)V
    .locals 0
    ...
    invoke-interface {p4, p0, p1}, Lv8/c2;->R1(Landroid/graphics/Point;I)V
    ...
    invoke-interface {p4, p0, p1}, Lv8/c2;->h1(ZI)V
    ...
    invoke-interface {p4, p0, p0}, Lv8/c2;->h1(ZI)V

    :goto_0
    return-void
.end method

.method private synthetic k(ILv8/c2;)V
    .locals 1

    iget-object v0, p0, Le8/n$f;->e:Le8/n;

    invoke-static {v0}, Le8/n;->Tl(Le8/n;)I

    move-result v0

    iget p0, p0, Le8/n$f;->d:I

    invoke-interface {p2, v0, p1, p0}, Lv8/c2;->p3(III)V

    return-void
.end method

.method private synthetic l(Lv8/c2;)V
    .locals 1

    iget-object v0, p0, Le8/n$f;->e:Le8/n;

    invoke-static {v0}, Le8/n;->am(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Le8/n;->am(Le8/n;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-interface {p1, p0}, Lv8/c2;->bf(Landroid/graphics/Bitmap;)V
...
.method public final f()V
    ...
    invoke-static {v0}, Le8/n;->Yl(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1}, Le8/n;->Zl(Le8/n;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1}, Le8/n;->bm(Le8/n;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1}, Le8/n;->am(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2}, Le8/n;->am(Le8/n;)Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-direct {v1, v2}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    invoke-static {v0, v1}, Le8/n;->Fl(Le8/n;Landroid/graphics/Canvas;)Landroid/graphics/Canvas;
    ...
    invoke-static {v0, v1}, Le8/n;->Hl(Le8/n;Landroid/graphics/Paint;)Landroid/graphics/Paint;

    iget-object p0, p0, Le8/n$f;->e:Le8/n;

    invoke-static {p0}, Le8/n;->Gl(Le8/n;)Landroid/graphics/Paint;
...
.method public final g([D)Z
    ...
    invoke-static {v0}, Le8/n;->Kl(Le8/n;)Landroid/os/Handler;
...
.method public final h()I
    ...
    invoke-static {v2}, Le8/n;->Yl(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3}, Le8/n;->Yl(Le8/n;)Landroid/graphics/Bitmap;
...
.method public handleAttachImage()Z
    ...
    invoke-static {v0, v3}, Le8/n;->Dl(Le8/n;Lcom/android/camera/panorama/CaptureImage;)V
    ...
    invoke-static {v3}, Le8/n;->Ol(Le8/n;)Lcom/android/camera/panorama/MorphoPanoramaGP3;
    ...
    invoke-static {v3, v0}, Le8/n;->Il(Le8/n;Z)Z
    ...
    invoke-static {v3}, Le8/n;->Jl(Le8/n;)Landroid/os/Handler;
...
.method public final m(I)V
    ...
    invoke-static {v0}, Le8/n;->Ll(Le8/n;)Z
    ...
    invoke-static {v3}, Le8/n;->Tl(Le8/n;)I
...
.method public final n()V
    ...
    invoke-static {v0}, Le8/n;->Ol(Le8/n;)Lcom/android/camera/panorama/MorphoPanoramaGP3;

    move-result-object v0

    iget-object v1, p0, Le8/n$f;->e:Le8/n;

    invoke-static {v1}, Le8/n;->Yl(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3}, Le8/n;->am(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5}, Le8/n;->Yl(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v4}, Le8/n;->Yl(Le8/n;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Le8/n;->El(Le8/n;)Landroid/graphics/Canvas;
...
.method public final o()V
    ...
    invoke-static {v0}, Le8/n;->Ml(Le8/n;)Z
    ...
    invoke-static {v0, v3}, Le8/n;->Nl(Le8/n;Z)Z
