...
.method public static synthetic Al(Le8/n;)V
    .locals 0

    invoke-direct {p0}, Le8/n;->tm()V
...
.method public static synthetic Bl(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0}, Le8/n;->rm(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic Cl(Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0

    invoke-static {p0}, Le8/n;->pm(Ljava/util/concurrent/atomic/AtomicReference;)V

    return-void
.end method

.method public static synthetic Dl(Le8/n;Lcom/android/camera/panorama/CaptureImage;)V
    .locals 0

    invoke-virtual {p0, p1}, Le8/n;->Cm(Lcom/android/camera/panorama/CaptureImage;)V

    return-void
.end method

.method public static synthetic El(Le8/n;)Landroid/graphics/Canvas;
    .locals 0
...
.method public static synthetic Fl(Le8/n;Landroid/graphics/Canvas;)Landroid/graphics/Canvas;
    .locals 0
...
.method public static synthetic Gl(Le8/n;)Landroid/graphics/Paint;
    .locals 0
...
.method public static synthetic Hl(Le8/n;Landroid/graphics/Paint;)Landroid/graphics/Paint;
    .locals 0
...
.method public static synthetic Il(Le8/n;Z)Z
    .locals 0
...
.method public static synthetic Jl(Le8/n;)Landroid/os/Handler;
    .locals 0
...
.method public static synthetic Kl(Le8/n;)Landroid/os/Handler;
    .locals 0
...
.method public static synthetic Ll(Le8/n;)Z
    .locals 0

    invoke-virtual {p0}, Le8/n;->mm()Z
...
.method public static synthetic Ml(Le8/n;)Z
    .locals 0
...
.method public static synthetic Nl(Le8/n;Z)Z
    .locals 0
...
.method public static synthetic Ol(Le8/n;)Lcom/android/camera/panorama/MorphoPanoramaGP3;
    .locals 0
...
.method public static synthetic Pl(Le8/n;)I
    .locals 0
...
.method public static synthetic Ql(Le8/n;I)I
    .locals 0
...
.method public static synthetic Rl(Le8/n;)I
    .locals 0
...
.method public static synthetic Sl(Le8/n;I)I
    .locals 0
...
.method public static synthetic Tl(Le8/n;)I
    .locals 0
...
.method public static synthetic Ul(Le8/n;I)I
    .locals 0
...
.method public static synthetic Vl(Le8/n;)Lcom/android/camera/panorama/direction/DirectionFunction;
    .locals 0
...
.method public static synthetic Wl(Le8/n;Lcom/android/camera/panorama/direction/DirectionFunction;)Lcom/android/camera/panorama/direction/DirectionFunction;
    .locals 0
...
.method public static synthetic Xl(Le8/n;)Le8/n$c;
    .locals 0
...
.method public static synthetic Yl(Le8/n;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public static synthetic Zl(Le8/n;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public static synthetic am(Le8/n;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public static synthetic bm(Le8/n;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public static gm(J)Ljava/lang/String;
    .locals 1
...
.method public static synthetic nm(Lcom/android/camera/Camera;)V
    .locals 0
...
.method private synthetic om(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    .locals 0
    ...
    invoke-virtual {p0, p1, p2}, Le8/n;->Dm(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V

    return-void
.end method

.method public static synthetic pm(Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private synthetic qm(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Boolean;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p0, p1}, Le8/n;->jm(Landroid/media/Image;)V
...
.method public static synthetic rl(Le8/n;)V
    .locals 0
...
.method public static synthetic rm(Ljava/lang/Throwable;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic sl(Le8/n;)V
    .locals 0

    invoke-virtual {p0}, Le8/n;->Bm()V

    return-void
.end method

.method private synthetic sm(ZLv8/i2;)V
    .locals 1
    ...
    invoke-interface {p2, p1}, Lv8/i2;->aa(I)V

    goto :goto_0

    :cond_0
    invoke-interface {p2}, Lv8/i2;->Y()V
    ...
    invoke-virtual {p0}, Le8/d0;->lk()V

    invoke-interface {p2}, Lv8/i2;->U7()V

    :cond_2
    return-void
.end method

.method public static synthetic tl(Le8/n;Lv8/i2;)V
    .locals 0

    invoke-direct {p0, p1}, Le8/n;->um(Lv8/i2;)V
...
.method private synthetic tm()V
    ...
    invoke-virtual {p0, v0, v0}, Le8/n;->nl(ZZ)V

    return-void
.end method

.method public static synthetic ul(Lv8/c2;)V
    .locals 0

    invoke-static {p0}, Le8/n;->vm(Lv8/c2;)V

    return-void
.end method

.method private synthetic um(Lv8/i2;)V
    .locals 2
    ...
    invoke-static {v0, v1}, Le8/n;->em(J)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Le8/n;->wm()Lio/reactivex/disposables/Disposable;
...
.method public static synthetic vl(Le8/n;Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Le8/n;->om(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V

    return-void
.end method

.method public static synthetic vm(Lv8/c2;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Lv8/c2;->bf(Landroid/graphics/Bitmap;)V

    return-void
.end method

.method public static synthetic wl(Le8/n;)V
    .locals 0

    invoke-virtual {p0}, Le8/n;->xm()V

    return-void
.end method

.method public static synthetic xl(Le8/n;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Boolean;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Le8/n;->qm(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Boolean;)V
...
.method public static synthetic yl(Lcom/android/camera/Camera;)V
    ...
    invoke-static {p0}, Le8/n;->nm(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic zl(Le8/n;ZLv8/i2;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Le8/n;->sm(ZLv8/i2;)V
...
# virtual methods
.method public final Am([Landroid/net/Uri;Ljava/lang/String;II)Z
    .locals 20
    ...
    invoke-virtual/range {p0 .. p0}, Le8/n;->im()I
...
.method public final Bm()V
    ...
    invoke-virtual {v0, v2, v5}, Lye/d;->a(II)Z

    iget-wide v7, p0, Le8/n;->ga:J

    invoke-static {v7, v8}, Le8/n;->gm(J)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v9, v11, v12}, Le8/n;->Am([Landroid/net/Uri;Ljava/lang/String;II)Z
    ...
    invoke-virtual/range {v7 .. v12}, Le8/n;->cm(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II)V
...
.method public final Cm(Lcom/android/camera/panorama/CaptureImage;)V
    .locals 10
...
.method public final Dm(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    .locals 4
    ...
    invoke-static {v3}, Lt7/f0;->b(Lr7/m;)Lcom/android/camera/w2;

    move-result-object v3

    invoke-virtual {v1, v3}, Lya/b3;->L4(Lcom/android/camera/w2;)V
    ...
    invoke-virtual {v1, p1, v2, p0}, Lya/a;->f(ILya/a$m;Lye/n;)V
...
.method public final Em()Lio/reactivex/disposables/Disposable;
    .locals 2
    ...
    sget-object v1, Leg/i;->i:Lio/reactivex/Scheduler;
...
.method public final cm(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II)V
    .locals 19
    ...
    invoke-static/range {v9 .. v15}, Lld/d;->D(Ljava/io/FileDescriptor;ILandroid/location/Location;JI[B)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v2, v7, v3, v5, v6}, Lld/d;->E(Ljava/lang/String;ILandroid/location/Location;J)V
    ...
    iput-object v2, v1, Lk9/d$b;->j:Lcom/android/camera/fragment/beauty/e0;

    invoke-virtual {v8, v1}, Lq7/i0;->Ek(Lk9/d$b;)V

    invoke-virtual/range {p0 .. p0}, Lq7/i0;->u0()Lcom/android/camera/Camera;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Lq7/i0;->ej()Z
    ...
    invoke-static {v1, v9, v12}, Lcom/android/camera/m5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/m5;

    move-result-object v3

    invoke-static {v1, v9}, Lcom/android/camera/a6;->t(Landroid/content/Context;Landroid/net/Uri;)V

    invoke-virtual {v1}, Lcom/android/camera/ActivityBase;->q4()Lcom/android/camera/ThumbnailUpdater;

    move-result-object v1

    invoke-virtual {v1, v3, v12, v12}, Lcom/android/camera/ThumbnailUpdater;->u(Lcom/android/camera/m5;ZZ)V
    ...
    :cond_5
    invoke-virtual {v3}, Lcom/android/camera/m5;->n()Landroid/graphics/Bitmap;
...
.method public final fm(D)Z
    ...
    invoke-static {v3}, Lcom/android/camera/v2;->a5(Landroid/content/Context;)Z
...
.method public final im()I
    ...
    invoke-static {p0}, Lcom/android/camera/v2;->g0(Z)Lcom/android/camera/f3;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/android/camera/f3;->b(Z)I
...
.method public final jm(Landroid/media/Image;)V
    .locals 3
    ...
    :cond_4
    invoke-virtual {p0, p1}, Le8/n;->km(Landroid/media/Image;)Z
...
.method public final km(Landroid/media/Image;)Z
    .locals 12
    .annotation build Lh7/c;
    .end annotation
    ...
    invoke-virtual {p0, v0, v1}, Le8/n;->fm(D)Z
...
.method public nl(ZZ)V
    ...
    invoke-virtual {p0, p1}, Le8/n;->ym(Z)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide p1

    invoke-static {p1, p2}, Le8/n;->em(J)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Le8/n;->fa:Ljava/lang/String;

    invoke-virtual {p0}, Le8/n;->Em()Lio/reactivex/disposables/Disposable;
...
.method public final wm()Lio/reactivex/disposables/Disposable;
    .locals 5
    ...
    sget-object v2, Leg/i;->i:Lio/reactivex/Scheduler;
...
.method public final xm()V
    ...
    invoke-virtual {v3}, Lcom/android/camera/s;->f()V
