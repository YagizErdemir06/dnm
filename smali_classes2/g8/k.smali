...
.method public static synthetic d(Ljava/util/concurrent/atomic/AtomicInteger;Lv8/y2;)V
    .locals 0

    invoke-static {p0, p1}, Lg8/k;->i(Ljava/util/concurrent/atomic/AtomicInteger;Lv8/y2;)V

    return-void
.end method

.method public static synthetic e(Lg8/k;Lyl/c;ILandroid/content/Context;IFLv8/y2;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lg8/k;->j(Lyl/c;ILandroid/content/Context;IFLv8/y2;)V

    return-void
.end method

.method public static synthetic i(Ljava/util/concurrent/atomic/AtomicInteger;Lv8/y2;)V
    .locals 0

    invoke-interface {p1}, Lv8/y2;->getDeviceDegree()I
...
.method private synthetic j(Lyl/c;ILandroid/content/Context;IFLv8/y2;)V
    .locals 3

    invoke-interface {p6}, Lv8/y2;->getMishotTopSurface()Landroid/graphics/SurfaceTexture;
    ...
    iget-object v0, p0, Lg8/k;->b:Lyl/f;
    ...
    iput-object v0, p0, Lg8/k;->b:Lyl/f;
    ...
    invoke-direct {v0, p1, p6, v2}, Lyl/f;-><init>(Lyl/c;Landroid/graphics/SurfaceTexture;[I)V
    ...
    :cond_1
    iget-object p1, p0, Lg8/k;->b:Lyl/f;
    ...
    iget-object p0, p0, Lg8/k;->b:Lyl/f;
...
.method public b(ILyl/c;IFLandroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v7}, Lg8/h;-><init>(Lg8/k;Lyl/c;ILandroid/content/Context;IF)V
...
.method public f(Lcom/android/camera/ui/a1;)V
    ...
    sget-object v0, Lwl/e;->k:Lwl/e;

    invoke-interface {p1, v0}, Lcom/android/camera/ui/a1;->o1(Lwl/e;)V
    ...
    invoke-virtual {p1}, Lyl/e;->a()V

    iget-object p1, p0, Lg8/k;->b:Lyl/f;

    invoke-virtual {p1}, Lyl/f;->g()Z
...
.method public g(Lcom/android/camera/ui/a1;I)V
    ...
    sget-object p2, Lwl/e;->k:Lwl/e;

    invoke-interface {p1, p2}, Lcom/android/camera/ui/a1;->S0(Lwl/e;)Ldm/q;
    ...
    invoke-virtual {v0, p0}, Ldm/e;->j(Ldm/e$a;)V

    :cond_0
    const/4 p0, 0x1

    invoke-interface {p1, p2, p0}, Lcom/android/camera/ui/a1;->Y0(Lwl/e;Z)V
...
.method public getComputeMode()I
    ...
    invoke-interface {p0}, Lv8/y2;->getComputeMode()I
