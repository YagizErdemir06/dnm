...
.method public constructor <init>(Lya/c4;Lc8/a;Lya/s5;)V
    ...
    iput-object p1, p0, Lya/j4;->W:Lse/d$b;
...
.method public static synthetic j0(Lya/j4;)Lye/w;
    .locals 0

    iget-object p0, p0, Lya/j4;->L:Lye/w;
...
.method private synthetic y0()V
    ...
    invoke-virtual {v0, v1}, Lse/d;->x(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;)V
...
# virtual methods
.method public A0(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {p0}, Lya/q4;->h()Lye/n;
    ...
    invoke-virtual {p1, v2}, Lye/w;->e1(I)V

    invoke-interface {v0, p1, p2, p3, p4}, Lye/n;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    iget-object p1, p0, Lya/j4;->H:Lye/w;

    invoke-virtual {p1}, Lye/w;->s()Lye/x;

    move-result-object p1

    invoke-virtual {p1}, Lye/x;->N0()Z
    ...
    invoke-interface {p1, p2, p3, p4, v1}, Lya/a$m;->Q7(ZJI)V
...
.method public final B0([B)V
    ...
    :cond_0
    iget-object v0, p0, Lya/j4;->L:Lye/w;

    invoke-virtual {v0, p1}, Lye/w;->r0([B)V
    ...
    :cond_1
    iget-object p1, p0, Lya/j4;->L:Lye/w;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lya/j4;->A0(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lya/j4;->H:Lye/w;
    ...
    invoke-virtual {p0, v0, v1}, Lye/z;->Z(J)V
...
.method public G0()V
    ...
    sget-object v0, Leg/i;->g:Lio/reactivex/Scheduler;
...
.method public J0(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;Lye/w;)V
    .locals 7
    ...
    :cond_0
    invoke-virtual {p2}, Lye/w;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p2, v0}, Lye/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-virtual {p2}, Lye/x;->q0()Lye/z;
    ...
    :goto_0
    invoke-virtual {p2, v1}, Lye/z;->K(Z)V
    ...
    invoke-virtual {p2, v2}, Lye/z;->O(F)V
    ...
    invoke-virtual {p2, v0}, Lye/z;->V(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p0}, Lye/z;->F(Ljava/lang/String;)V
...
.method public final n0()V
    ...
    iget-object v1, p0, Lya/j4;->H:Lye/w;

    invoke-direct {v0, v1}, Lye/w;-><init>(Lye/w;)V

    iput-object v0, p0, Lya/j4;->L:Lye/w;
    ...
    invoke-direct {v0, v1}, Lye/x$b;-><init>(Lye/x;)V

    iget-object v1, p0, Lya/j4;->H:Lye/w;

    invoke-virtual {v1}, Lye/w;->o0()Z
    ...
    iget-object v2, p0, Lya/j4;->H:Lye/w;

    invoke-virtual {v2}, Lye/w;->s()Lye/x;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->D(Landroid/util/Size;)Lye/x$b;
    ...
    iget-object v3, p0, Lya/j4;->H:Lye/w;

    invoke-virtual {v3}, Lye/w;->s()Lye/x;

    move-result-object v3

    invoke-virtual {v3}, Lye/x;->r0()Landroid/util/Size;
    ...
    invoke-virtual {v0, v1}, Lye/x$b;->D(Landroid/util/Size;)Lye/x$b;

    :goto_0
    iget-object v1, p0, Lya/j4;->L:Lye/w;
    ...
    iget-object v2, p0, Lya/j4;->L:Lye/w;

    invoke-virtual {v2}, Lye/w;->s()Lye/x;

    move-result-object v2

    invoke-virtual {v2}, Lye/x;->O0()Z
    ...
    invoke-virtual {v0, v1}, Lye/x$b;->u(I)Lye/x$b;

    move-result-object v7

    invoke-virtual {v7, v4}, Lye/x$b;->q(Z)Lye/x$b;

    move-result-object v7

    const-string v8, ""

    invoke-virtual {v7, v8}, Lye/x$b;->R(Ljava/lang/String;)Lye/x$b;

    move-result-object v7

    const/4 v8, 0x1

    invoke-virtual {v7, v8}, Lye/x$b;->c(Z)Lye/x$b;
    ...
    invoke-virtual {v9}, Lye/x;->q0()Lye/z;

    move-result-object v9

    invoke-virtual {p0, v9}, Lya/j4;->q0(Lye/z;)Lye/z;

    move-result-object v9

    invoke-virtual {v7, v9}, Lye/x$b;->E(Lye/z;)Lye/x$b;

    move-result-object v7

    invoke-virtual {v7, v1}, Lye/x$b;->g(I)Lye/x$b;

    move-result-object v1

    invoke-virtual {v1, v2}, Lye/x$b;->h(I)Lye/x$b;
    ...
    invoke-virtual {v1, v5}, Lye/x$b;->T(I)Lye/x$b;
    ...
    invoke-virtual {v1, v2}, Lye/x$b;->S(I)Lye/x$b;

    move-result-object v1

    invoke-virtual {v1, v6}, Lye/x$b;->B(Z)Lye/x$b;

    iget-object v1, p0, Lya/j4;->L:Lye/w;

    invoke-virtual {v1, v4}, Lye/w;->W0(Z)V
    ...
    invoke-virtual {v1, v0}, Lye/w;->b(Lye/x;)V
    ...
    invoke-virtual {v1}, Lye/x;->I0()Z

    move-result v1

    invoke-virtual {v0, v1}, Lye/w;->I0(Z)V
    ...
    invoke-virtual {v0, v1}, Lye/w;->Z0(Z)V
    ...
    invoke-virtual {v0, v1}, Lye/w;->b1(I)V

    iget-object v0, p0, Lya/j4;->L:Lye/w;

    invoke-virtual {v0, v4}, Lye/w;->U0(Z)V

    iget-object v0, p0, Lya/j4;->L:Lye/w;

    iget p0, p0, Lya/j4;->V:I

    invoke-virtual {v0, p0}, Lye/w;->K0(I)V
...
.method public q0(Lye/z;)Lye/z;
    .locals 0

    new-instance p0, Lye/z;

    invoke-direct {p0, p1}, Lye/z;-><init>(Lye/z;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lye/z;->N(Z)Lye/z;
...
.method public r0()J
    ...
    iget-object v0, p0, Lya/j4;->H:Lye/w;
...
.method public t0()V
    ...
    invoke-virtual {v0, v3, v4}, Lye/w;->r1(J)V
    ...
    sget-object p0, Leg/i;->g:Lio/reactivex/Scheduler;
...
.method public bridge synthetic u(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lya/j4;->z0(Lye/w;)V
...
.method public w(Landroid/media/Image;I)V
    ...
    invoke-static {v0, p1, v1, v2}, Lte/d;->m(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
