...
.method public static synthetic H1(Lib/q;Lye/w;)V
    .locals 0

    invoke-virtual {p0, p1}, Lib/q;->N1(Lye/w;)V
...
.method public final N1(Lye/w;)V
    .locals 5
    ...
    invoke-virtual {p1, v0}, Lye/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {p1}, Lye/w;->G()Landroid/hardware/camera2/CaptureResult;

    move-result-object v0

    check-cast v0, Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {p0, v0, p1}, Lib/d;->r1(Landroid/hardware/camera2/TotalCaptureResult;Lye/w;)V
    ...
    invoke-virtual {p1, v0}, Lye/w;->r0([B)V
    ...
    invoke-interface {v0, p1, p0, v1, v1}, Lye/n;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final O1(ZI)V
    ...
    invoke-interface {p2, p1, v2, v3, v1}, Lya/a$m;->Q7(ZJI)V
...
.method public f()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-direct {v7, v6}, Lcom/android/camera/w2;-><init>(Landroid/util/Size;)V

    iput-object v7, p0, Lya/x4;->A:Lcom/android/camera/w2;
    ...
    iget-object v7, p0, Lya/x4;->A:Lcom/android/camera/w2;

    invoke-virtual {v6, v7}, Lya/c3;->O5(Lcom/android/camera/w2;)Z
    ...
    invoke-direct {v3}, Lcom/android/camera/fragment/beauty/e0;-><init>()V

    const-string v4, "i:0"

    iput-object v4, v3, Lcom/android/camera/fragment/beauty/e0;->a:Ljava/lang/String;

    invoke-static {v2}, Lya/g;->v(Lya/f;)Ljava/util/HashSet;

    move-result-object v4

    invoke-static {v0, v4, v3}, Lcom/android/camera2/compat/MiCameraCompat;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/e0;)V
...
.method public w(Landroid/media/Image;I)V
    ...
    invoke-virtual {v0, v1, v2}, Lib/n;->o(J)Lye/w;
    ...
    invoke-virtual {v0, v2, p2}, Lye/w;->a([BI)V
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lib/q;->N1(Lye/w;)V
