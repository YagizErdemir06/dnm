...
.method public static synthetic I0(Lib/d;)Lye/w;
    .locals 0

    iget-object p0, p0, Lib/d;->K:Lye/w;
...
.method public static synthetic s0(Lib/d;Lye/w;I)Z
    .locals 0

    invoke-virtual {p0, p1, p2}, Lib/d;->j1(Lye/w;I)Z
...
.method public final Z0()V
    ...
    iget-object v1, p0, Lib/d;->H:Lye/w;

    invoke-direct {v0, v1}, Lye/w;-><init>(Lye/w;)V

    iput-object v0, p0, Lib/d;->K:Lye/w;
    ...
    iget-object v1, p0, Lib/d;->K:Lye/w;
    ...
    iget-object v2, p0, Lib/d;->K:Lye/w;
    ...
    invoke-virtual {v7, v3}, Lye/x$b;->q(Z)Lye/x$b;
    ...
    invoke-virtual {v1, v4}, Lye/x$b;->h(I)Lye/x$b;

    move-result-object v1

    invoke-virtual {v1, v2}, Lye/x$b;->n(I)Lye/x$b;
    ...
    invoke-virtual {v1, v3}, Lye/w;->W0(Z)V
    ...
    iget-object v0, p0, Lib/d;->K:Lye/w;
    ...
    invoke-virtual {v0, v8}, Lye/w;->Y0(Z)V

    iget-object p0, p0, Lib/d;->K:Lye/w;

    invoke-virtual {p0, v3}, Lye/w;->U0(Z)V
...
.method public c1()J
    ...
    iget-object v0, p0, Lib/d;->H:Lye/w;
    ...
    :cond_0
    iget-object p0, p0, Lib/d;->H:Lye/w;
...
.method public d1()V
    ...
    invoke-interface {v0, v4, v2, v3, v1}, Lya/a$m;->Q7(ZJI)V
...
.method public final j1(Lye/w;I)Z
    .locals 0
...
.method public k1(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    iget-object p1, p0, Lib/d;->H:Lye/w;
...
.method public final l1([BLjava/lang/String;)V
    ...
    iget-object v2, p0, Lib/d;->H:Lye/w;
    ...
    iget-object v3, p0, Lib/d;->H:Lye/w;
    ...
    invoke-virtual {v0, p1, v1}, Lye/w;->s0([BI)V
    ...
    invoke-virtual {v0, p1, v2}, Lye/w;->s0([BI)V

    :goto_0
    iget-object v0, p0, Lib/d;->H:Lye/w;

    invoke-virtual {v0, v1}, Lye/w;->Y0(Z)V
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lib/d;->k1(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public final m1([BI)V
    ...
    invoke-virtual {v0, p1, p2}, Lye/w;->a([BI)V
    ...
    :cond_1
    iget-object p1, p0, Lib/d;->K:Lye/w;

    const/4 p2, 0x0

    invoke-virtual {p0, p1, p2, p2, p2}, Lib/d;->k1(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public r1(Landroid/hardware/camera2/TotalCaptureResult;Lye/w;)V
    .locals 7
    ...
    :cond_3
    invoke-virtual {p2, v2}, Lye/z;->V(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1}, Lye/z;->F(Ljava/lang/String;)V
...
.method public w(Landroid/media/Image;I)V
    ...
    invoke-virtual {v0, v5, v6}, Lye/w;->r1(J)V
    ...
    invoke-static {v0, p1, v9, v8}, Lte/d;->m(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v4, p0, Lib/d;->H:Lye/w;
    ...
    invoke-static {v0, p1, v4, v8}, Lte/d;->m(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v10, p0, Lib/d;->H:Lye/w;

    invoke-virtual {v10}, Lye/w;->v()J
