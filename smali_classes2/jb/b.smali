...
.method public q(Ljb/c;Lye/w;)[B
    ...
    invoke-static/range {v25 .. v25}, Lld/d;->k([B)Lld/e;
    ...
    invoke-virtual {v3, v5, v8}, Lld/e;->E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v8, v5}, Lld/e;->E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v1, v2}, Lld/e;->E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v3}, Lld/d;->G([BLld/e;)[B
    ...
    invoke-static {v12, v2}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I

    move-result v14

    invoke-static {v12, v13}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I
    ...
    invoke-static {v1, v12}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I

    move-result v5

    invoke-static {v1, v13}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I
    ...
    invoke-static {v2, v13}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I
    ...
    invoke-virtual/range {p2 .. p2}, Lye/x;->a0()I

    move-result v0

    invoke-virtual/range {p2 .. p2}, Lye/x;->Z()Landroid/graphics/Rect;

    move-result-object v1

    invoke-virtual/range {p2 .. p2}, Lye/x;->X()Z

    move-result v3

    invoke-virtual/range {p2 .. p2}, Lye/x;->Y()Z

    move-result v5

    invoke-static {v2, v0, v1, v3, v5}, Lcom/android/camera/h6;->a(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    invoke-interface {v6, v7, v8, v0}, Ld/g;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-static {v1, v5, v6}, Lcom/android/camera/g6;->f(Ljava/io/InputStream;Ljava/io/OutputStream;Ld/g;)Z
    ...
    invoke-static {v0, v5, v6}, Lcom/android/camera/a6;->h5(Ljava/io/File;Ljava/io/ByteArrayOutputStream;I)V
...
.method public r(Ljb/c;Lye/w;)[B
    ...
    invoke-virtual {p0, p1, p2}, Ljb/b;->q(Ljb/c;Lye/w;)[B
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Ljb/b;->s(Ljb/c;Lye/w;)[B
...
.method public s(Ljb/c;Lye/w;)[B
    ...
    invoke-virtual/range {p1 .. p1}, Ljb/c;->j()Lye/z;

    move-result-object v8

    invoke-virtual {v8}, Lye/z;->r()Z
    ...
    invoke-static/range {v17 .. v17}, Lld/d;->k([B)Lld/e;
    ...
    invoke-virtual {v10, v15, v14}, Lld/e;->E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v14, v15}, Lld/e;->E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v14, v10}, Lld/d;->G([BLld/e;)[B
    ...
    invoke-static {v11, v10}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I

    move-result v15

    invoke-static {v11, v14}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I
    ...
    invoke-static {v7, v11}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I

    move-result v0

    invoke-static {v7, v14}, Lcom/android/camera/a6;->i1(Ljava/io/File;I)I
    ...
    invoke-static {v7, v0, v1, v2, v3}, Lcom/android/camera/h6;->a(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    invoke-interface {v5, v6, v7, v0}, Ld/g;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-static {v1, v4, v5}, Lcom/android/camera/g6;->f(Ljava/io/InputStream;Ljava/io/OutputStream;Ld/g;)Z
    ...
    invoke-static {v0, v4, v5}, Lcom/android/camera/a6;->h5(Ljava/io/File;Ljava/io/ByteArrayOutputStream;I)V
