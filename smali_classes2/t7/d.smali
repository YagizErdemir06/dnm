...
.method public static synthetic d(Lq7/l2;)V
    .locals 0

    invoke-static {p0}, Lt7/d;->j(Lq7/l2;)V
...
.method public static synthetic j(Lq7/l2;)V
    .locals 0
...
.method public a([BIIZZLc8/a;)V
    ...
    invoke-direct {p0, v0}, Lt7/c;-><init>(Lq7/l2;)V
...
.method public final f(Ljava/lang/Object;IIZZ)V
    ...
    :cond_0
    invoke-virtual {v14}, Lq7/i0;->Ah()Lr7/m;
    ...
    invoke-virtual {v14}, Lq7/l2;->jn()Z
    ...
    invoke-virtual {v14}, Lq7/i0;->Se()Lr7/b;
    ...
    invoke-interface {v1, v2, v3}, Lv8/w2;->be(ZI)I
    ...
    invoke-virtual {v14}, Lq7/i0;->U()I

    move-result v16

    invoke-static/range {v16 .. v16}, Lcom/android/camera/v2;->q3(I)Z
    ...
    invoke-virtual {v4, v5}, Lid/b;->G8(I)Z
    ...
    invoke-static {v0, v5, v7}, Lld/d;->H([BLld/e;[B)[B
    ...
    invoke-virtual {v14, v3}, Lq7/l2;->Hm(I)I
    ...
    iget-object v5, v14, Lq7/l2;->Ga:Lw7/f;
    ...
    iget-boolean v5, v14, Lq7/l2;->p6:Z
    ...
    invoke-virtual {v14}, Lq7/l2;->Bm()Lt7/s;
    ...
    invoke-direct/range {v25 .. v32}, Lye/w;-><init>(IJILjava/lang/String;J)V

    iget-object v2, v14, Lq7/l2;->Ga:Lw7/f;

    iget-boolean v2, v2, Lw7/f;->e:Z

    if-nez v2, :cond_e

    iget-boolean v2, v14, Lq7/l2;->p6:Z

    if-nez v2, :cond_e

    iget-boolean v2, v14, Lq7/l2;->na:Z
    ...
    :goto_9
    invoke-virtual {v4, v6}, Lye/w;->Y0(Z)V

    const/4 v2, 0x0

    invoke-virtual {v4, v0, v2}, Lye/w;->a([BI)V

    invoke-virtual {v4, v11}, Lye/w;->Z0(Z)V

    move/from16 v0, v23

    invoke-virtual {v4, v0}, Lye/w;->q1(Z)V

    move/from16 v0, v18

    invoke-virtual {v4, v0}, Lye/w;->W0(Z)V
    ...
    invoke-direct {v0, v2, v5, v6, v3}, Lye/x$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    :goto_a
    invoke-virtual {v0, v6}, Lye/x$b;->P(Z)Lye/x$b;

    invoke-virtual {v0, v1}, Lye/x$b;->C(I)Lye/x$b;
    ...
    invoke-virtual {v0, v1}, Lye/x$b;->L(F)Lye/x$b;
    ...
    invoke-virtual {v0, v1}, Lye/x$b;->K(I)Lye/x$b;
    ...
    invoke-virtual {v0, v1}, Lye/x$b;->w(Landroid/location/Location;)Lye/x$b;

    move-result-object v0

    move/from16 v1, v22

    invoke-virtual {v0, v1}, Lye/x$b;->h(I)Lye/x$b;

    move-result-object v0

    move/from16 v1, v21

    invoke-virtual {v0, v1}, Lye/x$b;->T(I)Lye/x$b;
    ...
    invoke-virtual {v0, v1}, Lye/x$b;->S(I)Lye/x$b;

    move-result-object v0

    invoke-virtual {v0, v12}, Lye/x$b;->n(I)Lye/x$b;

    move-result-object v0

    move/from16 v1, v17

    invoke-virtual {v0, v1}, Lye/x$b;->B(Z)Lye/x$b;

    move-result-object v0

    invoke-virtual {v0, v10}, Lye/x$b;->c(Z)Lye/x$b;

    move-result-object v0

    const/4 v1, 0x1

    invoke-virtual {v14, v1}, Lq7/l2;->Im(Z)Lye/z;

    move-result-object v2

    invoke-virtual {v0, v2}, Lye/x$b;->E(Lye/z;)Lye/x$b;

    move-result-object v0

    move/from16 v12, v24

    invoke-virtual {v0, v12}, Lye/x$b;->z(Z)Lye/x$b;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->Q(Ljava/lang/String;)Lye/x$b;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->o(Z)Lye/x$b;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->k(Lcom/android/camera/effect/renders/f;)Lye/x$b;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->p(Z)Lye/x$b;

    move-result-object v0

    invoke-virtual {v0, v7}, Lye/x$b;->g(I)Lye/x$b;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->i(Z)Lye/x$b;
    ...
    invoke-virtual {v0, v2}, Lye/x$b;->j(Z)Lye/x$b;

    move-result-object v0

    invoke-virtual {v14}, Lq7/l2;->vm()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lye/x$b;->f(J)Lye/x$b;
    ...
    invoke-virtual {v4, v0}, Lye/w;->b(Lye/x;)V
    ...
    invoke-virtual {v4, v1}, Lye/w;->k1(Z)V

    :cond_11
    invoke-virtual {v14}, Lq7/i0;->u0()Lcom/android/camera/Camera;
    ...
    invoke-virtual {v0, v4, v1, v1, v1}, Ll9/h;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final g(Landroid/graphics/Bitmap;ZZZIZ)[B
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/f3;->b(Z)I
...
.method public final h([BZZZIZZ)[B
    ...
    :cond_3
    invoke-virtual {v2}, Lq7/i0;->Se()Lr7/b;
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/camera/a6;->a0(Landroid/graphics/Bitmap;FZFZZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0, v8}, Lcom/android/camera/f3;->b(Z)I
