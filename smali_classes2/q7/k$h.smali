...
.method public constructor <init>(Lq7/k;)V
    ...
    iput-object v0, p0, Lq7/k$h;->a:Ljava/lang/ref/WeakReference;
...
.method public A3(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lq7/k$h;->a(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)V
...
.method public final a(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    iget-object p0, p0, Lq7/k$h;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p0}, Lq7/k;->Jl(Lq7/k;)I
    ...
    invoke-static {p0}, Lq7/k;->Kl(Lq7/k;)I
    ...
    invoke-static {p0}, Lq7/k;->Ll(Lq7/k;)I
    ...
    :cond_2
    invoke-static {p0}, Lq7/k;->Nl(Lq7/k;)I

    if-eqz p2, :cond_3

    invoke-static {p0, p2}, Lq7/k;->Gl(Lq7/k;Landroid/hardware/camera2/CaptureResult;)Landroid/hardware/camera2/CaptureResult;

    :cond_3
    invoke-static {p0}, Lq7/k;->cl(Lq7/k;)Z
    ...
    :cond_4
    invoke-static {p0}, Lq7/k;->dl(Lq7/k;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {p0}, Lq7/k;->el(Lq7/k;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {p0}, Lq7/k;->gl(Lq7/k;)I

    invoke-static {p0}, Lq7/k;->hl(Lq7/k;)Z
    ...
    invoke-static {p0}, Lq7/k;->fl(Lq7/k;)I
    ...
    invoke-static {p0}, Lq7/k;->il(Lq7/k;)Lq7/k$f;

    move-result-object p2

    if-eqz p2, :cond_7

    invoke-static {p0}, Lq7/k;->Ml(Lq7/k;)I
