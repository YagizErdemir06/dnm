...
.method public static synthetic a(Lev/j0;Ljava/lang/String;[B)V
    .locals 0

    invoke-static {p0, p1, p2}, Li7/c;->b(Lev/j0;Ljava/lang/String;[B)V

    return-void
.end method

.method public static b(Lev/j0;Ljava/lang/String;[B)V
    .locals 2

    const-class v0, Lev/p1;
    ...
    check-cast v0, Lev/p1;

    if-nez v0, :cond_0

    invoke-static {}, Lev/p1;->E()Lev/p1;
    ...
    :cond_0
    invoke-static {}, Lev/p0;->n()Ljava/lang/String;
    ...
    invoke-static {p2}, Lev/p0;->m([B)Lev/p0;
    ...
    :cond_1
    invoke-static {}, Lev/q0;->n()Ljava/lang/String;
    ...
    invoke-static {p2}, Lev/q0;->m([B)Lev/q0;
    ...
    invoke-static {v0, p0, p1}, Lev/s0;->w(Lev/s0;Ljava/lang/Class;Ljava/lang/String;)Lev/c;
...
.method public static c(Landroid/media/MediaMetadataRetriever;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Lcom/android/camera/w2;[Landroid/graphics/Bitmap;)V
    .locals 2
    ...
    iget v1, p3, Lcom/android/camera/w2;->b:I
    ...
    invoke-direct {p3, v0, v1}, Lcom/android/camera/w2;-><init>(II)V
    ...
    iget p2, p3, Lcom/android/camera/w2;->a:I

    iget p3, p3, Lcom/android/camera/w2;->b:I

    invoke-static {p0, p1, p2, p3}, Lcom/android/camera/m5;->h(Landroid/media/MediaMetadataRetriever;Ljava/io/FileDescriptor;II)Landroid/graphics/Bitmap;
    ...
    :cond_2
    iget p1, p3, Lcom/android/camera/w2;->a:I

    iget p3, p3, Lcom/android/camera/w2;->b:I

    invoke-static {p0, p2, p1, p3}, Lcom/android/camera/m5;->i(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public static d(Ljava/io/File;)Lev/p1;
    .locals 1
    ...
    :try_start_1
    invoke-static {p0}, Li7/c;->e(Lbv/d;)Lev/p1;
...
.method public static e(Lbv/d;)Lev/p1;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static f(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5}, Li7/c;->d(Ljava/io/File;)Lev/p1;
    ...
    invoke-static {p0, v5, v6}, Lev/s0;->x(Lev/s0;Ljava/lang/Class;[Ljava/lang/String;)Lev/c;
...
.method public static g(Ljava/lang/String;Ljava/util/List;J)V
    ...
    invoke-virtual {p0, p2, p3}, Lhv/e;->c(Ljava/io/File;Lhv/c;)V
    :try_end_0
