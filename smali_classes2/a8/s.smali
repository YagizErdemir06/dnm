...
.method public static synthetic a([Lya/f3;Lv7/e;Lq7/i0;Landroid/graphics/Rect;Lv8/n1;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, La8/s;->d([Lya/f3;Lv7/e;Lq7/i0;Landroid/graphics/Rect;Lv8/n1;)V

    return-void
.end method

.method public static synthetic b([Lya/f3;Lq7/i0;Landroid/graphics/Rect;Lv8/x2;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, La8/s;->c([Lya/f3;Lq7/i0;Landroid/graphics/Rect;Lv8/x2;)V

    return-void
.end method

.method public static synthetic c([Lya/f3;Lq7/i0;Landroid/graphics/Rect;Lv8/x2;)V
    .locals 0
    ...
    invoke-interface {p3, p0, p1, p2}, Lv8/x2;->Y0([Lya/f3;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    return-void
.end method

.method public static synthetic d([Lya/f3;Lv7/e;Lq7/i0;Landroid/graphics/Rect;Lv8/n1;)V
    .locals 6
    ...
    :cond_0
    invoke-virtual {p2}, Lq7/i0;->M9()Lr7/h;
    ...
    invoke-interface {p1, p0, v0, p3, v1}, Lv8/g1;->x3([Lya/f3;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V

    :cond_1
    invoke-interface {p4}, Lv8/d1;->isFaceExists()Z
    ...
    invoke-interface {p4}, Lv8/d1;->isFocusViewVisible()Z
    ...
    invoke-virtual {p2}, Lq7/i0;->getHandler()Landroid/os/Handler;
...
.method public z8([Lya/f3;Lv7/e;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0}, Lcom/android/camera/ui/a1;->D0()Z
    ...
    invoke-direct {v1, p1, p0, p3}, La8/q;-><init>([Lya/f3;Lq7/i0;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v1, p1, p2, p0, p3}, La8/r;-><init>([Lya/f3;Lv7/e;Lq7/i0;Landroid/graphics/Rect;)V
