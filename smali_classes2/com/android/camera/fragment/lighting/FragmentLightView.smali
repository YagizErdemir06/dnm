...
.field public t:Lcom/android/camera/t2;
...
.method public static synthetic Gh(Lcom/android/camera/fragment/lighting/FragmentLightView;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/lighting/FragmentLightView;->hi(Z)V
...
.method public static synthetic Xh(Lcom/android/camera/fragment/lighting/FragmentLightView;II)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/fragment/lighting/FragmentLightView;->ii(II)V
...
.method public static synthetic ai(Lcom/android/camera/fragment/lighting/FragmentLightView;)Lcom/android/camera/ui/LightingView;
    .locals 0
...
.method public static synthetic bi(Lcom/android/camera/fragment/lighting/FragmentLightView;)Z
    .locals 0
...
.method private synthetic hi(Z)V
    ...
    invoke-interface {v0, v2, v1}, Lv8/y2;->alertFaceDetect(ZI)V

    goto :goto_0

    :pswitch_1
    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->fi()Z
    ...
    invoke-interface {v1, p1}, Lyh/a$d;->Qd(Z)V
    ...
    invoke-interface {v0, v2, p0}, Lv8/y2;->alertFaceDetect(ZI)V
...
.method public final ci(I)V
    ...
    invoke-interface {v0, p1}, Lv8/y2;->isContainAlertLightingTip(I)Z
...
.method public final di(IZ)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/fragment/lighting/FragmentLightView;->ii(II)V

    goto :goto_1

    :cond_2
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/lighting/FragmentLightView;->ci(I)V

    :goto_1
    return-void
.end method

.method public final ei(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    .locals 4
    .annotation build Lh7/d;
        ignore = false
        key = "isSupportMimoji"
...
.method public final gi(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    .locals 1
    .annotation build Lh7/d;
        ignore = false
        key = "isSupportMimoji"
...
.method public final declared-synchronized ii(II)V
    .locals 4
    .annotation build Lh7/d;
        ignore = false
        key = "isSupportMimoji"
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->ki()V
...
.method public initView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/lighting/FragmentLightView;->t:Lcom/android/camera/t2;
...
.method public final ji(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/lighting/FragmentLightView;->t:Lcom/android/camera/t2;
...
.method public final li(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    .locals 0
    .annotation build Lh7/d;
        ignore = false
        key = "isSupportMimoji"
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->La()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->tg()Z
...
.method public x3([Lya/f3;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    .locals 5
    .annotation build Lh7/d;
        ignore = false
        key = "isSupportMimoji"
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/lighting/FragmentLightView;->ji(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, p4}, Lcom/android/camera/fragment/lighting/FragmentLightView;->di(IZ)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/fragment/lighting/FragmentLightView;->li(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/fragment/lighting/FragmentLightView;->gi(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z

    move-result v0

    if-eqz v0, :cond_a

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/fragment/lighting/FragmentLightView;->ei(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    :cond_a
    :goto_3
    invoke-virtual {p0, p2, p4}, Lcom/android/camera/fragment/lighting/FragmentLightView;->di(IZ)V
