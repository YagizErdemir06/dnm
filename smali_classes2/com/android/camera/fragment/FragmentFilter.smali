...
.implements Lcom/android/camera/d4;
...
.field protected mComponentRunningFilter:Lm2/l0;

.field protected mCubicEaseOut:Lps/m;
...
.field protected mFilterGLThread:Lyl/m;
...
.method private synthetic lambda$drawRealtimeFilterOnGLThread$1()V
    ...
    invoke-interface {v3}, Lcom/android/camera/ui/a1;->c1()Ljava/lang/Object;
    ...
    invoke-interface {v2}, Lcom/android/camera/ui/a1;->d1()[F
    ...
    iget-object v6, p0, Lcom/android/camera/fragment/FragmentFilter;->mRecyclerView:Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;
    ...
    :try_start_0
    invoke-virtual {v5}, Lcom/android/camera/fragment/EffectItemAdapter$EffectItemHolder;->getEglSurface()Lyl/f;
    ...
    iget-object v8, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;

    invoke-virtual {v8}, Lm2/l0;->getItems()Ljava/util/List;
    ...
    invoke-virtual {v6}, Lyl/e;->e()I

    move-result v8

    invoke-virtual {v6}, Lyl/e;->d()I
...
.method private releaseGL()V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lyl/m;

    const/4 v3, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lyl/m;->e()Landroid/os/Handler;
    ...
    new-instance v4, Lcom/android/camera/fragment/r2;

    invoke-direct {v4, p0}, Lcom/android/camera/fragment/r2;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V

    invoke-virtual {v1, v4}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :cond_1
    iput-object v3, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lyl/m;
...
.method public static synthetic th(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 0
...
.method public static synthetic vh(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 0
...
.method public drawRealtimeFilterOnGLThread()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lyl/m;
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/fragment/q2;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V
    ...
    invoke-virtual {v0, p0}, Lyl/m;->j(Ljava/lang/Runnable;)Z
...
.method public initGL()V
    ...
    invoke-interface {v1}, Lcom/android/camera/ui/a1;->U0()Lyl/m;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lyl/m;
...
.method public initView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;

    iget v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mCurrentMode:I

    invoke-virtual {v0, p1, v2}, Lm2/l0;->g(Ljava/util/ArrayList;I)V

    iget-object p1, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lyl/m;
    ...
    invoke-virtual {v2}, Lyl/m;->d()Lyl/c;

    move-result-object v2

    invoke-direct {v3, v0, p1, v4, v2}, Lcom/android/camera/fragment/EffectItemAdapter;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/b;ZLyl/c;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/FragmentFilter;->mCubicEaseOut:Lps/m;
...
.method public isMutexOther()Z
    ...
    invoke-virtual {v0}, Lm2/l0;->getItems()Ljava/util/List;
...
.method public notifyItemChanged(II)V
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lm2/l0;->getItems()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lm2/l0;->getItems()Ljava/util/List;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-interface {p1}, Ly8/g;->Rc()V
...
.method public onItemSelected(IZ)V
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;

    invoke-virtual {v5}, Lm2/l0;->getItems()Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;

    invoke-virtual {v6, v3, v5}, Lm2/l0;->h(ZI)V
    ...
    invoke-static {v4, p2}, Lk9/a;->h1(IZ)V
    ...
    invoke-interface {v1, v3, v0, v0, v3}, Lv8/z;->E5(ZLjava/lang/String;Ljava/lang/String;Z)V

    :cond_3
    invoke-interface {v1, v4}, Lv8/z;->h8(I)V
    :try_end_0
...
.method public onPause()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/a1;->C0(Lcom/android/camera/t2$b;)V
...
.method public onResume()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/a1;->x1(Lcom/android/camera/t2$b;)V
...
.method public reInit()V
    ...
    invoke-virtual {v0, v1}, Lm2/l0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;
...
.method public updateCurrentIndex()V
    ...
    invoke-virtual {v1, v0}, Lm2/l0;->getComponentValue(I)Ljava/lang/String;
...
.method public updateFilterData()V
    ...
    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mComponentRunningFilter:Lm2/l0;
    ...
    invoke-virtual {v1}, Lj2/b1;->u()Lj2/f;
    ...
    invoke-virtual {v1, v0, v2}, Lm2/l0;->g(Ljava/util/ArrayList;I)V
...
.method public updateSelectFilter(I)V
    ...
    invoke-virtual {v1}, Lm2/l0;->getItems()Ljava/util/List;
