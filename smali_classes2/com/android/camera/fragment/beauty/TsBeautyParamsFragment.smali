...
.method public static synthetic Ei(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0
...
.method public static synthetic Fi(Lcom/android/camera/data/data/j;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Ri(Lcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic Gi(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;ZLcom/android/camera/data/data/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Ni(ZLcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic Hi(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;ZLcom/android/camera/data/data/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Pi(ZLcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic Ii(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V
    .locals 0
...
.method public static synthetic Ji(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)Lva/a;
    .locals 0
...
.method public static synthetic Ki(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)V
    .locals 0
...
.method private synthetic Ni(ZLcom/android/camera/data/data/j;)V
    .locals 1
...
.method private synthetic Pi(ZLcom/android/camera/data/data/j;)V
    .locals 1
...
.method private synthetic Qi(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Li(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->ci()Ljava/lang/String;
...
.method public static synthetic Ri(Lcom/android/camera/data/data/j;)V
    .locals 4
...
.method public Ch()V
    ...
    invoke-static {v0, v1}, Lcom/android/camera/v2;->c4(ILcom/android/camera/fragment/beauty/e0;)Z

    move-result v0

    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/BaseBeautyMakeupFragment;->ai()Ljava/util/List;
    ...
    new-instance v2, Lcom/android/camera/fragment/beauty/b1;

    invoke-direct {v2, p0, v0}, Lcom/android/camera/fragment/beauty/b1;-><init>(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;Z)V
...
.method public Li(Ljava/lang/String;)V
    ...
    new-instance v7, Lcom/android/camera/fragment/beauty/c1;

    invoke-direct {v7, v4, v5, v1, v6}, Lcom/android/camera/fragment/beauty/c1;-><init>(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final Mi()Z
    ...
    invoke-static {p0}, Lcom/android/camera/s2;->L(Landroid/content/Intent;)Z
...
.method public handleMutex(Z)V
    ...
    new-instance v3, Lcom/android/camera/fragment/beauty/a1;

    invoke-direct {v3, p0, p1}, Lcom/android/camera/fragment/beauty/a1;-><init>(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;Z)V
...
.method public li()Landroid/widget/AdapterView$OnItemClickListener;
    ...
    new-instance v0, Lcom/android/camera/fragment/beauty/y0;

    invoke-direct {v0, p0}, Lcom/android/camera/fragment/beauty/y0;-><init>(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)V
