...
.method public H()V
    ...
    invoke-static {v0, v11}, Lcom/android/camera/a6;->D1(Ljava/lang/String;Landroid/net/Uri;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v15}, Lcom/android/camera/a6;->H1(Landroid/content/ContentValues;)Lcom/android/camera/w2;

    move-result-object v15

    invoke-static {v14, v11, v0, v15, v12}, Li7/c;->c(Landroid/media/MediaMetadataRetriever;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Lcom/android/camera/w2;[Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v0, v14}, Lte/d;->b(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    :cond_8
    invoke-static {v11}, Lbv/b;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v3, v0, v4, v4}, Lcom/android/camera/m5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;
    ...
    :goto_9
    invoke-virtual {v0, v7, v8}, Lcom/android/camera/m5;->O(J)V

    const/4 v3, 0x1

    invoke-virtual {v0, v3}, Lcom/android/camera/m5;->N(Z)V

    iget-object v5, v1, Ll9/b;->b:Ll9/q;

    invoke-interface {v5, v0, v3}, Ll9/q;->k(Lcom/android/camera/m5;Z)V
