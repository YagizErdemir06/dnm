...
.method public H()V
    ...
    invoke-static {v5, v6, v1, v2, v3}, Lcom/android/camera/m5;->e([BIILandroid/net/Uri;Z)Lcom/android/camera/m5;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Lcom/android/camera/m5;->Q()V

    iget-object v1, p0, Ll9/b;->b:Ll9/q;

    invoke-interface {v1, v2, v4}, Ll9/q;->k(Lcom/android/camera/m5;Z)V
    ...
    invoke-direct {v1, p0, v2}, Ll9/n$b;-><init>(Ll9/n;Lcom/android/camera/m5;)V
