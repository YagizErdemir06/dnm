...
# instance fields
.field public e:Lcom/android/camera/m5;
...
.method public A(Landroid/net/Uri;Ljava/lang/String;Landroid/content/ContentValues;Z)Landroid/net/Uri;
    ...
    invoke-virtual {v0, p1, p0}, Ll9/z;->C0(Landroid/content/Context;Ll9/q;)V

    invoke-virtual {v0}, Ll9/z;->H()V
...
.method public final B(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    :cond_0
    invoke-static {p1, p3}, Lcom/android/camera/a6;->t(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public final C(Lye/w;Landroid/hardware/camera2/CaptureResult;)V
    .locals 9
    ...
    invoke-virtual {p1}, Lye/x;->q0()Lye/z;
    ...
    invoke-virtual {v0, v2}, Lye/z;->C(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lye/z;->z(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {p0, p2, v0}, Ll9/h;->f0(Landroid/hardware/camera2/CaptureResult;Lye/z;)V
...
.method public F()[B
    ...
    iget-object p0, p0, Ll9/h;->v:Lye/w;
...
.method public final G()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/camera/f3;->b(Z)I
...
.method public final H(Lye/w;)V
    ...
    invoke-virtual {v0, p1}, Ll9/a$a;->y(Lye/w;)Ll9/a$a;

    invoke-static {p1}, Ll9/a;->a(Lye/w;)I

    move-result v1

    invoke-virtual {v0, v1}, Ll9/a$a;->z(I)Ll9/a$a;

    invoke-static {p1}, Ll9/a;->d(Lye/w;)Z
...
.method public final J(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Ll9/h;->K(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    return-void
.end method

.method public final K(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 1
    .param p2    # Landroid/hardware/camera2/CaptureResult;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, p3}, Ll9/h;->M(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, Ll9/h;->I(Lye/w;)V
    ...
    invoke-virtual {p0, p1}, Ll9/h;->H(Lye/w;)V
    ...
    :pswitch_5
    invoke-virtual {p0, p1}, Ll9/h;->L(Lye/w;)V

    goto :goto_0

    :pswitch_6
    invoke-virtual {p0, p1}, Ll9/h;->W(Lye/w;)V
    ...
    :pswitch_8
    invoke-virtual {p0, p1}, Ll9/h;->X(Lye/w;)V
...
.method public M(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    .locals 11
    ...
    invoke-virtual {v5}, Lye/x;->z0()Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera/a6;->d1(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    :goto_1
    invoke-virtual {v3}, Lye/x;->v0()Landroid/util/Size;

    move-result-object v5

    if-nez v5, :cond_3

    invoke-virtual {v3}, Lye/x;->p0()Landroid/util/Size;
    ...
    invoke-static {v2, v1}, Lte/e;->c(Ljava/lang/Object;I)V
...
.method public R()V
    ...
    iput-object v2, p0, Ll9/h;->e:Lcom/android/camera/m5;
...
.method public final W(Lye/w;)V
    ...
    invoke-virtual {p0, p1, v1, v0}, Ll9/h;->h0(Lye/w;II)V
...
.method public final Z()V
    ...
    iput-object v0, p0, Ll9/h;->v:Lye/w;
...
.method public final a0()V
    ...
    invoke-interface {v0}, Ll9/h$c;->G4()V
...
.method public c(Ljava/util/function/Consumer;)V
    ...
    invoke-interface {p0}, Ll9/h$c;->q4()Lcom/android/camera/ThumbnailUpdater;
...
.method public c0()V
    ...
    iget-object v0, p0, Ll9/h;->v:Lye/w;
    ...
    invoke-static {v2, v3}, Lcom/android/camera/a6;->W(J)Ljava/lang/String;
    ...
    iget-object v5, p0, Ll9/h;->v:Lye/w;

    invoke-virtual {v5}, Lye/w;->x()[B

    move-result-object v5

    invoke-static {v5}, Lld/d;->u([B)I
    ...
    iget-object v7, p0, Ll9/h;->v:Lye/w;

    invoke-virtual {v7}, Lye/w;->x()[B

    move-result-object v7

    invoke-virtual {v6, v7}, Ll9/a$a;->p([B)Ll9/a$a;

    invoke-virtual {v0}, Lye/w;->f0()Z
    ...
    invoke-virtual {v6, v0}, Ll9/g$a;->S(Lld/e;)Ll9/g$a;
    ...
    invoke-virtual {v6, v1}, Ll9/a$a;->t(Lye/z;)Ll9/a$a;
...
.method public final e0(Lye/w;Landroid/hardware/camera2/CaptureResult;)V
    .locals 0
    ...
    invoke-virtual {p0}, Lye/x;->q0()Lye/z;
    ...
    invoke-virtual {p0, p2}, Lye/z;->C(Ljava/lang/String;)V
...
.method public f(Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/m5;->P(Landroid/net/Uri;)V

    :cond_0
    return-void
.end method

.method public final f0(Landroid/hardware/camera2/CaptureResult;Lye/z;)V
    .locals 0
    ...
    invoke-virtual {p2}, Lye/z;->i()Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0}, Lq7/j3;->b(Llb/k$b;)Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Lye/z;->e0(Ljava/lang/String;)V
...
.method public final h0(Lye/w;II)V
    .locals 7
    ...
    iput-object p1, p0, Ll9/h;->v:Lye/w;

    int-to-double v3, p2

    invoke-virtual {v1}, Lye/x;->u0()Landroid/util/Size;
    ...
    invoke-static {p1, p3, v2, p2}, Lcom/android/camera/m5;->b([BIZI)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p1, p0}, Lv8/e1;->L7(Landroid/graphics/Bitmap;)V
...
.method public i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    .locals 4
    .param p2    # Landroid/hardware/camera2/CaptureResult;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2}, Ll9/h;->e0(Lye/w;Landroid/hardware/camera2/CaptureResult;)V

    monitor-enter p0

    :try_start_0
    invoke-virtual {p1}, Lye/w;->y()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, p2}, Ll9/h;->J(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    ...
    invoke-virtual {p0, p1, p2}, Ll9/h;->C(Lye/w;Landroid/hardware/camera2/CaptureResult;)V

    invoke-virtual {p0, p1, p2, p3, p4}, Ll9/h;->K(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public final j0(Z)V
    ...
    iget-object v3, p0, Ll9/h;->e:Lcom/android/camera/m5;

    const/4 v4, 0x0

    iput-object v4, p0, Ll9/h;->e:Lcom/android/camera/m5;
    ...
    invoke-virtual {v0, v3, v1, p1}, Lcom/android/camera/ThumbnailUpdater;->u(Lcom/android/camera/m5;ZZ)V
...
.method public k(Lcom/android/camera/m5;Z)V
    .locals 4
    ...
    iput-object p1, p0, Ll9/h;->e:Lcom/android/camera/m5;
    ...
    invoke-interface {p0}, Ll9/h$c;->w2()V
...
.method public n(Ljava/lang/Object;Ljava/lang/String;J)V
    ...
    invoke-virtual {p1, p2, p3, p4}, Lye/w;->c(Ljava/lang/String;J)V

    invoke-virtual {p1}, Lye/w;->Z()Z
    ...
    :cond_2
    invoke-virtual {p1}, Lye/w;->h0()Z

    move-result p2

    if-eqz p2, :cond_3

    invoke-virtual {p0, p1}, Ll9/h;->V(Lye/w;)V
...
.method public r(Ljava/lang/String;Landroid/net/Uri;II)Landroid/net/Uri;
    ...
    invoke-virtual {p1, p2, p0}, Ll9/c;->C0(Landroid/content/Context;Ll9/q;)V

    invoke-virtual {p1}, Ll9/c;->H()V
...
.method public s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lye/w;Ll9/d$a;)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Ll9/d;-><init>(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lye/w;Ll9/d$a;Landroid/os/Handler;)V
...
.method public t(Ll9/g$a;Landroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-static {v0, v1}, Lte/e;->c(Ljava/lang/Object;I)V

    invoke-virtual {p1}, Ll9/a$a;->g()Lye/z;
...
.method public final w(Ll9/p;Z)V
    ...
    invoke-interface {p1, v0, p0}, Ll9/p;->C0(Landroid/content/Context;Ll9/q;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
