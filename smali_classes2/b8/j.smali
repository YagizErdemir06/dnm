...
.method public a(Lb8/k;)Lb8/k;
    ...
    invoke-virtual {v2, v3}, Lcom/android/camera/Camera;->En(I)V
    ...
    invoke-interface {v4, v2, v5}, Lr7/l;->oc(Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {v4}, Lcom/android/camera/t2;->Y()Lcom/android/camera/g5$a;

    move-result-object v5

    if-eqz v5, :cond_5

    invoke-virtual {v4}, Lcom/android/camera/t2;->f0()Z

    move-result v5

    if-eqz v5, :cond_4

    invoke-virtual {v4, v3}, Lcom/android/camera/t2;->z0(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/camera/t2;->z0(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v5, v2, v3, v7}, Lr7/l;->j2(Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    invoke-interface {v4}, Lv8/l;->Vc()Lz1/b;
    ...
    iget v3, p0, Lcom/android/camera/w2;->a:I
    ...
    invoke-static {v3, p0, v0}, Lcom/android/camera/v2;->e1(IILya/f;)F

    move-result p0

    invoke-interface {v2, p0}, Lv8/n1;->setPreviewAspectRatio(F)V
