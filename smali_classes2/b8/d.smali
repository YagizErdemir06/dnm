...
# direct methods
.method public constructor <init>(Lcom/android/camera/module/loader/base/StartControl;Lq7/v4;Landroid/content/Intent;)V
    .locals 1
...
.method public static synthetic a(Lb8/d;Lv8/b1;)V
    .locals 0

    invoke-direct {p0, p1}, Lb8/d;->d(Lv8/b1;)V
...
.method public final f(Lj2/b1;Lr2/a$a;Lj2/b1;Lr2/a$a;)V
    .locals 0
...
.method public final g(Lj2/b1;Lr2/a$a;II)V
    .locals 5
...
.method public final h(Lj2/b1;Z)V
    .locals 2
    ...
    invoke-virtual {v0, v1, p2}, Lm2/v0;->U(IZ)Z
...
.method public final i()V
    ...
    :goto_0
    invoke-interface {v7, v10}, Lr2/a;->h(I)Lr2/a$b;

    move-result-object v7

    check-cast v7, Lj2/b1;
    ...
    iget v12, v0, Lb8/a;->a:I

    invoke-static {v12}, Lya/m3;->w(I)Z
    ...
    const-string v12, "pref_camera_track_focus_key_video"

    invoke-interface {v4, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;
    ...
    invoke-virtual {v0, v3, v4, v11, v13}, Lb8/d;->g(Lj2/b1;Lr2/a$a;II)V
    ...
    :goto_2
    invoke-virtual {v0, v3, v12}, Lb8/d;->h(Lj2/b1;Z)V
    ...
    invoke-virtual {v1, v15, v12}, Lcom/android/camera/data/data/g;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lid/b;->Bb()Z
    ...
    invoke-virtual/range {v16 .. v16}, Lid/b;->ob()Z
    ...
    invoke-static {v8, v12}, Lcom/android/camera/a6;->m3(Ljava/lang/Object;I)Z
    ...
    const-string v12, "pref_camera_portrait_with_facebeauty_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_facedetection_auto_hidden_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_video_show_faceview"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_dual_enable_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_dual_sat_enable_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_mfnr_sat_enable_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_sr_enable_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_parallel_process_enable_key"
    ...
    const-string v12, "pref_camera_video_sat_enable_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_touch_focus_delay_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_camera_quick_shot_enable_key"

    invoke-interface {v8, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v8

    const-string v12, "pref_video_capture_repeating"
    ...
    invoke-virtual {v1, v12, v8}, Lcom/android/camera/data/data/g;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    invoke-static {v8}, Lcom/android/camera/a6;->y3(Ljava/lang/String;)Z

    move-result v8

    if-nez v8, :cond_10

    invoke-interface {v5, v12}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;
    ...
    :goto_6
    invoke-virtual {v1, v3}, Ll2/g;->G0(I)V
    ...
    :cond_16
    invoke-virtual {v2}, Lm2/h1;->S()Lm2/y;

    move-result-object v8

    invoke-virtual {v8}, Lm2/y;->G()V

    invoke-virtual {v3}, Lj2/b1;->I()Lj2/v;
    ...
    invoke-virtual {v3}, Lj2/b1;->b0()Lj2/g0;

    move-result-object v12

    invoke-virtual {v2}, Lm2/h1;->t0()Lj2/a1;

    move-result-object v14

    invoke-virtual {v0, v8, v12, v14, v4}, Lb8/d;->q(Lj2/v;Lj2/g0;Lj2/a1;Lr2/a$a;)V
    ...
    invoke-virtual {v0, v8, v12}, Lb8/d;->j(Lm2/b;Z)V

    invoke-virtual {v2}, Lm2/h1;->O()Lm2/k;

    move-result-object v8

    invoke-virtual {v0, v8, v12}, Lb8/d;->m(Lm2/k;Z)V

    invoke-virtual {v3}, Lj2/b1;->D()Lj2/s;

    move-result-object v8

    iget v12, v0, Lb8/a;->a:I

    invoke-virtual {v8, v12}, Lj2/s;->getKey(I)Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lm2/h1;->j0()Lm2/v0;

    move-result-object v8

    invoke-virtual {v8}, Lm2/v0;->b()V

    invoke-virtual {v0, v1, v5}, Lb8/d;->w(Ll2/g;Lr2/a$a;)V

    invoke-virtual {v0, v3, v4, v7, v10}, Lb8/d;->n(Lj2/b1;Lr2/a$a;Lj2/b1;Lr2/a$a;)V

    invoke-static {}, Lg2/b;->i()Lk2/g;

    move-result-object v3

    invoke-virtual {v3}, Lk2/g;->p()V

    invoke-virtual {v2}, Lm2/h1;->l0()Lm2/a1;

    move-result-object v3

    invoke-virtual {v0, v3}, Lb8/d;->t(Lm2/a1;)V
    ...
    invoke-interface {v6, v3}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "pref_live_music_hint_key"

    invoke-interface {v3, v7}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "pref_live_sticker_key"

    invoke-interface {v3, v7}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "pref_live_sticker_name_key"

    invoke-interface {v3, v7}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "pref_live_sticker_hint_key"

    invoke-interface {v3, v7}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "pref_live_speed_key"

    invoke-interface {v3, v7}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "key_live_filter"

    invoke-interface {v3, v7}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;

    move-result-object v3

    const-string v7, "pref_live_beauty_status"
    ...
    invoke-interface {v5, v3}, Lr2/a$a;->remove(Ljava/lang/String;)Lr2/a$a;
    ...
    check-cast v8, Lq7/v4;

    invoke-interface {v8}, Lq7/v4;->u0()Lcom/android/camera/Camera;

    move-result-object v8

    invoke-virtual {v8}, Lcom/android/camera/ActivityBase;->Mi()Z
    ...
    :goto_9
    invoke-virtual {v2}, Lm2/h1;->d0()Lm2/p0;

    move-result-object v3

    iget v7, v0, Lb8/a;->a:I

    invoke-virtual {v3, v7}, Lcom/android/camera/data/data/b;->getPersistValue(I)Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v3, v7, v8}, Lm2/p0;->checkValueValid(ILjava/lang/String;)Z
    ...
    invoke-virtual {v3, v7}, Lm2/p0;->getDefaultValue(I)Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v3, v7, v8}, Lcom/android/camera/data/data/b;->setComponentValue(ILjava/lang/String;)V
    ...
    invoke-virtual {v3}, Lid/b;->F6()Z

    move-result v3

    iget v7, v0, Lb8/d;->b:I
    ...
    invoke-static {v4, v3}, Lcom/android/camera/v2;->K8(Lr2/a$a;Z)V
    ...
    iget v5, v0, Lb8/a;->a:I

    invoke-virtual {v4, v13, v5}, Lc8/g;->r0(II)Lya/f;
    ...
    invoke-direct {v4, v0}, Lb8/c;-><init>(Lb8/d;)V
    ...
    invoke-static {v9, v1, v4}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lm2/h1;->r()[Ljava/lang/String;

    move-result-object v12

    if-eqz v12, :cond_23

    iget-object v1, v0, Lb8/d;->g:Landroid/content/Intent;
    ...
    invoke-virtual {v1, v3}, Lm2/h1;->j1([Ljava/lang/String;)V

    new-instance v1, Ll4/g2;

    invoke-direct {v1}, Ll4/g2;-><init>()V

    invoke-virtual {v1}, Ll4/g2;->getItemClass()Ljava/lang/Class;
    ...
    check-cast v4, Ll4/h2;

    iget v5, v0, Lb8/a;->a:I

    invoke-virtual {v1, v5, v4}, Ll4/g2;->d(ILl4/h2;)V

    :cond_23
    invoke-virtual {v2}, Lm2/h1;->s()Landroid/util/Pair;
    ...
    :cond_24
    invoke-virtual {v2, v3}, Lm2/h1;->k1(Landroid/util/Pair;)V

    invoke-virtual {v2, v3}, Lm2/h1;->n1(Ljava/lang/String;)V

    invoke-virtual {v2, v3}, Lm2/h1;->m1(Ljava/lang/String;)V
...
.method public final n(Lj2/b1;Lr2/a$a;Lj2/b1;Lr2/a$a;)V
    .locals 2
    ...
    invoke-virtual {p3}, Lj2/b1;->O()Lj2/j;
    ...
    invoke-virtual {p1}, Lj2/b1;->z()Lj2/m;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lb8/d;->f(Lj2/b1;Lr2/a$a;Lj2/b1;Lr2/a$a;)V
    ...
    invoke-virtual {p1}, Lj2/b1;->p()Lj2/a;
    ...
    invoke-virtual {p3}, Lj2/b1;->p()Lj2/a;
    ...
    invoke-static {}, Lcom/android/camera/v2;->J7()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p1}, Lj2/b1;->y()Lj2/k;

    move-result-object p1

    invoke-virtual {p0, p1, p2}, Lb8/d;->r(Lj2/k;Lr2/a$a;)V

    invoke-virtual {p3}, Lj2/b1;->y()Lj2/k;
...
.method public final o(Lj2/h;Lr2/a$a;)V
    ...
    invoke-virtual {p1, p2}, Lj2/h;->F(Lr2/a$a;)V
...
.method public final p(Lj2/j;Lr2/a$a;)V
    ...
    invoke-virtual {p1, p2}, Lj2/j;->y(Lr2/a$a;)V

    :cond_0
    return-void
.end method

.method public final q(Lj2/v;Lj2/g0;Lj2/a1;Lr2/a$a;)V
    .locals 0
    ...
    invoke-virtual {p2, p1, p4}, Lj2/g0;->m(Lj2/v;Lr2/a$a;)Z
    ...
    invoke-virtual {p3, p0, p1}, Lj2/a1;->setComponentValue(ILjava/lang/String;)V
...
.method public final t(Lm2/a1;)V
    .locals 0

    invoke-virtual {p1}, Lm2/a1;->b()V
