...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lbk/a$a;-><init>(Lkotlin/jvm/internal/w;)V
...
.method public constructor <init>(Lbk/b;)V
    ...
    invoke-virtual {p1}, Luj/a;->i()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lbk/a;->c:Ljava/lang/String;

    const-string p1, ""

    iput-object p1, p0, Lbk/a;->d:Ljava/lang/String;

    sget-object p1, Lbk/a$b;->a:Lbk/a$b;

    invoke-static {p1}, Lnm/f0;->b(Ljn/a;)Lnm/d0;

    move-result-object p1

    iput-object p1, p0, Lbk/a;->e:Lnm/d0;
...
.method public final a(Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    invoke-virtual {v2}, Luj/a;->k()Ljava/lang/String;
    ...
    invoke-virtual {v9, v10}, Ldk/e;->o(Ljava/lang/String;)I

    move-result v9

    iput v9, v0, Lbk/a;->b:I

    iget-object v10, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v10, v9}, Lbk/b;->n(I)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v0, Lbk/a;->c:Ljava/lang/String;

    iget-object v9, v0, Lbk/a;->a:Lbk/b;

    iget v10, v0, Lbk/a;->b:I

    invoke-virtual {v9, v10}, Lbk/b;->t(I)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v0, Lbk/a;->d:Ljava/lang/String;
    ...
    invoke-virtual {v9, v10}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-static {v10, v2, v8, v6, v8}, Lbk/b;->x(Lbk/b;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v10}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v9}, Lwj/f;->j()Lwj/h;

    move-result-object v2

    invoke-virtual {v2, v10}, Lwj/h;->h(Lwj/e;)V

    :cond_2
    :goto_0
    iget-object v2, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v2}, Lbk/b;->A()Ljava/util/HashMap;
    ...
    sget-object v10, Luj/a;->a:Luj/a;

    invoke-virtual {v10}, Luj/a;->k()Ljava/lang/String;
    ...
    iget-object v12, v0, Lbk/a;->a:Lbk/b;

    invoke-static {v12, v9, v8, v6, v8}, Lbk/b;->x(Lbk/b;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v12

    iget-object v13, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v13, v9}, Lbk/b;->j(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v9

    invoke-virtual {v3}, Lwj/f;->j()Lwj/h;

    move-result-object v13

    invoke-virtual {v13, v8}, Lwj/h;->h(Lwj/e;)V

    invoke-virtual {v3}, Lwj/f;->j()Lwj/h;

    move-result-object v13

    invoke-virtual {v13, v8}, Lwj/h;->g(Lwj/a;)V
    ...
    invoke-virtual {v13}, Lwj/a;->l()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lwj/a;->l()Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v21}, Lwj/a;-><init>(Ljava/lang/String;IIIFILkotlin/jvm/internal/w;)V

    invoke-virtual {v13, v6}, Lwj/h;->g(Lwj/a;)V
    ...
    invoke-virtual {v5}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v5}, Lwj/h;->h(Lwj/e;)V
...
.method public final c(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Scene;)V
    ...
    invoke-virtual/range {p0 .. p1}, Lbk/a;->e(Lcom/faceunity/core/avatar/model/Scene;)Lcom/faceunity/core/avatar/model/Avatar;
    ...
    :goto_0
    invoke-virtual {v3, v4}, Ldk/e;->o(Ljava/lang/String;)I

    move-result v3

    iget-object v4, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v4, v3}, Lbk/b;->t(I)Ljava/lang/String;

    move-result-object v3

    iget-object v4, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v4, v3}, Lbk/b;->o(Ljava/lang/String;)Ljava/lang/String;
...
.method public final d(Ljava/lang/String;Lwj/e;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-virtual {v0, p1}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {p1}, Lwj/f;->i()Lwj/g;

    move-result-object p1

    invoke-virtual {p1}, Lwj/g;->m()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v1, p2}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    :cond_2
    invoke-virtual {v1}, Lwj/f;->j()Lwj/h;

    move-result-object v1

    invoke-virtual {v1}, Lwj/h;->f()Lwj/e;
    ...
    iget-object v2, p0, Lbk/a;->c:Ljava/lang/String;

    invoke-virtual {v1, p2, v2}, Lbk/b;->w(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, Lwj/e;->j()Ljava/util/ArrayList;
...
.method public final f(Lcom/faceunity/core/avatar/model/Scene;Lwj/e;)Lcom/faceunity/core/avatar/model/Avatar;
    .locals 17
    .param p1    # Lcom/faceunity/core/avatar/model/Scene;
        .annotation build Ljv/d;
        .end annotation
    ...
    :cond_0
    invoke-virtual/range {p2 .. p2}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v4}, Ldk/e;->o(Ljava/lang/String;)I
    ...
    iget-object v7, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v7, v6}, Lbk/b;->n(I)Ljava/lang/String;
    ...
    sget-object v15, Luj/a;->a:Luj/a;

    invoke-virtual {v15}, Luj/a;->k()Ljava/lang/String;
    ...
    invoke-virtual {v12, v15}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-static {v12, v15, v2, v13, v2}, Lbk/b;->x(Lbk/b;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v15}, Lwj/e;->m()Ljava/util/ArrayList;
    ...
    invoke-static {v12, v13, v15, v14, v15}, Lbk/b;->x(Lbk/b;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/ArrayList;
    ...
    check-cast v14, Lwj/e;

    invoke-virtual {v14}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v14}, Lwj/e;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v5}, Lbk/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lbk/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v13}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v6}, Lbk/b;->t(I)Ljava/lang/String;

    move-result-object v2

    iget-object v0, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v0, v2}, Lbk/b;->o(Ljava/lang/String;)Ljava/lang/String;
...
.method public final g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lxn/c0;->F3(Ljava/lang/CharSequence;Ljava/lang/String;IZILjava/lang/Object;)I
    ...
    invoke-static/range {v0 .. v5}, Lxn/b0;->k2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Ljava/lang/String;
...
.method public final i()Ljava/lang/String;
    ...
    iget-object p0, p0, Lbk/a;->c:Ljava/lang/String;
...
.method public final j()Ljava/lang/String;
    ...
    iget-object p0, p0, Lbk/a;->d:Ljava/lang/String;
...
.method public final k()Lcom/faceunity/core/faceunity/FUSceneKit;
    ...
    iget-object p0, p0, Lbk/a;->e:Lnm/d0;
...
.method public final o(Lcom/faceunity/core/avatar/model/Scene;Lwj/e;)V
    .locals 20
    ...
    :cond_1
    iget-object v3, v0, Lbk/a;->a:Lbk/b;

    sget-object v4, Luj/a;->a:Luj/a;

    invoke-virtual {v4}, Luj/a;->k()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v3, v5}, Lbk/b;->s(Ljava/lang/String;)Lwj/d;
    ...
    :cond_2
    iget-object v5, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v4}, Luj/a;->k()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v5, v4}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v5, v7}, Ldk/e;->o(Ljava/lang/String;)I

    move-result v5

    iput v5, v0, Lbk/a;->b:I

    iget-object v6, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v6, v5}, Lbk/b;->n(I)Ljava/lang/String;

    move-result-object v5

    iput-object v5, v0, Lbk/a;->c:Ljava/lang/String;

    iget-object v5, v0, Lbk/a;->a:Lbk/b;

    iget v6, v0, Lbk/a;->b:I

    invoke-virtual {v5, v6}, Lbk/b;->t(I)Ljava/lang/String;

    move-result-object v5

    iput-object v5, v0, Lbk/a;->d:Ljava/lang/String;
    ...
    iget-object v6, v0, Lbk/a;->d:Ljava/lang/String;

    invoke-virtual {v3, v6}, Lwj/d;->f(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v6}, Lbk/b;->u(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    iget-object v1, v0, Lbk/a;->a:Lbk/b;

    iget-object v3, v0, Lbk/a;->d:Ljava/lang/String;

    invoke-virtual {v1, v3}, Lbk/b;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v8, Luj/a;->a:Luj/a;

    invoke-virtual {v8}, Luj/a;->k()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lbk/a;->k()Lcom/faceunity/core/faceunity/FUSceneKit;
    ...
    invoke-virtual {v4}, Lwj/f;->j()Lwj/h;

    move-result-object v0

    move-object/from16 v1, p2

    invoke-virtual {v0, v1}, Lwj/h;->h(Lwj/e;)V
...
.method public final p(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    invoke-virtual {p0, p1}, Lbk/a;->e(Lcom/faceunity/core/avatar/model/Scene;)Lcom/faceunity/core/avatar/model/Avatar;
...
.method public final q(Lcom/faceunity/core/avatar/model/Scene;Lwj/e;)V
    .locals 18
    .param p1    # Lcom/faceunity/core/avatar/model/Scene;
        .annotation build Ljv/d;
        .end annotation
    ...
    sget-object v5, Luj/a;->a:Luj/a;

    invoke-virtual {v5}, Luj/a;->k()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v4, v6}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v5, v2}, Ldk/e;->o(Ljava/lang/String;)I

    move-result v2

    iget-object v5, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v5, v2}, Lbk/b;->t(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lbk/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v2, v0}, Lwj/g;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final r(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lwj/e;)V
    .locals 9
    .param p1    # Lcom/faceunity/core/avatar/model/Scene;
        .annotation build Ljv/d;
        .end annotation
    ...
    invoke-virtual {v0, p2}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v0}, Lwj/f;->i()Lwj/g;

    move-result-object v0

    invoke-virtual {v0}, Lwj/g;->n()Ljava/util/ArrayList;
    ...
    :cond_2
    invoke-virtual {p3}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v0}, Lcom/faceunity/core/entity/FUBundleData;->getName()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    :cond_4
    iget-object v5, p0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v0}, Lcom/faceunity/core/entity/FUBundleData;->getName()Ljava/lang/String;

    move-result-object v6

    iget-object v7, p0, Lbk/a;->c:Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v6}, Lwj/h;->h(Lwj/e;)V

    goto :goto_1

    :cond_6
    invoke-static {v1}, Lpm/g0;->Q5(Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final s(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p0, v0}, Lwj/g;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final t(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lwj/g;->l()Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, Lwj/g;->m()Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lbk/a;->c:Ljava/lang/String;

    invoke-virtual {v5, v3, v6}, Lbk/b;->w(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    :cond_8
    invoke-static {v0}, Lpm/g0;->Q5(Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final u(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lwj/a;)V
    .locals 27
    .param p1    # Lcom/faceunity/core/avatar/model/Scene;
        .annotation build Ljv/d;
        .end annotation
    ...
    invoke-virtual {v4, v1}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v1}, Lwj/f;->i()Lwj/g;

    move-result-object v5

    invoke-virtual {v5}, Lwj/g;->j()Ljava/util/ArrayList;
    ...
    iget-object v8, v0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v8, v6}, Lbk/b;->j(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v9, v2}, Lwj/a;->n(Lwj/a;)Z
    ...
    invoke-virtual {v8, v6}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;

    move-result-object v6

    if-eqz v6, :cond_4

    invoke-virtual {v6}, Lwj/f;->j()Lwj/h;
    ...
    :cond_5
    invoke-virtual {v7, v9}, Lwj/h;->g(Lwj/a;)V
    ...
    invoke-virtual {v4}, Lwj/a;->l()Ljava/lang/String;

    move-result-object v5

    sget-object v6, Luj/a;->a:Luj/a;

    invoke-virtual {v6}, Luj/a;->I()Ljava/lang/String;
    ...
    invoke-static {v5, v8, v9, v10, v7}, Lxn/c0;->V2(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
    ...
    invoke-virtual {v4}, Lwj/a;->m()I

    move-result v6

    int-to-double v11, v6

    invoke-virtual {v4}, Lwj/a;->j()I

    move-result v6

    int-to-double v13, v6

    invoke-virtual {v4}, Lwj/a;->h()I
    ...
    invoke-virtual {v6}, Luj/a;->o()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lwj/h;->g(Lwj/a;)V

    return-void
.end method

.method public final v(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lwj/e;)V
    .locals 12
    ...
    :cond_0
    iget-object p1, p0, Lbk/a;->a:Lbk/b;

    invoke-virtual {p1, p2}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v3}, Luj/a;->i0()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Luj/a;->j0()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v4, v3}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v3}, Lwj/g;->n()Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lbk/a;->a:Lbk/b;

    invoke-virtual {v8, v4}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    :cond_4
    invoke-virtual {v8}, Lwj/f;->j()Lwj/h;

    move-result-object v9

    invoke-virtual {v9}, Lwj/h;->f()Lwj/e;

    move-result-object v9

    if-eqz v9, :cond_3

    invoke-virtual {v9}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lbk/a;->a:Lbk/b;

    iget-object v10, p0, Lbk/a;->c:Ljava/lang/String;

    invoke-virtual {v9, v4, v10}, Lbk/b;->w(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v4}, Lwj/h;->h(Lwj/e;)V
    ...
    invoke-virtual {v4, v5}, Lwj/h;->h(Lwj/e;)V
    ...
    invoke-virtual {v4}, Lwj/g;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v5}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v9, v5, v10}, Lbk/b;->w(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v5}, Lwj/h;->h(Lwj/e;)V
    ...
    invoke-virtual {v4}, Lwj/e;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v8}, Lbk/b;->z(Ljava/lang/String;)Lwj/f;
    ...
    invoke-virtual {v8, v9, v10}, Lbk/b;->w(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lwj/f;->j()Lwj/h;

    move-result-object v4

    invoke-virtual {v4, v9}, Lwj/h;->h(Lwj/e;)V

    goto :goto_4

    :cond_11
    invoke-virtual {p1}, Lwj/f;->j()Lwj/h;

    move-result-object p0

    invoke-virtual {p0, p3}, Lwj/h;->h(Lwj/e;)V
...
.method public final w(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lwj/e;)V
    .locals 2
    .param p1    # Lcom/faceunity/core/avatar/model/Scene;
        .annotation build Ljv/d;
        .end annotation
    ...
    invoke-virtual {p0, p1, p3}, Lbk/a;->o(Lcom/faceunity/core/avatar/model/Scene;Lwj/e;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lbk/a;->v(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lwj/e;)V
