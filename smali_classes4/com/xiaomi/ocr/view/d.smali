...
.method public b(FF)Landroid/graphics/Path;
    ...
    invoke-static {v1}, Lml/a;->h(Landroid/content/Context;)I
...
.method public c(Ljava/util/List;IIIFF)Landroid/util/Pair;
    ...
    invoke-virtual {v6, v7}, Ljl/g;->d(Landroid/graphics/Path;)Z
...
.method public d(Ljava/util/List;IIIFF)Landroid/util/Pair;
    ...
    invoke-virtual {v4, p0}, Ljl/g;->d(Landroid/graphics/Path;)Z

    move-result v7

    if-eqz v7, :cond_4

    invoke-virtual {v4}, Lcom/xiaomi/ocr/view/b;->t()Ljl/a;
    ...
    invoke-virtual {v4}, Lcom/xiaomi/ocr/view/b;->u()Ljl/a;
...
.method public final e(Lcom/xiaomi/ocr/view/b;I)Landroid/util/Pair;
    ...
    invoke-virtual {v6, v7}, Ljl/a;->w(Landroid/graphics/Path;)Z
    ...
    invoke-virtual {v6, v7}, Ljl/a;->u(Landroid/graphics/Path;)Z
...
.method public final g(Lcom/xiaomi/ocr/view/b;ILandroid/graphics/PointF;)Landroid/util/Pair;
    ...
    invoke-virtual {p1, p3}, Ljl/g;->f(Landroid/graphics/PointF;)Z
    ...
    invoke-virtual {v5, p3}, Ljl/g;->f(Landroid/graphics/PointF;)Z
