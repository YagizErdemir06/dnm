...
.method public submit(Lcom/xiaomi/camera/mivi/bean/ResultImageData;Lcom/xiaomi/camera/mivi/IReProcessor$Callback;)V
    ...
    invoke-static {v4}, Lte/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {v5, v6, v7, v8, v15}, Lse/d;->n(Ljava/lang/String;JZ)Lye/w;
    ...
    invoke-virtual/range {v16 .. v16}, Lye/w;->s()Lye/x;

    move-result-object v5

    invoke-virtual {v5}, Lye/x;->h0()I
