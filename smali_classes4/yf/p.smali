...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lyf/p;->Z:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lyf/c;-><init>(Landroid/content/Context;II)V

    new-instance p1, Lyf/p$a;

    invoke-direct {p1, p0}, Lyf/p$a;-><init>(Lyf/p;)V

    iput-object p1, p0, Lyf/p;->Y:Lcom/xiaomi/idm/api/IDMProcessCallback;

    return-void
.end method

.method public static synthetic B1(Lyf/p;)Lcom/xiaomi/idm/api/IDMServer;
    .locals 0

    iget-object p0, p0, Lyf/p;->V:Lcom/xiaomi/idm/api/IDMServer;

    return-object p0
.end method

.method public static synthetic C1(Lyf/p;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lyf/p;->W:Ljava/lang/String;

    return-object p0
.end method

.method public static synthetic D1(Lyf/p;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lyf/p;->W:Ljava/lang/String;
...
.method public static synthetic M0()Ljava/lang/String;
    ...
    sget-object v0, Lyf/p;->Z:Ljava/lang/String;
...
.method public C0(Ljava/lang/String;I)V
    ...
    sget-object p2, Lyf/p;->Z:Ljava/lang/String;
    ...
    iget-object v0, p0, Lyf/p;->V:Lcom/xiaomi/idm/api/IDMServer;

    if-nez v0, :cond_0

    const-string p0, "rejectConnection: not started yet"

    invoke-static {p2, p0}, Lbg/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    iget-object v0, p0, Lyf/p;->X:Lyf/p$b;
    ...
    :cond_1
    iget-object v0, p0, Lyf/p;->W:Ljava/lang/String;
    ...
    iget-object v2, p0, Lyf/p;->X:Lyf/p$b;

    invoke-virtual {v2}, Lcom/xiaomi/idm/api/IDMService;->getServiceId()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lyf/p;->W:Ljava/lang/String;

    iget p0, p0, Lyf/c;->T:I
...
.method public E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lyf/p;->V:Lcom/xiaomi/idm/api/IDMServer;
    ...
    :cond_0
    iget-object v1, p0, Lyf/p;->W:Ljava/lang/String;
    ...
    invoke-virtual {v0, p2, v1, v2}, Lzf/c$b;->c(Ljava/lang/String;Ljava/lang/String;Z)V

    iget-object p2, p0, Lyf/c;->J:Lyf/c$i;

    iget-object v0, p0, Lyf/p;->W:Ljava/lang/String;

    const/4 v1, 0x0

    invoke-virtual {p2, v0, v1}, Lyf/c$i;->e(Ljava/lang/String;I)V
    :try_end_0
    ...
    iget-object v0, p0, Lyf/c;->J:Lyf/c$i;

    iget-object p0, p0, Lyf/p;->W:Ljava/lang/String;

    invoke-virtual {v0, p0, p1}, Lyf/c$i;->e(Ljava/lang/String;I)V

    sget-object p0, Lyf/p;->Z:Ljava/lang/String;

    const-string p1, "sendPayload: failed"

    invoke-static {p0, p1, p2}, Lbg/a;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public F0()V
    ...
    new-instance v0, Lyf/c$j;

    invoke-direct {v0, p0}, Lyf/c$j;-><init>(Lyf/c;)V

    iput-object v0, p0, Lyf/c;->L:Lyf/c$j;

    new-instance v0, Lyf/c$d;

    invoke-direct {v0, p0}, Lyf/c$d;-><init>(Lyf/c;)V

    iput-object v0, p0, Lyf/c;->M:Lyf/c$d;

    new-instance v0, Lyf/c$c;

    invoke-direct {v0, p0}, Lyf/c$c;-><init>(Lyf/c;)V

    iput-object v0, p0, Lyf/c;->N:Lyf/c$c;

    new-instance v0, Lyf/c$b;

    invoke-direct {v0, p0}, Lyf/c$b;-><init>(Lyf/c;)V

    iput-object v0, p0, Lyf/c;->O:Lyf/c$b;

    new-instance v0, Lyf/c$f;

    invoke-direct {v0, p0}, Lyf/c$f;-><init>(Lyf/c;)V

    iput-object v0, p0, Lyf/c;->R:Lyf/c$f;

    new-instance v0, Lyf/c$e;

    invoke-direct {v0, p0}, Lyf/c$e;-><init>(Lyf/c;)V

    iput-object v0, p0, Lyf/c;->S:Lyf/c$e;

    iget-object v0, p0, Lyf/c;->L:Lyf/c$j;

    invoke-virtual {p0, v0}, Lgg/d;->e(Lgg/c;)V

    iget-object v0, p0, Lyf/c;->M:Lyf/c$d;

    iget-object v1, p0, Lyf/c;->L:Lyf/c$j;

    invoke-virtual {p0, v0, v1}, Lgg/d;->f(Lgg/c;Lgg/c;)V

    iget-object v0, p0, Lyf/c;->N:Lyf/c$c;

    iget-object v1, p0, Lyf/c;->L:Lyf/c$j;

    invoke-virtual {p0, v0, v1}, Lgg/d;->f(Lgg/c;Lgg/c;)V

    iget-object v0, p0, Lyf/c;->O:Lyf/c$b;

    iget-object v1, p0, Lyf/c;->N:Lyf/c$c;

    invoke-virtual {p0, v0, v1}, Lgg/d;->f(Lgg/c;Lgg/c;)V

    iget-object v0, p0, Lyf/c;->R:Lyf/c$f;

    iget-object v1, p0, Lyf/c;->O:Lyf/c$b;

    invoke-virtual {p0, v0, v1}, Lgg/d;->f(Lgg/c;Lgg/c;)V

    iget-object v0, p0, Lyf/c;->S:Lyf/c$e;
...
.method public G0()V
    ...
    :cond_0
    new-instance v1, Lyf/p$b;

    invoke-virtual {p0}, Lyf/c;->y1()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lyf/p$b;-><init>(Lyf/p;Ljava/lang/String;)V

    iput-object v1, p0, Lyf/p;->X:Lyf/p$b;
...
.method public I0()V
    ...
    iget-object v2, p0, Lyf/c;->I:Landroid/content/Context;

    const-string v3, "apmr9571"

    iget-object v4, p0, Lyf/p;->Y:Lcom/xiaomi/idm/api/IDMProcessCallback;
    ...
    iput-object v1, p0, Lyf/p;->V:Lcom/xiaomi/idm/api/IDMServer;
...
.method public J0()V
    ...
    iget-object v1, p0, Lyf/p;->X:Lyf/p$b;
    ...
    :cond_1
    iget-object v2, p0, Lyf/p;->V:Lcom/xiaomi/idm/api/IDMServer;
...
.method public z0(Ljava/lang/String;)V
    ...
    :cond_2
    iget-object p1, p0, Lyf/p;->V:Lcom/xiaomi/idm/api/IDMServer;
