...
.method public constructor <init>(Lq7/v4;)V
    ...
    iput-object v0, p0, Luf/w;->a:Luf/t0;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Luf/w;->d:Ljava/lang/ref/WeakReference;
...
.method public static synthetic a(Lcom/android/camera2/compat/theme/custom/mm/aid/FriendRemoteDisplayProtocol;)V
    ...
    invoke-static {p0}, Luf/w;->f(Lcom/android/camera2/compat/theme/custom/mm/aid/FriendRemoteDisplayProtocol;)V

    return-void
.end method

.method public static synthetic b(Lv8/b1;)V
    .locals 0

    invoke-static {p0}, Luf/w;->e(Lv8/b1;)V

    return-void
.end method

.method public static synthetic e(Lv8/b1;)V
    .locals 4
...
.method public final d()V
    ...
    iget-object v0, p0, Luf/w;->a:Luf/t0;
    ...
    invoke-virtual {v0, v1}, Luf/t0;->t0(Z)V

    iget-object v0, p0, Luf/w;->d:Ljava/lang/ref/WeakReference;
    ...
    :goto_0
    iget-object p0, p0, Luf/w;->a:Luf/t0;

    const/16 v1, 0xa7

    invoke-virtual {p0, v1, v0}, Luf/t0;->k0(ILjava/lang/String;)V
...
.method public g()V
    ...
    iget-object v1, p0, Luf/w;->a:Luf/t0;

    invoke-virtual {v1, v0}, Luf/t0;->v0(Z)V

    invoke-static {}, Luf/t0;->F()Luf/t0;

    move-result-object v1

    invoke-virtual {v1}, Luf/t0;->E()Luf/e;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Luf/e;->q()Z

    move-result v1

    iput-boolean v1, p0, Luf/w;->e:Z
...
.method public h()V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ActivityBase;->Qi()Z

    move-result v1

    invoke-virtual {v0}, Lcom/android/camera/ActivityBase;->Oi()Z
    ...
    invoke-virtual {p0, v0}, Luf/t0;->v0(Z)V
...
.method public j()V
    ...
    invoke-virtual {p0}, Luf/w;->l()V

    iget-object v1, p0, Luf/w;->a:Luf/t0;

    invoke-virtual {v1, p0}, Luf/t0;->y(Luf/s;)V

    iget-object v1, p0, Luf/w;->d:Ljava/lang/ref/WeakReference;
    ...
    iget-object v2, p0, Luf/w;->a:Luf/t0;

    invoke-virtual {v2}, Luf/t0;->H()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p0}, Luf/w;->c()V

    iget-object v2, p0, Luf/w;->a:Luf/t0;

    invoke-virtual {v2, v0}, Luf/t0;->t0(Z)V
...
.method public k()V
    ...
    iget-object p0, p0, Luf/w;->d:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0}, Lq7/v4;->Wb()V
...
.method public final l()V
    ...
    iput-object v0, p0, Luf/w;->b:Landroid/net/ConnectivityManager;

    new-instance v0, Luf/w$a;

    invoke-direct {v0, p0}, Luf/w$a;-><init>(Luf/w;)V

    iput-object v0, p0, Luf/w;->c:Landroid/net/ConnectivityManager$NetworkCallback;

    iget-object v0, p0, Luf/w;->b:Landroid/net/ConnectivityManager;
    ...
    iget-object p0, p0, Luf/w;->c:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method public onChannelClose(Z)V
    ...
    :cond_0
    iget-object p1, p0, Luf/w;->d:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0}, Lq7/v4;->h9()V
