...
.method public constructor <init>(Lye/k$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lye/c;-><init>(Lye/k$a;Lcom/xiaomi/engine/BufferFormat;)V
...
.method public X(Lye/h0;)V
    ...
    invoke-virtual {p1}, Lye/h0;->f()Ljm/c;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lye/g;->g0(Lye/h0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lye/g;->h0(Lye/h0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Lye/c;->K:Landroid/media/ImageReader;

    new-instance v2, Lye/g$a;

    invoke-direct {v2, p0}, Lye/g$a;-><init>(Lye/g;)V
    ...
    iget-object v2, p0, Lye/c;->K:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Lye/c;->L:Landroid/media/ImageReader;

    new-instance v2, Lye/g$b;

    invoke-direct {v2, p0}, Lye/g$b;-><init>(Lye/g;)V
    ...
    iget-object v2, p0, Lye/c;->L:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lye/c;->M:Landroid/media/ImageReader;

    new-instance v1, Lye/g$c;

    invoke-direct {v1, p0}, Lye/g$c;-><init>(Lye/g;)V
    ...
    iget-object p0, p0, Lye/c;->M:Landroid/media/ImageReader;
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_2
    new-instance p1, Lye/g$d;

    invoke-direct {p1, p0}, Lye/g$d;-><init>(Lye/g;)V
    ...
    iget-object p1, p0, Lye/c;->O:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Lye/c;->I:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Lye/c;->J:Lye/j0;

    invoke-virtual {p2}, Lye/j0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Lye/g$e;

    invoke-direct {p1, p0}, Lye/g$e;-><init>(Lye/g;)V
...
.method public final g0(Lye/h0;)V
    .locals 9
    .param p1    # Lye/h0;
    ...
    invoke-virtual {v1}, Lye/e$a;->k()Landroid/media/Image;

    move-result-object v3

    invoke-virtual {p0, v2}, Lye/k;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Lye/k;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Lte/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v1}, Lye/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p1}, Lye/h0;->e()I

    move-result v4

    invoke-virtual {p0, v1, v2, v7, v4}, Lye/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Lye/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final h0(Lye/h0;)V
    .locals 7
    .param p1    # Lye/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Lte/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v2, v5, v4}, Lye/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public p()Z
    ...
    iget-object v1, p0, Lye/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lye/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lye/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lye/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Lye/k$a;->g(Lye/k;)Z
    ...
    iget-object p0, p0, Lye/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
