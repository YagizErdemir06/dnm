...
.method public constructor <init>(Lye/d0;)V
    ...
    iput-object p1, p0, Lye/d0$e;->a:Lye/d0;
...
.method public a(JI)V
    ...
    iget-object v0, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {v0}, Lye/d0;->p(Lye/d0;)Lye/d0$j;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lye/d0$e;->c(J)Lye/w;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lye/w;->i0()Z
    ...
    iget-object p0, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p0}, Lye/d0;->p(Lye/d0;)Lye/d0$j;

    move-result-object p0

    invoke-interface {p0, v0, p3}, Lye/d0$j;->a(Lye/w;I)V
...
.method public b(Landroid/media/Image;)V
    ...
    invoke-static {p0}, Lye/d0;->i(Lye/d0;)Lye/f;

    move-result-object p0

    invoke-interface {p0, p1}, Lye/f;->b(Landroid/media/Image;)V

    return-void
.end method

.method public c(J)Lye/w;
    .locals 0

    iget-object p0, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p0, p1, p2}, Lye/d0;->N(Lye/d0;J)Lye/w;
...
.method public d(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, Lye/d0$e;->i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, p2}, Lye/d0$e;->j(Lcom/xiaomi/engine/ResultData;)V

    :goto_0
    return-void
.end method

.method public e(Landroid/media/Image;IZ)V
    .locals 16
    ...
    invoke-static {v8, v13}, Lte/e;->d(II)V

    invoke-static/range {p1 .. p1}, Lte/d;->g(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_12

    iget-object v1, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v1}, Lye/d0;->m(Lye/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    :cond_0
    invoke-virtual {v1, v9, v10}, Lye/d0$e;->c(J)Lye/w;
    ...
    invoke-virtual {v15}, Lye/w;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Lye/w;->s()Lye/x;

    move-result-object v3

    invoke-virtual {v3}, Lye/x;->o0()I
    ...
    invoke-static {v5}, Lte/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_8

    invoke-virtual {v3}, Lye/x;->R0()Z
    ...
    iget-object v2, v1, Lye/d0$e;->a:Lye/d0;
    ...
    invoke-static/range {v2 .. v7}, Lye/d0;->n(Lye/d0;Lye/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-static {v3, v0, v7}, Lte/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v3

    iget-object v4, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v4}, Lye/d0;->i(Lye/d0;)Lye/f;

    move-result-object v4

    invoke-interface {v4, v0}, Lye/f;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v3}, Lye/d0;->q(Lye/d0;)Ll9/h;

    move-result-object v3

    iget-object v4, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v4}, Lye/d0;->o(Lye/d0;)Ll9/d$a;

    move-result-object v4

    invoke-virtual {v3, v0, v2, v15, v4}, Ll9/h;->s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lye/w;Ll9/d$a;)V

    invoke-static {v5}, Lte/c;->c(I)Z

    move-result v0

    if-eqz v0, :cond_7

    iget-object v0, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v0}, Lye/d0;->r(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lye/d0;->s(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lye/d0;->t(Lye/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lye/d0;->u(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lye/d0;->v(Lye/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v15}, Lye/w;->J()I

    move-result v5

    invoke-virtual {v15}, Lye/w;->I()I

    move-result v6

    invoke-virtual {v15}, Lye/w;->d()Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v15}, Lye/w;->P()F

    move-result v8

    invoke-static {v3, v5, v6, v7, v8}, Lcom/android/camera/a6;->M(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v0}, Lye/d0;->u(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lye/d0;->s(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v2}, Lye/d0;->m(Lye/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v2}, Lye/d0;->u(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lye/d0;->s(Lye/d0;)Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v7}, Lye/d0$e;->h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLye/w;J)V
    ...
    invoke-static {v2, v0, v3}, Lte/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v3}, Lye/d0;->i(Lye/d0;)Lye/f;

    move-result-object v3

    invoke-interface {v3, v0}, Lye/f;->b(Landroid/media/Image;)V

    iget-object v0, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v0, v9, v10, v2}, Lye/d0;->w(Lye/d0;JLandroid/media/Image;)V
    ...
    invoke-static {v1, v9, v10, v0}, Lye/d0;->w(Lye/d0;JLandroid/media/Image;)V
...
.method public f(JLjava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, Lye/d0;->l(Lye/d0;J)Lye/w;

    return-void
.end method

.method public g(Lye/k;)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lye/r;->z(Lye/k;)Z
...
.method public final h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLye/w;J)V
    .locals 6
    ...
    invoke-static {p2}, Lte/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p4, v3, v0}, Lye/w;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Lye/w;->a0(Ljava/lang/String;)Z

    move-result p2

    if-nez p2, :cond_2

    sget-boolean p2, Lye/d0;->U:Z
    ...
    invoke-virtual {p4, p2}, Lye/w;->V0(Z)V
    ...
    iget-object p2, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p2}, Lye/d0;->q(Lye/d0;)Ll9/h;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, Ll9/h;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lye/d0$e;->a:Lye/d0;

    invoke-virtual {p4}, Lye/w;->O()Landroid/media/Image;

    move-result-object p3

    invoke-static {p2, p3}, Lye/d0;->x(Lye/d0;Landroid/media/Image;)V

    if-eqz p1, :cond_3

    invoke-virtual {p4}, Lye/w;->u0()V

    :cond_3
    iget-object p1, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p1, p4}, Lye/d0;->y(Lye/d0;Lye/w;)Z
    ...
    invoke-static {p1}, Lye/d0;->p(Lye/d0;)Lye/d0$j;
    ...
    invoke-interface {p1, p4}, Lye/d0$j;->b(Lye/w;)V
    ...
    invoke-static {p1}, Lye/d0;->B(Lye/d0;)I

    iget-object p1, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p1, p5, p6}, Lye/d0;->l(Lye/d0;J)Lye/w;

    move-result-object p1

    iget-object p2, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p2}, Lye/d0;->z(Lye/d0;)I

    move-result p3

    invoke-static {p2, p1, p3}, Lye/d0;->C(Lye/d0;Lye/w;I)Z
    ...
    invoke-static {p1}, Lye/d0;->D(Lye/d0;)V

    iget-object p1, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p1, v0}, Lye/d0;->A(Lye/d0;I)I

    :cond_5
    iget-object p1, p0, Lye/d0$e;->a:Lye/d0;

    invoke-static {p1}, Lye/d0;->F(Lye/d0;)V
...
.method public final i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, v0, v1}, Lye/d0$e;->c(J)Lye/w;
    ...
    invoke-static {p1}, Lye/l;->a(Lcom/xiaomi/engine/ResultData;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lye/z;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lye/x;->U0(B)V

    invoke-virtual {v0, p1}, Lye/z;->d0(B)V
...
.method public final j(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {v1, v2, v3}, Lye/d0$e;->c(J)Lye/w;
    ...
    :goto_1
    iget-object v11, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v11}, Lye/d0;->u(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v11, v12}, Lye/d0;->v(Lye/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, v7}, Lye/d0;->t(Lye/d0;Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v7, v1, Lye/d0$e;->a:Lye/d0;

    invoke-static {v7}, Lye/d0;->u(Lye/d0;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lye/w;->J()I

    move-result v8

    invoke-virtual {v4}, Lye/w;->I()I

    move-result v11

    invoke-virtual {v4}, Lye/w;->d()Landroid/graphics/Rect;

    move-result-object v12

    invoke-virtual {v4}, Lye/w;->P()F

    move-result v4

    invoke-static {v7, v8, v11, v12, v4}, Lcom/android/camera/a6;->M(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v4}, Lye/d0;->m(Lye/d0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v4}, Lye/d0;->s(Lye/d0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lye/d0;->u(Lye/d0;)Ljava/util/Map;
