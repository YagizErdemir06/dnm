...
.method public constructor <init>(Lye/d0;)V
    ...
    iput-object p1, p0, Lye/d0$c;->a:Lye/d0;
...
.method public a(Lye/e;)V
    ...
    invoke-virtual {p0, p1, v0}, Lye/d0$c;->d(Lye/e;Ljava/lang/String;)V
...
.method public c(Lye/e;)V
    ...
    iget-object v5, p0, Lye/d0$c;->a:Lye/d0;

    invoke-virtual {v5}, Lye/d0;->z0()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lye/e;->n()Lye/e$a;

    move-result-object v5

    if-eqz v5, :cond_e

    iget-object v6, p0, Lye/d0$c;->a:Lye/d0;

    invoke-static {v6, v7, v8}, Lye/d0;->N(Lye/d0;J)Lye/w;

    move-result-object v6

    invoke-virtual {v5}, Lye/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v6, v9, v10}, Lye/w;->r1(J)V

    iget-object v11, p0, Lye/d0$c;->a:Lye/d0;

    invoke-static {v11, v7, v8}, Lye/d0;->l(Lye/d0;J)Lye/w;

    iget-object v11, p0, Lye/d0$c;->a:Lye/d0;

    invoke-static {v11, v9, v10, v6}, Lye/d0;->K(Lye/d0;JLye/w;)V

    :cond_1
    if-ne v1, v0, :cond_4

    iget-object v1, p0, Lye/d0$c;->a:Lye/d0;
    ...
    invoke-virtual {p1}, Lye/e;->l()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lye/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, p0, Lye/d0$c;->a:Lye/d0;

    invoke-static {v4, v7, v8}, Lye/d0;->N(Lye/d0;J)Lye/w;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4, v1}, Lye/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {v4}, Lye/w;->s()Lye/x;

    move-result-object v1

    invoke-virtual {v1}, Lye/x;->V0()Z
    ...
    invoke-virtual {v4}, Lye/w;->K()Ljm/c;
    ...
    invoke-direct/range {v0 .. v6}, Lye/h0;-><init>(Ljava/util/List;ZJZLjm/c;)V

    invoke-virtual {p1}, Lye/e;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Lye/h0;->h(I)V
    ...
    iget-object v0, p1, Lye/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lye/k;->e(Lye/h0;)I

    goto/16 :goto_1

    :cond_8
    iget-object p1, p0, Lye/d0$c;->a:Lye/d0;

    invoke-static {p1}, Lye/d0;->d(Lye/d0;)Lye/k$a;

    move-result-object p1

    invoke-interface {p1, v7, v8, v3}, Lye/k$a;->a(JI)V
    ...
    invoke-interface {p1, v0, v3, v3}, Lye/k$a;->e(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lye/d0$c;->b(Landroid/media/Image;)V
    ...
    :cond_a
    iget-object v0, p0, Lye/d0$c;->a:Lye/d0;

    invoke-static {v0, v7, v8}, Lye/d0;->N(Lye/d0;J)Lye/w;
    ...
    invoke-virtual {v5}, Lye/e$a;->e()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0, v6}, Lye/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v5, v1, v4}, Lte/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    invoke-direct {v5, v4, v3, v6}, Lye/i;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {v0, v5}, Lye/k;->d(Lye/i;)V
    ...
    :cond_b
    invoke-virtual {p0, v1}, Lye/d0$c;->b(Landroid/media/Image;)V

    goto :goto_1

    :cond_c
    invoke-virtual {p0, p1, v1}, Lye/d0$c;->d(Lye/e;Ljava/lang/String;)V
...
.method public final d(Lye/e;Ljava/lang/String;)V
    .locals 13
    .param p1    # Lye/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v7}, Lye/e$a;->p()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v7}, Lye/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v5, v9, v10}, Lye/d0;->N(Lye/d0;J)Lye/w;
    ...
    iget-object v7, p0, Lye/d0$c;->a:Lye/d0;

    invoke-virtual {p1}, Lye/e;->b()I

    move-result v9

    invoke-static {v7, p1, v9}, Lye/d0;->O(Lye/d0;Lye/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    invoke-virtual {v5, v7}, Lye/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v7, v10, v11}, Lye/d0;->N(Lye/d0;J)Lye/w;
    ...
    iget-object v8, p0, Lye/d0$c;->a:Lye/d0;

    invoke-virtual {p1}, Lye/e;->b()I

    move-result v9

    invoke-static {v8, p1, v9}, Lye/d0;->O(Lye/d0;Lye/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v8

    invoke-virtual {v7, v8}, Lye/w;->G0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, p2, p0}, Lye/d0;->k(Lye/d0;Lye/e$a;Lye/f;)V
    ...
    invoke-virtual {v0}, Lye/h0;->a()Z

    move-result v5

    if-eqz v5, :cond_9

    iget-object v5, v4, Lye/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object p0, p0, Lye/d0$c;->a:Lye/d0;
    ...
    invoke-virtual {v0, v2}, Lye/h0;->i(I)V

    :cond_b
    if-eqz v4, :cond_c

    invoke-virtual {v4, v0}, Lye/k;->e(Lye/h0;)I
