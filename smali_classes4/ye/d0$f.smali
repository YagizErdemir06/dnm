...
.method public constructor <init>(Lye/d0;)V
    ...
    iput-object p1, p0, Lye/d0$f;->a:Lye/d0;
...
# virtual methods
.method public final a(Lye/w;J)V
    .locals 11
    ...
    invoke-virtual {p1, v0}, Lye/w;->g1(I)V
    ...
    invoke-virtual {p1}, Lye/w;->k()Ljava/lang/String;
    ...
    invoke-direct/range {v2 .. v10}, Lye/e;-><init>(IIIJLjava/lang/String;ZLye/k;)V

    invoke-virtual {p1}, Lye/w;->f()I

    move-result p2

    invoke-virtual {v0, p2}, Lye/e;->D(I)V

    iget-object p0, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p0}, Lye/d0;->M(Lye/d0;)Lye/r$e;

    move-result-object p0

    invoke-virtual {v0, p0}, Lye/e;->H(Lye/r$e;)V

    const/4 p0, 0x1

    invoke-virtual {v0, p0}, Lye/e;->Q(Z)V

    invoke-virtual {v0, p0}, Lye/e;->L(Z)V

    invoke-static {}, Lye/r;->w()Lye/r;

    move-result-object p2

    invoke-virtual {p2, v0}, Lye/r;->G(Lye/e;)V
    ...
    invoke-virtual {p2, p1, p0}, Lye/r;->B(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public onEarlyMetaAvailable(Lcom/xiaomi/camera/isp/ISPResult;)V
    ...
    iget-object v0, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {v0}, Lye/d0;->E(Lye/d0;)Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p0}, Lye/d0;->E(Lye/d0;)Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0, v0, v1, p1}, Lye/j;->a(ILjava/lang/String;Ljava/lang/Object;)V
...
.method public onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v3}, Lte/e;->d(II)V

    iget-object p1, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p1, v1, v2}, Lye/d0;->N(Lye/d0;J)Lye/w;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object v3, p0, Lye/d0$f;->a:Lye/d0;

    invoke-virtual {p1}, Lye/w;->O()Landroid/media/Image;

    move-result-object v4

    invoke-static {v3, v4}, Lye/d0;->x(Lye/d0;Landroid/media/Image;)V

    invoke-virtual {p1}, Lye/w;->u0()V

    iget-object p1, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p1, v1, v2}, Lye/d0;->l(Lye/d0;J)Lye/w;
...
.method public onJpegAvailable([BLjava/lang/String;)V
    ...
    invoke-static {v3, v1, v2}, Lye/d0;->N(Lye/d0;J)Lye/w;
    ...
    invoke-virtual {v3, p1, p2}, Lye/w;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {v3, p2}, Lye/w;->a0(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object p2, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p2}, Lye/d0;->G(Lye/d0;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v4, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {v4}, Lye/d0;->H(Lye/d0;)Ljava/util/HashMap;
    ...
    invoke-static {v4, v1, v2}, Lye/d0;->l(Lye/d0;J)Lye/w;
    ...
    invoke-virtual {v3, p2}, Lye/w;->V0(Z)V

    invoke-virtual {v3}, Lye/w;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {p1}, Lye/d0;->q(Lye/d0;)Ll9/h;

    move-result-object p1

    const/4 v4, 0x0

    invoke-virtual {p1, v3, p2, v4, v4}, Ll9/h;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lye/d0$f;->a:Lye/d0;

    invoke-virtual {v3}, Lye/w;->O()Landroid/media/Image;

    move-result-object v4

    invoke-static {p2, v4}, Lye/d0;->x(Lye/d0;Landroid/media/Image;)V

    if-eqz p1, :cond_3

    invoke-virtual {v3}, Lye/w;->u0()V

    :cond_3
    iget-object p1, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p1, v3}, Lye/d0;->y(Lye/d0;Lye/w;)Z
    ...
    invoke-interface {p1, v3}, Lye/d0$j;->b(Lye/w;)V
    ...
    invoke-static {p1}, Lye/d0;->z(Lye/d0;)I

    move-result p2

    invoke-static {p1, v3, p2}, Lye/d0;->C(Lye/d0;Lye/w;I)Z
...
.method public onJpegImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-static {v4, v1, v2}, Lye/d0;->N(Lye/d0;J)Lye/w;
    ...
    :cond_1
    invoke-virtual {v4, v7, p2}, Lye/w;->a([BI)V
    ...
    invoke-virtual {v4, p1}, Lye/w;->M0([B)V

    invoke-virtual {v4}, Lye/w;->s()Lye/x;

    move-result-object p2

    invoke-virtual {p2}, Lye/x;->p0()Landroid/util/Size;
    ...
    invoke-virtual {p2}, Lye/x;->i0()I

    move-result v8

    invoke-static {v3, v6, v8}, Lra/c;->k(III)Landroid/graphics/Rect;
    ...
    invoke-virtual {v4, v3}, Lye/w;->J0(Landroid/graphics/Rect;)V

    sget-boolean p2, Lcom/android/camera/a6;->r0:Z

    if-eqz p2, :cond_2

    invoke-virtual {v4}, Lye/w;->L()Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lcom/android/camera/a6;->k4([BLjava/lang/String;)V

    :cond_2
    const-string p1, "JPEG"

    invoke-virtual {v4, p1}, Lye/w;->a0(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, p2}, Lye/w;->V0(Z)V

    invoke-virtual {v4}, Lye/w;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object p3, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p3}, Lye/d0;->q(Lye/d0;)Ll9/h;

    move-result-object p3

    invoke-virtual {p3, v4, p2, v6, p1}, Ll9/h;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v4, p2, v6, v6}, Ll9/h;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-virtual {v4}, Lye/w;->O()Landroid/media/Image;
    ...
    invoke-virtual {v4}, Lye/w;->u0()V

    :cond_6
    iget-object p1, p0, Lye/d0$f;->a:Lye/d0;

    invoke-static {p1, v4}, Lye/d0;->y(Lye/d0;Lye/w;)Z
    ...
    invoke-interface {p1, v4}, Lye/d0$j;->b(Lye/w;)V
...
.method public onTuningImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v1, v2}, Lye/d0;->N(Lye/d0;J)Lye/w;
    ...
    invoke-virtual {p0, v5, v1, v2}, Lye/d0$f;->a(Lye/w;J)V
    ...
    invoke-virtual {p0, p1, p2, v3, p3}, Lye/r;->A(Landroid/media/Image;IIZ)V
    ...
    invoke-static/range {v4 .. v9}, Lye/d0;->I(Lye/d0;Lye/w;Landroid/media/Image;Ljava/lang/String;IZ)V
...
.method public onYuvAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v6}, Lye/w;->e()I

    move-result v4

    invoke-static {v4}, Lte/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v6}, Lye/w;->i0()Z

    move-result p2

    if-nez p2, :cond_1

    invoke-virtual {p0, v6, v1, v2}, Lye/d0$f;->a(Lye/w;J)V
    ...
    invoke-virtual {p0, p1, v0, v3, p3}, Lye/r;->A(Landroid/media/Image;IIZ)V

    goto :goto_0

    :cond_2
    iget-object v5, p0, Lye/d0$f;->a:Lye/d0;
    ...
    invoke-static/range {v5 .. v10}, Lye/d0;->I(Lye/d0;Lye/w;Landroid/media/Image;Ljava/lang/String;IZ)V
