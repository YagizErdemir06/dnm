...
.method public constructor <init>(Lwl/f;)V
    ...
    iput-object p1, p0, Lbm/a;->a:Lwl/f;

    invoke-virtual {p0}, Lbm/a;->c()V

    invoke-virtual {p0}, Lbm/a;->b()V
...
# virtual methods
.method public a(ILul/b;ILul/b;II[FLandroid/graphics/Rect;Lyl/h;)I
    .locals 6

    invoke-virtual {p9}, Lyl/h;->u()V

    const-string v0, "clear error!"

    invoke-static {v0}, Lsg/h;->k(Ljava/lang/String;)V

    invoke-static {p3}, Lsg/h;->p(I)V

    if-eqz p3, :cond_0

    invoke-virtual {p9}, Lyl/h;->k()V

    :cond_0
    iget p3, p0, Lbm/a;->c:I
    ...
    iget p3, p0, Lbm/a;->g:I

    invoke-static {p3}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    iget p3, p0, Lbm/a;->h:I
    ...
    invoke-virtual {p9, v0, p5, v0, p6}, Lyl/h;->r(FFFF)V
    ...
    invoke-virtual {p9, p5, p6, v0}, Lyl/h;->E(FFF)V
    ...
    invoke-virtual {p9, p5, p6, p8}, Lyl/h;->w(FFF)V
    ...
    invoke-virtual/range {v0 .. v5}, Lbm/a;->d(ILul/b;Lul/b;[FLyl/h;)V
    ...
    iget p1, p0, Lbm/a;->g:I

    invoke-static {p1}, Landroid/opengl/GLES20;->glDisableVertexAttribArray(I)V

    iget p0, p0, Lbm/a;->h:I

    invoke-static {p0}, Landroid/opengl/GLES20;->glDisableVertexAttribArray(I)V

    invoke-virtual {p9}, Lyl/h;->s()V

    const-string p0, "check error!"

    invoke-static {p0}, Lsg/h;->k(Ljava/lang/String;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lbm/a;->k:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lbm/a;->k:Ljava/nio/FloatBuffer;

    :cond_0
    iget-object v0, p0, Lbm/a;->a:Lwl/f;

    sget-object v1, Lwl/f;->b:Lwl/f;

    if-ne v0, v1, :cond_1

    iget-object v0, p0, Lbm/a;->l:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lbm/a;->l:Ljava/nio/FloatBuffer;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lbm/a;->m:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lbm/a;->m:Ljava/nio/FloatBuffer;
...
.method public final c()V
    ...
    iget-object v1, p0, Lbm/a;->a:Lwl/f;
    ...
    sget-object v0, Lbm/a$a;->a:[I

    iget-object v2, p0, Lbm/a;->a:Lwl/f;
    ...
    invoke-static {v1, v0}, Lzl/a;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final d(ILul/b;Lul/b;[FLyl/h;)V
    .locals 16
    ...
    invoke-virtual/range {p5 .. p5}, Lyl/h;->c()F

    move-result v3

    invoke-virtual/range {p5 .. p5}, Lyl/h;->d()F

    move-result v4

    iget-object v5, v0, Lbm/a;->a:Lwl/f;

    sget-object v6, Lwl/f;->b:Lwl/f;
    ...
    :cond_0
    invoke-virtual/range {p5 .. p5}, Lyl/h;->i()[F
    ...
    :goto_2
    iget v7, v0, Lbm/a;->d:I

    invoke-virtual/range {p5 .. p5}, Lyl/h;->e()[F
    ...
    sget-object v7, Lul/b;->f:Lul/b;

    if-ne v1, v7, :cond_3

    sget-object v7, Lul/b;->i:Lul/b;
    ...
    :cond_4
    :goto_3
    iget v3, v0, Lbm/a;->o:I

    if-eq v3, v5, :cond_6

    sget-object v5, Lul/b;->a:Lul/b;

    if-ne v1, v5, :cond_5

    sget-object v1, Lul/b;->e:Lul/b;
    ...
    iget-object v15, v0, Lbm/a;->k:Ljava/nio/FloatBuffer;

    invoke-static/range {v10 .. v15}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    iget-object v1, v0, Lbm/a;->a:Lwl/f;

    if-ne v1, v6, :cond_7

    iget v1, v0, Lbm/a;->h:I
    ...
    iget-object v0, v0, Lbm/a;->l:Ljava/nio/FloatBuffer;
    ...
    iget-object v0, v0, Lbm/a;->m:Ljava/nio/FloatBuffer;
