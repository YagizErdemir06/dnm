...
# direct methods
.method public varargs constructor <init>(Ljava/lang/String;Laf/a;Laf/g;Z[Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Laf/d;-><init>(Ljava/lang/String;Laf/a;)V

    iput-boolean p4, p0, Laf/f;->g:Z

    iput-object p5, p0, Laf/f;->f:[Ljava/lang/String;

    new-instance p1, Lze/l;

    invoke-direct {p1, p3}, Lze/l;-><init>(Laf/g;)V

    iput-object p1, p0, Laf/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
...
.method public c()Laf/b;
    ...
    iget-object v1, p0, Laf/d;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lze/a$c;->b(Ljava/lang/String;)Lze/a$b;

    move-result-object v0

    iget-object v1, v0, Lze/a$b;->e:Lya/a;
    ...
    iget-object v1, v0, Lze/a$b;->d:Lya/f;
    ...
    iget-boolean v3, p0, Laf/f;->g:Z

    invoke-virtual {v1, v3}, Lya/a;->d(Z)V

    :cond_0
    iget-object p0, p0, Laf/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    invoke-direct {p0, v2}, Laf/b;-><init>(Ljava/lang/Exception;)V
    ...
    iget-boolean v5, v1, Lze/a$b;->a:Z

    const/4 v6, 0x2

    if-eqz v5, :cond_4

    iget-object v0, p0, Laf/d;->a:Ljava/lang/String;

    new-array v5, v6, [Ljava/lang/Object;

    iget-object v1, v1, Lze/a$b;->g:Ljava/lang/String;
    ...
    iget-object v0, p0, Laf/f;->f:[Ljava/lang/String;

    invoke-static {v0}, Lze/e;->e([Ljava/lang/String;)V

    invoke-static {p0}, Lze/e;->c(Laf/d;)V
    ...
    :cond_4
    iget-boolean v5, v1, Lze/a$b;->b:Z
    ...
    iget-object p0, p0, Laf/d;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Laf/d;->c:Ljava/lang/String;
    ...
    iget-object v6, p0, Laf/d;->c:Ljava/lang/String;
    ...
    iget-object v1, v1, Lze/a$c;->a:Landroid/hardware/camera2/CameraManager;

    iget-object v5, p0, Laf/d;->c:Ljava/lang/String;

    iget-object v6, p0, Laf/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    invoke-virtual {v1, v5}, Lze/a$c;->b(Ljava/lang/String;)Lze/a$b;

    move-result-object v1

    iput-boolean v4, v1, Lze/a$b;->a:Z
    ...
    invoke-direct {v1, v2}, Laf/b;-><init>(Ljava/lang/Exception;)V
    :try_end_0
    ...
    iget-object v5, p0, Laf/d;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Laf/d;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Laf/b;-><init>(Ljava/lang/Exception;)V
