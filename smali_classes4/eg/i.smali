...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Leg/i;->b:Lio/reactivex/Scheduler;

    new-instance v0, Leg/i$a;

    invoke-direct {v0}, Leg/i$a;-><init>()V

    sput-object v0, Leg/i;->e:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Leg/i;->c:Lio/reactivex/Scheduler;
    ...
    sput-object v0, Leg/i;->f:Lio/reactivex/Scheduler;
    ...
    sput-object v0, Leg/i;->g:Lio/reactivex/Scheduler;

    sget-object v0, Lcom/android/camera/x2;->h:Lcom/android/camera/x2;

    invoke-static {v0}, Lio/reactivex/schedulers/Schedulers;->from(Ljava/util/concurrent/Executor;)Lio/reactivex/Scheduler;

    move-result-object v0

    sput-object v0, Leg/i;->h:Lio/reactivex/Scheduler;
    ...
    sput-object v0, Leg/i;->i:Lio/reactivex/Scheduler;
...
.method public static synthetic a(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-static {p0}, Leg/i;->n(Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public static synthetic b(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-static {p0}, Leg/i;->m(Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public static synthetic c(Ljava/lang/Runnable;Ljava/lang/Long;)V
    ...
    invoke-static {p0, p1}, Leg/i;->l(Ljava/lang/Runnable;Ljava/lang/Long;)V
...
.method public static synthetic d(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-static {p0}, Leg/i;->o(Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public static synthetic e(Ljava/lang/Runnable;Ljava/lang/Boolean;)V
    ...
    invoke-static {p0, p1}, Leg/i;->k(Ljava/lang/Runnable;Ljava/lang/Boolean;)V
...
.method public static synthetic f(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-static {p0}, Leg/i;->q(Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public static synthetic g(Ljava/lang/Runnable;)V
    ...
    invoke-static {p0}, Leg/i;->p(Ljava/lang/Runnable;)V
...
.method public static synthetic h()Ljava/lang/ThreadLocal;
    ...
    sget-object v0, Leg/i;->e:Ljava/lang/ThreadLocal;
...
.method public static i()Z
    ...
    sget-object v1, Leg/i;->e:Ljava/lang/ThreadLocal;
...
.method public static synthetic m(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-direct {v1, p0}, Leg/i$b;-><init>(Ljava/lang/Runnable;)V
...
.method public static synthetic n(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    new-instance v1, Leg/i$c;

    invoke-direct {v1, p0}, Leg/i$c;-><init>(Ljava/lang/Runnable;)V
...
.method public static synthetic o(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    new-instance v1, Leg/i$d;

    invoke-direct {v1, p0}, Leg/i$d;-><init>(Ljava/lang/Runnable;)V
...
.method public static synthetic q(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    invoke-direct {v1, p0}, Leg/c;-><init>(Ljava/lang/Runnable;)V
...
.method public static r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v0, p1}, Leg/b;-><init>(Ljava/lang/Runnable;)V
...
.method public static s(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {p2, p1}, Leg/d;-><init>(Ljava/lang/Runnable;)V
