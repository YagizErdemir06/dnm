...
.field public final l:Lnm/d0;
    .annotation build Ljv/d;
    .end annotation
.end field

.field public final m:Lak/b$c;
    .annotation build Ljv/d;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lak/b;->d:[F

    new-instance v0, Lak/b$b;

    invoke-direct {v0, p0}, Lak/b$b;-><init>(Lak/b;)V

    invoke-static {v0}, Lnm/f0;->b(Ljn/a;)Lnm/d0;

    move-result-object v0

    iput-object v0, p0, Lak/b;->g:Lnm/d0;

    new-instance v0, Lak/b$a;

    invoke-direct {v0, p0}, Lak/b$a;-><init>(Lak/b;)V

    invoke-static {v0}, Lnm/f0;->b(Ljn/a;)Lnm/d0;

    move-result-object v0

    iput-object v0, p0, Lak/b;->l:Lnm/d0;

    new-instance v0, Lak/b$c;

    invoke-direct {v0, p0}, Lak/b$c;-><init>(Lak/b;)V

    iput-object v0, p0, Lak/b;->m:Lak/b$c;

    return-void
.end method

.method public static synthetic a(Lak/b;Ljava/util/concurrent/CountDownLatch;)V
    .locals 0

    invoke-static {p0, p1}, Lak/b;->g(Lak/b;Ljava/util/concurrent/CountDownLatch;)V

    return-void
.end method

.method public static final synthetic b(Lak/b;)I
    .locals 0

    iget p0, p0, Lak/b;->c:I

    return p0
.end method

.method public static final synthetic c(Lak/b;)I
    .locals 0

    iget p0, p0, Lak/b;->b:I

    return p0
.end method

.method public static final synthetic d(Lak/b;)Lak/b$c;
    .locals 0

    iget-object p0, p0, Lak/b;->m:Lak/b$c;

    return-object p0
.end method

.method public static final synthetic e(Lak/b;Landroid/graphics/Bitmap;)V
    .locals 0

    iput-object p1, p0, Lak/b;->h:Landroid/graphics/Bitmap;

    return-void
.end method

.method public static final g(Lak/b;Ljava/util/concurrent/CountDownLatch;)V
    .locals 1
    ...
    invoke-virtual {p0}, Lak/b;->cacheLastBitmap()V

    :cond_0
    invoke-virtual {p0}, Lak/b;->releaseGLResource()V
...
.method public static synthetic j(Lak/b;IIIILjava/lang/Object;)Lak/b;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lak/b;->i(III)Lak/b;
...
.method public buildFURenderInputData()Lcom/faceunity/core/entity/FURenderInputData;
    ...
    invoke-virtual {p0}, Lak/b;->getMEmptyTextureInputData()Lcom/faceunity/core/entity/FURenderInputData;
...
.method public final cacheLastBitmap()V
    ...
    :cond_0
    iget-object v1, p0, Lak/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
    ...
    invoke-virtual {p0}, Lak/b;->getMFUPhotoRecordHelper()Lcom/faceunity/core/media/photo/FUPhotoRecordHelper;
...
.method public final drawCacheBitmap()V
    ...
    iget-object v0, p0, Lak/b;->h:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lak/b;->deleteCacheBitmapTexId()V

    invoke-static {v0}, Lcom/faceunity/toolbox/utils/FUGLUtils;->createImageTexture(Landroid/graphics/Bitmap;)I

    move-result v1

    iput v1, p0, Lak/b;->i:I
...
.method public drawRenderFrame()V
    ...
    invoke-virtual {p0}, Lak/b;->drawCacheBitmap()V
    ...
    :goto_0
    iput v0, p0, Lak/b;->k:I

    if-lez v0, :cond_3

    iget-object v2, p0, Lak/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public final getMEmptyTextureInputData()Lcom/faceunity/core/entity/FURenderInputData;
    ...
    iget-object p0, p0, Lak/b;->l:Lnm/d0;
...
.method public final getMFUPhotoRecordHelper()Lcom/faceunity/core/media/photo/FUPhotoRecordHelper;
    ...
    iget-object p0, p0, Lak/b;->g:Lnm/d0;
...
.method public final h(II)Lak/b;
    .locals 6
...
.method public final i(III)Lak/b;
    .locals 1
    .annotation build Lin/i;
    .end annotation
...
.method public isRenderEnvironmentPrepare()Z
    ...
    iget-object p0, p0, Lak/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public pauseRender()V
    ...
    invoke-direct {v3, p0, v0}, Lak/a;-><init>(Lak/b;Ljava/util/concurrent/CountDownLatch;)V
...
.method public release()V
    ...
    iput-object v0, p0, Lak/b;->h:Landroid/graphics/Bitmap;
...
.method public releaseGLResource()V
    ...
    iput v2, p0, Lak/b;->k:I

    :cond_0
    invoke-virtual {p0}, Lak/b;->deleteCacheBitmapTexId()V

    iget-object v0, p0, Lak/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
    ...
    iput-object v0, p0, Lak/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public surfaceCreated(Landroid/opengl/EGLConfig;)V
    ...
    iput-object p1, p0, Lak/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lak/b;->j:Z

    iput-boolean p1, p0, Lak/b;->f:Z
