...
.method public constructor <init>(II)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lii/c;-><init>(IILii/c$b;)V

    return-void
.end method

.method public constructor <init>(IILii/c$b;)V
    .locals 0
    ...
    .line 6
    iput-object p3, p0, Lii/c;->d:Lii/c$b;
...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
    ...
    iget v4, p0, Lii/c;->b:I

    add-int/2addr v1, v4

    int-to-float v1, v1

    iget v4, p0, Lii/c;->a:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lii/c;->d:Lii/c$b;

    iget-object p0, p0, Lii/c;->d:Lii/c$b;
...
.method public final l(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
    ...
    sget-object v0, Lii/c$a;->a:[I

    iget-object v1, p0, Lii/c;->d:Lii/c$b;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->e(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_3
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_4
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->j(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_5
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->i(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_6
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->k(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_7
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->f(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_8
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->c(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_9
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->o(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_a
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->b(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_b
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->a(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_c
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->n(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    goto :goto_0

    :pswitch_d
    invoke-virtual {p0, p1, p2, p3, p4}, Lii/c;->m(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
...
.method public transform(Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v1, v2, p2, p3}, Lii/c;->l(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
