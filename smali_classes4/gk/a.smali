...
# virtual methods
.method public final a(Lhk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    .locals 2

    iget-object p0, p1, Lhk/b$a;->a:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p1, Lhk/b$a;->b:Ljava/util/List;
...
.method public b(Lhk/b;Z)Lhk/b;
    ...
    invoke-virtual {p1}, Lhk/b;->b()Lhk/b$a;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhk/b;->g(Lhk/b$a;)V

    invoke-virtual {p1}, Lhk/b;->d()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhk/b;->i(Ljava/lang/String;)V

    invoke-virtual {p1}, Lhk/b;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhk/b;->h(Ljava/lang/String;)V

    invoke-virtual {p1}, Lhk/b;->e()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhk/b;->j(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lhk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-virtual {v0, v2}, Lhk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    invoke-virtual {v0}, Lhk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object p1

    check-cast p1, Lcom/faceunity/core/entity/FUGroupAnimationBundleData;

    invoke-virtual {p0, v1, p1}, Lgk/a;->a(Lhk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v0, p0}, Lhk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    :goto_0
    return-object v0
.end method

.method public c(Lhk/d;Z)Lhk/d;
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lhk/d;->g(Ljava/lang/String;)V

    invoke-virtual {p1}, Lhk/d;->a()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lhk/d;->e(Ljava/lang/String;)V

    invoke-virtual {p1}, Lhk/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lhk/d;->h(Ljava/lang/String;)V

    new-instance v0, Lcom/faceunity/core/entity/FUEmotionBundleData;

    invoke-virtual {p1}, Lhk/d;->b()Lcom/faceunity/core/entity/FUEmotionBundleData;
    ...
    invoke-virtual {p0, v0}, Lhk/d;->f(Lcom/faceunity/core/entity/FUEmotionBundleData;)V
...
.method public final d(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Lhk/b;->d()Ljava/lang/String;
...
.method public final e(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Lhk/d;->c()Ljava/lang/String;
...
.method public f(Ljava/lang/String;Lhk/a;)V
    .locals 10
    ...
    sget-object v6, Lgk/a;->a:Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Lwk/j;->k(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p2}, Lhk/a;->a()Ljava/util/Map;

    move-result-object v6

    invoke-virtual {p2}, Lhk/a;->b()Ljava/util/Map;

    move-result-object v7

    invoke-virtual {p2}, Lhk/a;->e()Ljava/util/Map;

    move-result-object v8

    :try_start_0
    invoke-static {p1}, Lxk/b;->e(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, v3, v9}, Lgk/a;->q(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    invoke-virtual {p0, v6, v3}, Lgk/a;->d(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2}, Lgk/a;->r(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p0, v7, v2}, Lgk/a;->e(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2, v3, v6}, Lgk/a;->t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p2, v2}, Lhk/a;->h(Ljava/util/List;)V
    ...
    invoke-virtual {p2, v2}, Lhk/a;->j(Ljava/util/List;)V
    ...
    invoke-virtual {p2, v2}, Lhk/a;->i(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1, v2, v6}, Lgk/a;->n(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lhk/b;

    move-result-object v1

    invoke-virtual {p2, v1}, Lhk/a;->k(Lhk/b;)V
    ...
    invoke-virtual {p0, p2, v0}, Lgk/a;->o(Lorg/json/JSONObject;Z)Lhk/f;
    ...
    invoke-virtual {p0, p1, v0}, Lgk/a;->o(Lorg/json/JSONObject;Z)Lhk/f;
...
.method public final g(Lorg/json/JSONObject;)Lhk/c;
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lhk/c;->f(I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v2}, Lhk/c;->f(I)V
    ...
    invoke-virtual {p0, v0}, Lhk/c;->j(Z)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v2}, Lhk/c;->j(Z)V
    ...
    invoke-virtual {p0, v0}, Lhk/c;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lhk/c;->g(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1}, Lhk/c;->i(Ljava/lang/Boolean;)V

    :cond_5
    return-object p0
.end method

.method public final h(Lorg/json/JSONObject;Z)Lhk/b$a;
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lgk/a;->p(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lhk/b$a;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lgk/a;->s(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lhk/b$a;->b:Ljava/util/List;
    ...
    invoke-virtual {p0, v1, p2}, Lgk/a;->l(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object v1

    iput-object v1, v0, Lhk/b$a;->c:Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    iput-object v1, v0, Lhk/b$a;->e:Lcom/faceunity/core/entity/FUBundleData;
    ...
    iput-object v1, v0, Lhk/b$a;->f:Lcom/faceunity/core/entity/FUBundleData;
    ...
    iput-object v1, v0, Lhk/b$a;->g:Lcom/faceunity/core/entity/FUBundleData;
    ...
    invoke-virtual {p0, p1, p2}, Lgk/a;->m(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUEmotionBundleData;

    move-result-object p0

    iput-object p0, v0, Lhk/b$a;->d:Lcom/faceunity/core/entity/FUEmotionBundleData;
...
.method public final i(Lorg/json/JSONObject;ZLjava/lang/String;)Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-static {v1}, Lkk/c;->i(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j(Lorg/json/JSONObject;ZLjava/lang/String;)Lhk/b;
    .locals 16
    ...
    invoke-virtual {v2, v3}, Lhk/b;->i(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lhk/b;->j(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lhk/b;->h(Ljava/lang/String;)V

    :cond_2
    invoke-virtual/range {p0 .. p1}, Lgk/a;->g(Lorg/json/JSONObject;)Lhk/c;
    ...
    invoke-static {v4}, Lkk/c;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lhk/b;->e()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v3}, Lhk/c;->e()Z

    move-result v9

    const/4 v10, 0x0

    invoke-virtual {v3}, Lhk/c;->a()I

    move-result v11

    invoke-virtual {v3}, Lhk/c;->c()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v3}, Lhk/c;->b()Ljava/lang/Integer;

    move-result-object v13

    invoke-virtual {v3}, Lhk/c;->d()Ljava/lang/Boolean;
    ...
    invoke-virtual {v2, v15}, Lhk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {v0, v1, v3}, Lgk/a;->h(Lorg/json/JSONObject;Z)Lhk/b$a;

    move-result-object v1

    invoke-virtual {v2, v1}, Lhk/b;->g(Lhk/b$a;)V

    invoke-virtual {v2}, Lhk/b;->b()Lhk/b$a;

    move-result-object v1

    invoke-virtual {v2}, Lhk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object v3

    check-cast v3, Lcom/faceunity/core/entity/FUGroupAnimationBundleData;

    invoke-virtual {v0, v1, v3}, Lgk/a;->a(Lhk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v2, v0}, Lhk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    :goto_1
    return-object v2
.end method

.method public final k(Lorg/json/JSONObject;Z)Lhk/d;
    .locals 2
    ...
    invoke-static {p1}, Lkk/c;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lhk/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p2, p1, v0}, Lcom/faceunity/core/entity/FUEmotionBundleData;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p2}, Lhk/d;->f(Lcom/faceunity/core/entity/FUEmotionBundleData;)V
...
.method public final n(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lhk/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, p3}, Lgk/a;->t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lwk/e;->e(Ljava/util/List;)Z
...
.method public final o(Lorg/json/JSONObject;Z)Lhk/f;
    .locals 3
    ...
    invoke-virtual {p0, v2}, Lhk/f;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {p0, p2}, Lhk/f;->h(Lcom/faceunity/core/entity/FUBundleData;)V
...
.method public final p(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3, p2}, Lgk/a;->i(Lorg/json/JSONObject;ZLjava/lang/String;)Lcom/faceunity/core/entity/FUAnimationBundleData;
...
.method public final q(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3, p2}, Lgk/a;->j(Lorg/json/JSONObject;ZLjava/lang/String;)Lhk/b;
...
.method public final r(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3}, Lgk/a;->k(Lorg/json/JSONObject;Z)Lhk/d;
...
.method public final s(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3}, Lgk/a;->l(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUAnimationBundleData;
...
.method public final t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {v0, v4}, Lgk/a;->g(Lorg/json/JSONObject;)Lhk/c;

    move-result-object v4

    invoke-virtual {v5}, Lhk/b;->b()Lhk/b$a;
    ...
    invoke-virtual {v5}, Lhk/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-virtual {v5}, Lhk/b;->e()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v4}, Lhk/c;->e()Z

    move-result v12

    const/4 v13, 0x0

    invoke-virtual {v4}, Lhk/c;->a()I

    move-result v14

    invoke-virtual {v4}, Lhk/c;->c()Ljava/lang/String;

    move-result-object v16

    invoke-virtual {v4}, Lhk/c;->b()Ljava/lang/Integer;

    move-result-object v17

    invoke-virtual {v4}, Lhk/c;->d()Ljava/lang/Boolean;
    ...
    invoke-virtual {v5, v4}, Lhk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {v0, v7, v4}, Lgk/a;->a(Lhk/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v5, v7}, Lhk/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
