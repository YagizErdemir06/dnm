...
.method public constructor <init>(Lyk/d;)V
    ...
    iput-object p1, p0, Lyk/d$a0;->a:Lyk/d;
...
.method public onCompleted()V
    ...
    iget-object v0, p0, Lyk/d$a0;->a:Lyk/d;
    ...
    invoke-static {v0}, Lyk/d;->q(Lyk/d;)Lvj/a;
    ...
    :cond_1
    sget-object v0, Lyk/d;->F:Lcom/faceunity/core/avatar/model/Avatar;

    if-eqz v0, :cond_5

    iget-object v4, p0, Lyk/d$a0;->a:Lyk/d;

    invoke-static {v4}, Lyk/d;->x(Lyk/d;)Lbk/b;
    ...
    :cond_2
    invoke-virtual {v5}, Lbk/b;->k()Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v6}, Lbk/b;->l()Ljava/util/HashMap;
    ...
    :cond_4
    invoke-virtual {v7}, Lbk/b;->m()Ljava/util/ArrayList;

    move-result-object v1

    new-instance v7, Lvj/a;

    invoke-direct {v7, v0}, Lvj/a;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    invoke-virtual {v7, v5, v6, v1}, Lvj/a;->b(Ljava/util/List;Ljava/util/HashMap;Ljava/util/ArrayList;)V

    invoke-static {v4, v7}, Lyk/d;->K(Lyk/d;Lvj/a;)V
    ...
    :cond_7
    iget-object p0, p0, Lyk/d$a0;->a:Lyk/d;
    ...
    invoke-virtual {p0, v12}, Lvj/a;->g(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
