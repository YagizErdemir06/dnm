...
.method public a(Lye/e;Lsf/d;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct/range {v4 .. v9}, Lye/e$a;-><init>(IZLjm/c;ZZ)V
    ...
    invoke-static {v4, v0}, Lte/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7}, Lye/e$a;->e()Landroid/media/Image;
    ...
    :cond_3
    invoke-static {v4, v10}, Lte/e;->b(Ljava/lang/String;I)V
    ...
    :goto_2
    invoke-virtual {v3, v6, v0, v0}, Lye/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-interface {v6, v11}, Lye/f;->b(Landroid/media/Image;)V

    invoke-virtual {v8}, Lye/e$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v6, v8}, Lye/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v6, v1}, Lye/f;->b(Landroid/media/Image;)V

    invoke-virtual {v3, v5, v10}, Lye/e$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v4}, Lye/e$a;->m()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v4}, Lye/e$a;->v()Z

    move-result v5

    invoke-virtual {v3, v1, v9, v5}, Lye/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v3, v1, v10, v0}, Lye/e$a;->B(Landroid/media/Image;IZ)V

    :cond_9
    invoke-virtual {v3}, Lye/e$a;->o()Z
    ...
    invoke-virtual {v1, v4, v3, v5}, Lsf/b;->b(Lye/e;Lye/e$a;Lsf/d;)V
...
.method public final b(Lye/e;Lye/e$a;Lsf/d;)V
    .locals 0
