...
# virtual methods
.method public a(Lye/e;Lsf/d;Lcom/xiaomi/engine/TaskSession;)V
    .locals 30
    .param p1    # Lye/e;
    ...
    new-instance v14, Lye/e$a;

    invoke-virtual/range {p1 .. p1}, Lye/e;->q()I

    move-result v9

    invoke-virtual/range {p1 .. p1}, Lye/e;->z()Z

    move-result v10

    invoke-virtual/range {p1 .. p1}, Lye/e;->p()Ljm/c;

    move-result-object v11

    const/4 v12, 0x1

    invoke-virtual/range {p1 .. p1}, Lye/e;->v()Z

    move-result v13

    move-object v8, v14

    invoke-direct/range {v8 .. v13}, Lye/e$a;-><init>(IZLjm/c;ZZ)V
    ...
    invoke-static {v9, v5}, Lte/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v15, Lye/e$a;

    invoke-virtual {v15}, Lye/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Lye/e$a;->e()Landroid/media/Image;
    ...
    invoke-static {v9, v10}, Lte/e;->b(Ljava/lang/String;I)V
    ...
    invoke-static {v9, v8}, Lte/e;->b(Ljava/lang/String;I)V
    ...
    check-cast v20, Lye/e$a;

    invoke-virtual/range {v20 .. v20}, Lye/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual/range {v20 .. v20}, Lye/e$a;->k()Landroid/media/Image;
    ...
    invoke-virtual {v0}, Lye/e$a;->k()Landroid/media/Image;
    ...
    invoke-virtual {v14, v0, v2, v4}, Lye/e$a;->B(Landroid/media/Image;IZ)V
    ...
    :goto_e
    invoke-virtual {v14, v3, v2}, Lye/e$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v1}, Lye/e$a;->m()Landroid/media/Image;

    move-result-object v0

    const/4 v2, 0x2

    invoke-virtual {v1}, Lye/e$a;->v()Z

    move-result v3

    invoke-virtual {v14, v0, v2, v3}, Lye/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v14, v0, v2, v2}, Lye/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual/range {p1 .. p1}, Lye/e;->g()Lye/f;
    ...
    :cond_10
    invoke-virtual {v3}, Lye/e$a;->e()Landroid/media/Image;

    move-result-object v5

    invoke-virtual {v5}, Landroid/media/Image;->close()V

    invoke-interface {v0, v5}, Lye/f;->b(Landroid/media/Image;)V

    invoke-virtual {v3}, Lye/e$a;->k()Landroid/media/Image;
    ...
    :cond_11
    invoke-virtual {v3}, Lye/e$a;->m()Landroid/media/Image;
    ...
    invoke-interface {v0, v3}, Lye/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v0, v2}, Lye/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v0, v1}, Lye/f;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v14, v1, v2, v3}, Lye/e$a;->B(Landroid/media/Image;IZ)V
    ...
    :goto_13
    invoke-virtual {v14}, Lye/e$a;->o()Z
    ...
    invoke-virtual {v1, v3}, Lye/e$a;->D(Z)V
    ...
    invoke-virtual {v1, v2, v4, v5}, Lsf/e;->b(Lye/e;Ljava/util/List;Lsf/d;)V
    ...
    invoke-virtual {v1, v2, v14, v5}, Lsf/e;->c(Lye/e;Lye/e$a;Lsf/d;)V
...
.method public final b(Lye/e;Ljava/util/List;Lsf/d;)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Lye/e;->O(Lye/e$a;)V

    invoke-virtual {p1, p2}, Lye/e;->I(Ljava/util/List;)V

    invoke-virtual {p1}, Lye/e;->w()Z

    move-result p0

    xor-int/lit8 p0, p0, 0x1

    invoke-interface {p3, p1, p0}, Lsf/d;->a(Lye/e;Z)V

    return-void
.end method

.method public final c(Lye/e;Lye/e$a;Lsf/d;)V
    .locals 0

    invoke-virtual {p1, p2}, Lye/e;->O(Lye/e$a;)V
