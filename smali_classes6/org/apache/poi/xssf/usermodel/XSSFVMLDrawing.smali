...
.method private newDrawing()V
    ...
    invoke-static {}, Lov/c$a;->a()Lov/c;

    move-result-object v0

    sget-object v1, Lqv/o;->N7:Lqv/o$a;

    invoke-interface {v0, v1}, Lov/c;->R0(Lqv/o$a;)V

    invoke-interface {v0}, Lov/c;->vp()Lov/a;

    move-result-object v2

    invoke-interface {v2, v1}, Lov/a;->R0(Lqv/o$a;)V

    const-string v1, "1"

    invoke-interface {v2, v1}, Lov/a;->setData(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lqv/j;->setId(Ljava/lang/String;)V

    const-string v1, "21600,21600"

    invoke-interface {v0, v1}, Lqv/j;->i6(Ljava/lang/String;)V

    const/high16 v1, 0x434a0000    # 202.0f

    invoke-interface {v0, v1}, Lqv/j;->f8(F)V

    const-string v1, "m,l,21600r21600,l21600,xe"

    invoke-interface {v0, v1}, Lqv/j;->E8(Ljava/lang/String;)V

    invoke-interface {v0}, Lqv/j;->p6()Lqv/k;

    move-result-object v1

    sget-object v2, Lqv/p;->V7:Lqv/p$a;

    invoke-interface {v1, v2}, Lqv/k;->jF(Lqv/p$a;)V

    invoke-interface {v0}, Lqv/j;->addNewPath()Lqv/g;

    move-result-object v1

    sget-object v2, Lqv/q;->a8:Lqv/q$a;

    invoke-interface {v1, v2}, Lqv/g;->wA(Lqv/q$a;)V

    sget-object v2, Lov/d;->W6:Lov/d$a;

    invoke-interface {v1, v2}, Lqv/g;->Zg(Lov/d$a;)V
...
.method public findCommentShape(II)Lqv/i;
    .locals 5
    ...
    instance-of v1, v0, Lqv/i;

    if-eqz v1, :cond_0

    check-cast v0, Lqv/i;

    invoke-interface {v0}, Lqv/i;->G0()I
    ...
    invoke-interface {v0, v1}, Lqv/i;->u6(I)Lmv/a;

    move-result-object v2

    invoke-interface {v2}, Lmv/a;->TD()Lmv/b$a;

    move-result-object v3

    sget-object v4, Lmv/b;->c6:Lmv/b$a;

    if-ne v3, v4, :cond_0

    invoke-interface {v2, v1}, Lmv/a;->getRowArray(I)Ljava/math/BigInteger;
    ...
    invoke-interface {v2, v1}, Lmv/a;->Io(I)Ljava/math/BigInteger;
...
.method public newCommentShape()Lqv/i;
    .locals 5

    invoke-static {}, Lqv/i$a;->a()Lqv/i;
    ...
    invoke-interface {v0, v1}, Lqv/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lqv/i;->setType(Ljava/lang/String;)V

    const-string v1, "position:absolute; visibility:hidden"

    invoke-interface {v0, v1}, Lqv/i;->l(Ljava/lang/String;)V

    const-string v1, "#ffffe1"

    invoke-interface {v0, v1}, Lqv/i;->V2(Ljava/lang/String;)V

    sget-object v2, Lov/e;->e7:Lov/e$a;

    invoke-interface {v0, v2}, Lqv/i;->z(Lov/e$a;)V

    invoke-interface {v0}, Lqv/i;->addNewFill()Lqv/b;

    move-result-object v2

    invoke-interface {v2, v1}, Lqv/b;->setColor(Ljava/lang/String;)V

    invoke-interface {v0}, Lqv/i;->addNewShadow()Lqv/h;

    move-result-object v1

    sget-object v2, Lqv/q;->a8:Lqv/q$a;

    invoke-interface {v1, v2}, Lqv/h;->x(Lqv/q$a;)V

    const-string v3, "black"

    invoke-interface {v1, v3}, Lqv/h;->setColor(Ljava/lang/String;)V

    invoke-interface {v1, v2}, Lqv/h;->my(Lqv/q$a;)V

    invoke-interface {v0}, Lqv/i;->addNewPath()Lqv/g;

    move-result-object v1

    sget-object v2, Lov/d;->V6:Lov/d$a;

    invoke-interface {v1, v2}, Lqv/g;->Zg(Lov/d$a;)V

    invoke-interface {v0}, Lqv/i;->V()Lqv/m;

    move-result-object v1

    const-string v2, "mso-direction-alt:auto"

    invoke-interface {v1, v2}, Lqv/m;->l(Ljava/lang/String;)V

    invoke-interface {v0}, Lqv/i;->addNewClientData()Lmv/a;

    move-result-object v1

    sget-object v2, Lmv/b;->c6:Lmv/b$a;

    invoke-interface {v1, v2}, Lmv/a;->hg(Lmv/b$a;)V

    invoke-interface {v1}, Lmv/a;->Ra()Lmv/c;

    invoke-interface {v1}, Lmv/a;->sA()Lmv/c;

    invoke-interface {v1}, Lmv/a;->addNewAnchor()Lorg/apache/xmlbeans/XmlString;
    ...
    invoke-interface {v1}, Lmv/a;->Ly()Lmv/c;
    ...
    invoke-interface {v1}, Lmv/a;->addNewRow()Lorg/apache/xmlbeans/XmlInteger;
    ...
    invoke-interface {v1}, Lmv/a;->H8()Lorg/apache/xmlbeans/XmlInteger;
...
.method public read(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Lov/c$a;->k(Ljava/lang/String;)Lov/c;
    ...
    invoke-static {v2}, Lqv/j$a;->k(Ljava/lang/String;)Lqv/j;
    ...
    invoke-interface {v2}, Lqv/j;->getId()Ljava/lang/String;
    ...
    invoke-static {v2}, Lqv/i$a;->k(Ljava/lang/String;)Lqv/i;

    move-result-object v2

    invoke-interface {v2}, Lqv/i;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)Lqv/i;
