...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Lqv/d$a;->a()Lqv/d;

    move-result-object v2

    invoke-interface {v2}, Lqv/d;->zl()Lqv/j;

    move-result-object v3

    const-string v4, "_x0000_t136"

    invoke-interface {v3, v4}, Lqv/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    invoke-interface {v3, v4}, Lqv/j;->i6(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    invoke-interface {v3, v4}, Lqv/j;->f8(F)V

    const-string v4, "10800"

    invoke-interface {v3, v4}, Lqv/j;->t8(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {v3, v4}, Lqv/j;->E8(Ljava/lang/String;)V

    invoke-interface {v3}, Lqv/j;->n1()Lqv/c;

    move-result-object v4

    invoke-interface {v4}, Lqv/c;->addNewF()Lqv/a;

    move-result-object v5

    const-string v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Lqv/a;->ha(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Lqv/a;->ha(Ljava/lang/String;)V

    invoke-interface {v3}, Lqv/j;->addNewPath()Lqv/g;

    move-result-object v4

    sget-object v5, Lqv/q;->a8:Lqv/q$a;

    invoke-interface {v4, v5}, Lqv/g;->Pu(Lqv/q$a;)V

    sget-object v6, Lov/d;->Y6:Lov/d$a;

    invoke-interface {v4, v6}, Lqv/g;->Zg(Lov/d$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    invoke-interface {v4, v6}, Lqv/g;->Vk(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    invoke-interface {v4, v6}, Lqv/g;->ti(Ljava/lang/String;)V

    invoke-interface {v3}, Lqv/j;->e2()Lqv/l;

    move-result-object v4

    invoke-interface {v4, v5}, Lqv/l;->x(Lqv/q$a;)V

    invoke-interface {v4, v5}, Lqv/l;->hc(Lqv/q$a;)V

    invoke-interface {v3}, Lqv/j;->A4()Lqv/f;

    move-result-object v4

    invoke-interface {v4}, Lqv/f;->addNewH()Lqv/e;

    move-result-object v4

    const-string v5, "#0,bottomRight"

    invoke-interface {v4, v5}, Lqv/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    invoke-interface {v4, v5}, Lqv/e;->pg(Ljava/lang/String;)V

    invoke-interface {v3}, Lqv/j;->addNewLock()Lov/b;

    move-result-object v3

    sget-object v4, Lqv/o;->N7:Lqv/o$a;

    invoke-interface {v3, v4}, Lov/b;->R0(Lqv/o$a;)V

    invoke-interface {v2}, Lqv/d;->YA()Lqv/i;
    ...
    invoke-interface {v3, v4}, Lqv/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lqv/i;->d0(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    invoke-interface {v3, p2}, Lqv/i;->setType(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lqv/i;->l(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lqv/i;->I4(Ljava/lang/String;)V

    const-string p2, "black"

    invoke-interface {v3, p2}, Lqv/i;->V2(Ljava/lang/String;)V

    sget-object p2, Lqv/q;->d8:Lqv/q$a;

    invoke-interface {v3, p2}, Lqv/i;->F8(Lqv/q$a;)V

    invoke-interface {v3}, Lqv/i;->e2()Lqv/l;

    move-result-object p2

    const-string v3, "font-family:&quot;Cambria&quot;;font-size:1pt"

    invoke-interface {p2, v3}, Lqv/l;->l(Ljava/lang/String;)V

    invoke-interface {p2, p1}, Lqv/l;->oF(Ljava/lang/String;)V
