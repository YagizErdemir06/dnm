...
.method public constructor <init>(Lkv/b;Lkv/b;Lio/reactivex/functions/BiPredicate;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Lkv/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Lkv/b;
...
.method public subscribeActual(Lkv/c;)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;-><init>(Lkv/c;ILio/reactivex/functions/BiPredicate;)V

    invoke-interface {p1, v0}, Lkv/c;->onSubscribe(Lkv/d;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Lkv/b;

    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Lkv/b;

    invoke-virtual {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;->subscribe(Lkv/b;Lkv/b;)V
