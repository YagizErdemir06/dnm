...
# direct methods
.method public constructor <init>(Lkv/c;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lkv/c;
...
.method public onSubscribe(Lkv/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lkv/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lkv/d;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lkv/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lkv/c;
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lkv/d;

    invoke-interface {p0, v1, v2}, Lkv/d;->request(J)V
...
.method public runAsync()V
    ...
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLkv/c;)Z
    ...
    :cond_4
    invoke-interface {v0, v10}, Lkv/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lkv/d;

    invoke-interface {v8, v2, v3}, Lkv/d;->request(J)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lkv/d;

    invoke-interface {v3}, Lkv/d;->cancel()V

    invoke-interface {v1}, Lio/reactivex/internal/fuseable/SimpleQueue;->clear()V

    invoke-interface {v0, v2}, Lkv/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLkv/c;)Z
...
.method public runBackfused()V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lkv/c;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->actual:Lkv/c;

    invoke-interface {v1, v0}, Lkv/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0}, Lkv/c;->onComplete()V
...
.method public runSync()V
    ...
    :cond_2
    invoke-interface {v0, v7}, Lkv/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Lkv/d;

    invoke-interface {v2}, Lkv/d;->cancel()V

    invoke-interface {v0, v1}, Lkv/c;->onError(Ljava/lang/Throwable;)V
