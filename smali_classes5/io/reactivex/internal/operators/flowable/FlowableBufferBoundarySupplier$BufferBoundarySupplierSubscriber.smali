...
# direct methods
.method public constructor <init>(Lkv/c;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public bridge synthetic accept(Lkv/c;Ljava/lang/Object;)Z
    .locals 0

    .line 1
    check-cast p2, Ljava/util/Collection;

    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->accept(Lkv/c;Ljava/util/Collection;)Z
...
.method public accept(Lkv/c;Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lkv/c;

    invoke-interface {p0, p2}, Lkv/c;->onNext(Ljava/lang/Object;)V
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lkv/d;
...
.method public next()V
    ...
    invoke-interface {v1, v2}, Lkv/b;->subscribe(Lkv/c;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lkv/d;

    invoke-interface {v1}, Lkv/d;->cancel()V

    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lkv/c;

    invoke-interface {p0, v0}, Lkv/c;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->actual:Lkv/c;

    const/4 v2, 0x0

    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lkv/c;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onSubscribe(Lkv/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Lkv/d;
    ...
    invoke-interface {p1, v3, v4}, Lkv/d;->request(J)V

    invoke-interface {v2, v1}, Lkv/b;->subscribe(Lkv/c;)V
    ...
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lkv/c;)V
