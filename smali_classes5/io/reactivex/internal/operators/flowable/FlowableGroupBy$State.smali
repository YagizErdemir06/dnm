...
.method public drainNormal()V
    ...
    :goto_2
    invoke-virtual {p0, v12, v14, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLkv/c;Z)Z
    ...
    :cond_3
    invoke-interface {v2, v13}, Lkv/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v11, v12, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLkv/c;Z)Z
    ...
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lkv/d;

    invoke-interface {v5, v9, v10}, Lkv/d;->request(J)V
...
.method public subscribe(Lkv/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lkv/c;)V
