...
.method public static a([BII)Lmp/r$a;
    .locals 1
    ...
    invoke-static {p0, p1, p2}, Lmp/r;->e([BII)Z

    move-result p0

    if-eqz p0, :cond_0

    iput p1, v0, Lmp/r$a;->a:I

    iput p2, v0, Lmp/r$a;->b:I
...
.method public static c([BI)Lmp/r$a;
    .locals 1

    aget-byte v0, p0, p1

    invoke-static {v0}, Lmp/r;->b(B)I

    move-result v0

    if-nez v0, :cond_0

    new-instance p0, Lmp/r$a;

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0}, Lmp/r$a;-><init>(II)V

    return-object p0

    :cond_0
    invoke-static {p0, p1, v0}, Lmp/r;->a([BII)Lmp/r$a;
...
.method public static d([B)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lmp/r;->c([BI)Lmp/r$a;

    move-result-object v2

    invoke-virtual {v2}, Lmp/r$a;->b()Z
...
.method public static f(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {v0}, Lmp/r;->d([B)Ljava/util/List;
    ...
    check-cast p1, Lmp/r$a;

    iget p1, p1, Lmp/r$a;->a:I
    ...
    check-cast p0, Lmp/r$a;

    iget p0, p0, Lmp/r$a;->a:I
...
.method public static g(Ljava/lang/String;I)Ljava/lang/String;
    ...
    check-cast v4, Lmp/r$a;

    iget v5, v4, Lmp/r$a;->a:I
