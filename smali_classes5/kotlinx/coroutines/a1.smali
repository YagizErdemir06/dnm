...
.method public final declared-synchronized B0(J)V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/a1;->x0()Z
...
.method public X()Ljava/lang/Thread;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/a1;->t0()Ljava/lang/Thread;
...
.method public g0(Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lkotlinx/coroutines/u1;->g0(Ljava/lang/Runnable;)V
...
.method public run()V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/a1;->s0()V
    ...
    :goto_1
    invoke-virtual {p0}, Lkotlinx/coroutines/u1;->I()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p0}, Lkotlinx/coroutines/a1;->X()Ljava/lang/Thread;
    ...
    :cond_a
    :try_start_2
    invoke-static {v5, v6, v10, v11}, Lsn/q;->v(JJ)J
    ...
    sget-object v7, Lnm/l2;->a:Lnm/l2;
...
.method public final declared-synchronized s0()V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/u1;->j0()V
...
.method public t(JLjava/lang/Runnable;Lwm/g;)Lkotlinx/coroutines/p1;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/u1;->o0(JLjava/lang/Runnable;)Lkotlinx/coroutines/p1;
...
.method public final declared-synchronized t0()Ljava/lang/Thread;
    .locals 2
