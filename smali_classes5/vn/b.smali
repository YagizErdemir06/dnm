...
# direct methods
.method public static synthetic a(Lun/m;)Ljava/util/Spliterator;
    .locals 0

    invoke-static {p0}, Lvn/b;->g(Lun/m;)Ljava/util/Spliterator;
...
.method public static final b(Ljava/util/stream/DoubleStream;)Lun/m;
    .locals 1
    ...
    new-instance v0, Lvn/b$d;

    invoke-direct {v0, p0}, Lvn/b$d;-><init>(Ljava/util/stream/DoubleStream;)V

    return-object v0
.end method

.method public static final c(Ljava/util/stream/IntStream;)Lun/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lvn/b$b;-><init>(Ljava/util/stream/IntStream;)V

    return-object v0
.end method

.method public static final d(Ljava/util/stream/LongStream;)Lun/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lvn/b$c;-><init>(Ljava/util/stream/LongStream;)V

    return-object v0
.end method

.method public static final e(Ljava/util/stream/Stream;)Lun/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lvn/b$a;-><init>(Ljava/util/stream/Stream;)V

    return-object v0
.end method

.method public static final f(Lun/m;)Ljava/util/stream/Stream;
    .locals 2
    .param p0    # Lun/m;
        .annotation build Ljv/d;
        .end annotation
    ...
    invoke-direct {v0, p0}, Lvn/a;-><init>(Lun/m;)V
...
.method public static final g(Lun/m;)Ljava/util/Spliterator;
    .locals 1
...
.method public static final h(Ljava/util/stream/DoubleStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Lpm/o;->p([D)Ljava/util/List;
...
.method public static final i(Ljava/util/stream/IntStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Lpm/o;->r([I)Ljava/util/List;
...
.method public static final j(Ljava/util/stream/LongStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Lpm/o;->s([J)Ljava/util/List;
