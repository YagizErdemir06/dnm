...
.method public b(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;
    ...
    invoke-virtual {p1, v0}, Llr/m;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;
...
.method public c()Z
    ...
    invoke-direct {v0, v1, v2}, Lgp/g;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;

    const v1, 0x800055

    invoke-virtual {v0, v1}, Llr/m;->f(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;

    invoke-virtual {v0, p0}, Llr/m;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;

    invoke-virtual {v0, p0}, Lgp/g;->H0(Lgp/g$d;)V
    ...
    invoke-virtual {v0, v1}, Llr/m;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;

    iget v1, p0, Lmiuix/appcompat/internal/view/menu/e;->j:I

    invoke-virtual {v0, v1}, Llr/m;->setVerticalOffset(I)V

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/e;->m:I

    if-lez v0, :cond_2

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/e;->c:Lgp/g;

    invoke-virtual {v1, v0}, Llr/m;->V(I)V
    ...
    invoke-virtual {v0, v1}, Llr/m;->K(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v1, v3}, Llr/m;->e(Landroid/view/View;Landroid/view/ViewGroup;)V
