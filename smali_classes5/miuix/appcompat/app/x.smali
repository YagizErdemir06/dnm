...
.method public static synthetic T(Lmiuix/appcompat/app/x;Landroid/content/Context;Ljp/b;II)Z
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lmiuix/appcompat/app/x;->r0(Landroid/content/Context;Ljp/b;II)Z
...
.method public L5(Landroid/content/res/Configuration;Lzr/e;Z)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lmiuix/appcompat/app/x;->X(Landroid/content/res/Configuration;Lzr/e;Z)V
...
.method public final c0(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;)V
    ...
    invoke-virtual {v3, v2}, Lmiuix/appcompat/app/AppCompatActivity;->sd(Z)V
    ...
    sget v4, Lso/b$m;->miuix_appcompat_screen_action_bar:I
    ...
    invoke-virtual {p2, p3}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->G0(Ljp/a;)V
    ...
    invoke-static {p1, p3}, Lnq/e;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lmiuix/appcompat/app/AppCompatActivity;->c1()Z
...
.method public e0(IZI)Landroid/animation/Animator;
    ...
    invoke-static {p0, p3}, Lcp/d;->a(Landroidx/fragment/app/Fragment;I)Landroid/animation/Animator;
...
.method public f0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget-object v1, Lso/b$r;->Window:[I

    invoke-virtual {v0, v1}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Lso/b$r;->Window_responsiveEnabled:I
    ...
    invoke-direct {v1, p0, p0}, Lmiuix/appcompat/app/x$b;-><init>(Lmiuix/appcompat/app/x;Lyr/a;)V

    iput-object v1, p0, Lmiuix/appcompat/app/x;->K1:Lmiuix/responsive/page/manager/BaseResponseStateManager;

    :cond_0
    sget v1, Lso/b$r;->Window_windowActionBar:I
    ...
    :cond_1
    sget v1, Lso/b$r;->Window_windowActionBarOverlay:I
    ...
    sget v1, Lso/b$r;->Window_windowExtraPaddingApplyToContentEnable:I
    ...
    sget v1, Lso/b$r;->Window_windowTranslucentStatus:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    invoke-virtual {p0, v1}, Lmiuix/appcompat/app/c;->Zf(I)V
    ...
    invoke-virtual {p2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Ljp/b;)V
    ...
    invoke-interface {v1, p1, p2, p3}, Lmiuix/appcompat/app/a0;->o6(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    :cond_9
    sget p1, Lso/b$r;->Window_endActionMenuEnabled:I
    ...
    sget p1, Lso/b$r;->Window_hyperActionMenuEnabled:I
    ...
    invoke-interface {p1}, Lmiuix/appcompat/app/a0;->A3()Z
    ...
    iget-object p2, p0, Lmiuix/appcompat/app/c;->z:Ljp/b;
    ...
    invoke-virtual {p0, p1, p2, p3, p3}, Lmiuix/appcompat/app/x;->r0(Landroid/content/Context;Ljp/b;II)Z
...
.method public h0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-interface {p1, p0, p2}, Lmiuix/appcompat/app/a0;->C3(Landroid/view/View;Landroid/os/Bundle;)V
...
.method public j3()Z
    ...
    invoke-interface {v0}, Lmiuix/appcompat/app/a0;->j3()Z
...
.method public je()Z
    ...
    invoke-interface {v0}, Lmiuix/appcompat/app/a0;->je()Z
...
.method public final r0(Landroid/content/Context;Ljp/b;II)Z
    .locals 9
...
.method public tb(I)V
    ...
    invoke-interface {v2}, Lmiuix/appcompat/app/a0;->A3()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2}, Ljp/c;->d7()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2, p1}, Ljp/a;->tb(I)V
