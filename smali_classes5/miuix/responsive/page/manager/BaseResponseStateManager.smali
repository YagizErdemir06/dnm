...
.method public constructor <init>(Lyr/a;)V
    ...
    iput-object p1, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lyr/a;

    invoke-interface {p1}, Lyr/a;->hg()Ljava/lang/Object;
    ...
    iget-object p1, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lyr/a;
    ...
    invoke-static {p1, v0}, Las/c;->a(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V

    invoke-virtual {p0}, Lmiuix/responsive/page/manager/a;->c()Lzr/b;

    move-result-object p1

    iput-object p1, p0, Lmiuix/responsive/page/manager/a;->b:Lzr/b;
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/responsive/page/manager/a;->d(Landroid/content/res/Configuration;)Lzr/b;

    move-result-object v0

    iput-object v0, p0, Lmiuix/responsive/page/manager/a;->b:Lzr/b;

    invoke-virtual {p0, p1}, Lmiuix/responsive/page/manager/a;->j(Landroid/content/res/Configuration;)V

    iget-object v0, p0, Lmiuix/responsive/page/manager/a;->b:Lzr/b;

    iget-object v1, p0, Lmiuix/responsive/page/manager/a;->a:Lzr/b;

    invoke-virtual {p0, v0, v1}, Lmiuix/responsive/page/manager/a;->h(Lzr/b;Lzr/b;)Z

    move-result v0

    iget-object v1, p0, Lmiuix/responsive/page/manager/a;->b:Lzr/b;

    xor-int/lit8 v0, v0, 0x1

    invoke-virtual {p0, p1, v1, v0}, Lmiuix/responsive/page/manager/BaseResponseStateManager;->r(Landroid/content/res/Configuration;Lzr/b;Z)V
...
.method public b(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Lmiuix/responsive/page/manager/a;->a:Lzr/b;

    iget-object v1, p0, Lmiuix/responsive/page/manager/a;->b:Lzr/b;

    invoke-virtual {v0, v1}, Lzr/b;->m(Lzr/b;)V
...
.method public final m(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lzr/d;->f(I)V
...
.method public n(Landroid/view/ViewGroup;Lyr/b;)V
    .locals 1
    ...
    invoke-virtual {p0, p2}, Lmiuix/responsive/page/manager/BaseResponseStateManager$c;->c(Lyr/b;)V
...
.method public o()V
    ...
    iput-object v0, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lyr/a;
...
.method public p()Lzr/b;
    .locals 0

    iget-object p0, p0, Lmiuix/responsive/page/manager/a;->b:Lzr/b;
...
.method public r(Landroid/content/res/Configuration;Lzr/b;Z)V
    .locals 4
    .param p2    # Lzr/b;
    ...
    invoke-virtual {p2, v0}, Lzr/b;->r(Lzr/e;)V

    :cond_0
    iget-object p2, p0, Lmiuix/responsive/page/manager/BaseResponseStateManager;->d:Lyr/a;

    invoke-interface {p2, p1, v0, p3}, Lyr/a;->L5(Landroid/content/res/Configuration;Lzr/e;Z)V
    ...
    invoke-interface {v1, p1, v0, p3}, Lyr/a;->L5(Landroid/content/res/Configuration;Lzr/e;Z)V
    ...
    :cond_3
    invoke-interface {v2, p1, v0, p3}, Lyr/b;->X(Landroid/content/res/Configuration;Lzr/e;Z)Z
...
.method public s()V
    ...
    invoke-virtual {p0, v2, v0, v1}, Lmiuix/responsive/page/manager/BaseResponseStateManager;->r(Landroid/content/res/Configuration;Lzr/b;Z)V
...
.method public t()V
    ...
    invoke-virtual {v0, p0}, Lzr/c;->e(Landroid/content/Context;)V
...
.method public final u(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Lkp/b$k;->ResponsiveSpec:[I
    ...
    invoke-static {p4}, Lwr/b;->a(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object p3

    const-class p4, Lyr/b;
    ...
    sget p3, Lkp/b$k;->ResponsiveSpec_android_id:I
    ...
    :cond_1
    sget p3, Lkp/b$k;->ResponsiveSpec_effectiveScreenOrientation:I
    ...
    sget p2, Lkp/b$k;->ResponsiveSpec_android_id:I
    ...
    new-instance p4, Lzr/d;

    invoke-direct {p4, p2}, Lzr/d;-><init>(I)V

    invoke-virtual {p4, p3}, Lzr/d;->f(I)V
    ...
    :cond_2
    sget p3, Lkp/b$k;->ResponsiveSpec_hideInScreenMode:I
    ...
    :cond_3
    sget p0, Lkp/b$k;->ResponsiveSpec_android_id:I
    ...
    invoke-direct {p2, p0, p3}, Lzr/d;-><init>(II)V
...
.method public w(I)V
    ...
    invoke-virtual {v1, v0}, Lzr/b;->r(Lzr/e;)V

    iput p1, v0, Lzr/e;->c:I
    ...
    invoke-interface {p1, v1, v0, v2}, Lyr/a;->L5(Landroid/content/res/Configuration;Lzr/e;Z)V
    ...
    invoke-interface {v3, v1, v0, v2}, Lyr/a;->L5(Landroid/content/res/Configuration;Lzr/e;Z)V
