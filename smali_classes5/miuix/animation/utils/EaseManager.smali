...
.method public static varargs createTimeInterpolator(I[D)Landroid/animation/TimeInterpolator;
    ...
    :pswitch_1
    new-instance p0, Lps/g;

    invoke-direct {p0}, Lps/g;-><init>()V
    ...
    :pswitch_7
    new-instance p0, Lps/r;

    invoke-direct {p0}, Lps/r;-><init>()V
    ...
    :pswitch_a
    new-instance p0, Lps/h0;

    invoke-direct {p0}, Lps/h0;-><init>()V

    return-object p0

    :pswitch_b
    new-instance p0, Lps/i0;

    invoke-direct {p0}, Lps/i0;-><init>()V

    return-object p0

    :pswitch_c
    new-instance p0, Lps/g0;

    invoke-direct {p0}, Lps/g0;-><init>()V

    return-object p0

    :pswitch_d
    new-instance p0, Lps/e0;

    invoke-direct {p0}, Lps/e0;-><init>()V

    return-object p0

    :pswitch_e
    new-instance p0, Lps/f0;

    invoke-direct {p0}, Lps/f0;-><init>()V

    return-object p0

    :pswitch_f
    new-instance p0, Lps/d0;

    invoke-direct {p0}, Lps/d0;-><init>()V

    return-object p0

    :pswitch_10
    new-instance p0, Lps/b0;

    invoke-direct {p0}, Lps/b0;-><init>()V

    return-object p0

    :pswitch_11
    new-instance p0, Lps/c0;

    invoke-direct {p0}, Lps/c0;-><init>()V
    ...
    :pswitch_13
    new-instance p0, Lps/l;

    invoke-direct {p0}, Lps/l;-><init>()V
    ...
    :pswitch_16
    new-instance p0, Lps/y;

    invoke-direct {p0}, Lps/y;-><init>()V

    return-object p0

    :pswitch_17
    new-instance p0, Lps/z;

    invoke-direct {p0}, Lps/z;-><init>()V

    return-object p0

    :pswitch_18
    new-instance p0, Lps/x;

    invoke-direct {p0}, Lps/x;-><init>()V
