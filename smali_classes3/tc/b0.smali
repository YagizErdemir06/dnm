...
.method public E0(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Ltc/b0;->b0(Ltc/b0$k;Ltc/p;)Ltc/b0$k;
...
.method public G()Llc/j;
    ...
    invoke-virtual {p0}, Ltc/b0;->B()Ltc/i;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, Ltc/b0;->A()Ltc/f;
    ...
    :cond_2
    invoke-virtual {p0}, Ltc/b0;->y()Ltc/l;

    move-result-object v0

    if-nez v0, :cond_4

    invoke-virtual {p0}, Ltc/b0;->I()Ltc/i;
...
.method public H()Ljava/lang/Class;
    ...
    invoke-virtual {p0}, Ltc/b0;->G()Llc/j;
...
.method public O()Z
    ...
    invoke-virtual {p0, v0}, Ltc/b0;->X(Ltc/b0$k;)Z
...
.method public bridge synthetic U(Llc/y;)Ltc/s;
    .locals 0
...
.method public bridge synthetic V(Ljava/lang/String;)Ltc/s;
    .locals 0
...
.method public final X(Ltc/b0$k;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final a0(Ltc/b0$k;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final b0(Ltc/b0$k;Ltc/p;)Ltc/b0$k;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, v1, p2}, Ltc/b0;->b0(Ltc/b0$k;Ltc/p;)Ltc/b0$k;
...
.method public final c0(Ljava/util/Collection;Ljava/util/Map;Ltc/b0$k;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public j0(Llc/x;)Llc/x;
    ...
    invoke-virtual {p0}, Ltc/b0;->F()Ltc/h;
    ...
    :cond_3
    invoke-virtual {p0}, Ltc/b0;->H()Ljava/lang/Class;
...
.method public w0()Z
    ...
    invoke-virtual {p0, v0}, Ltc/b0;->a0(Ltc/b0$k;)Z
...
.method public y0(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, p1, v0, v1}, Ltc/b0;->c0(Ljava/util/Collection;Ljava/util/Map;Ltc/b0$k;)V
