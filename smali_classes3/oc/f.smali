...
.method public n0(Llc/g;Llc/c;Loc/e;)V
    ...
    invoke-virtual {v1}, Ltc/s;->t()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1}, Ltc/s;->G()Llc/j;
...
.method public o0(Llc/g;Llc/c;Loc/e;)V
    ...
    invoke-virtual {v1}, Ltc/s;->N()Z

    move-result v2

    if-eqz v2, :cond_8

    invoke-virtual {v1}, Ltc/s;->I()Ltc/i;
    ...
    :cond_8
    invoke-virtual {v1}, Ltc/s;->K()Z

    move-result v2

    if-eqz v2, :cond_9

    invoke-virtual {v1}, Ltc/s;->A()Ltc/f;
    ...
    :cond_9
    invoke-virtual {v1}, Ltc/s;->B()Ltc/i;
    ...
    :cond_11
    invoke-virtual {v1}, Ltc/s;->v()[Ljava/lang/Class;
...
.method public u0(Llc/g;Llc/j;Llc/c;)Llc/k;
    ...
    invoke-static {v2, v1, v3}, Ldd/y;->X(Lnc/i;Ltc/h;Llc/y;)Ldd/y;
...
.method public x0(Llc/g;Llc/c;Ltc/s;Llc/j;)Loc/v;
    ...
    invoke-virtual {p3}, Ltc/s;->E()Ltc/h;
    ...
    :cond_3
    invoke-virtual {p3}, Ltc/s;->u()Llc/b$a;
    ...
    :cond_4
    invoke-virtual {p3}, Ltc/s;->s()Ltc/z;
...
.method public y0(Llc/g;Llc/c;Ltc/s;)Loc/v;
    ...
    invoke-virtual {p3}, Ltc/s;->B()Ltc/i;
...
.method public z0(Llc/g;Llc/c;Loc/e;Ljava/util/List;Ljava/util/Set;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Ltc/s;->H()Ljava/lang/Class;
