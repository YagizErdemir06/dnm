...
.method public static synthetic Aq(Landroid/net/Uri;)V
    .locals 0

    invoke-static {p0}, Ls4/s;->Tq(Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic Bq(Lv8/c0;)V
    .locals 0

    invoke-static {p0}, Ls4/s;->Xq(Lv8/c0;)V

    return-void
.end method

.method public static synthetic Cq(Ls4/s;Lsb/g;)V
    .locals 0

    invoke-direct {p0, p1}, Ls4/s;->Sq(Lsb/g;)V

    return-void
.end method

.method public static synthetic Dq(Ls4/s;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Ls4/s;->br(Ljava/lang/String;Landroid/graphics/Bitmap;)V

    return-void
.end method

.method public static synthetic Eq(Lv8/n1;)V
    .locals 0

    invoke-static {p0}, Ls4/s;->dr(Lv8/n1;)V

    return-void
.end method

.method public static synthetic Fq(Ls4/s;Landroid/graphics/Bitmap;[FLrb/c;Lv8/d;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Ls4/s;->Zq(Landroid/graphics/Bitmap;[FLrb/c;Lv8/d;)V

    return-void
.end method

.method public static synthetic Gq(Ls4/s;)V
    .locals 0

    invoke-direct {p0}, Ls4/s;->Yq()V

    return-void
.end method

.method public static synthetic Hq(Landroid/net/Uri;)V
    .locals 0
...
.method public static synthetic Iq(Lcom/android/camera/Camera;)V
    .locals 0

    invoke-static {p0}, Ls4/s;->Wq(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Jq(Lcom/android/camera/Camera;)V
    .locals 0

    invoke-static {p0}, Ls4/s;->cr(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Kq(Ls4/s;Landroid/graphics/Bitmap;[FLrb/c;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Ls4/s;->ar(Landroid/graphics/Bitmap;[FLrb/c;)V

    return-void
.end method

.method public static synthetic Lq(Ls4/s;Lya/o5;)V
    .locals 0

    invoke-direct {p0, p1}, Ls4/s;->Vq(Lya/o5;)V
...
.method private synthetic Sq(Lsb/g;)V
    .locals 3
    ...
    iput-object v1, p0, Lq7/l2;->ta:Lsb/g$a;

    invoke-static {}, Lil/c;->g()Lil/c;

    move-result-object p0

    invoke-virtual {p0}, Lil/c;->m()V

    return-void
.end method

.method public static synthetic Tq(Landroid/net/Uri;)V
    .locals 2
...
.method public static synthetic Uq()V
    .locals 1
...
.method private synthetic Vq(Lya/o5;)V
    .locals 0
...
.method public static synthetic Wq(Lcom/android/camera/Camera;)V
    .locals 1
...
.method public static synthetic Xq(Lv8/c0;)V
    .locals 1
...
.method private synthetic Zq(Landroid/graphics/Bitmap;[FLrb/c;Lv8/d;)V
    .locals 2
    ...
    invoke-interface {p4, p1, p2, v0, p3}, Lv8/d;->D8(Landroid/graphics/Bitmap;[FLandroid/util/Size;Ljava/lang/Runnable;)V

    return-void
.end method

.method private synthetic ar(Landroid/graphics/Bitmap;[FLrb/c;)V
    .locals 2
...
.method private synthetic br(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 4
    ...
    invoke-static {p2, p1, v3, v1}, Lcom/android/camera/a6;->p4(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;)Z
...
.method public static synthetic cr(Lcom/android/camera/Camera;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/android/camera/ActivityBase;->Fj(Z)V

    return-void
.end method

.method public static synthetic dr(Lv8/n1;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p0, v0}, Lv8/d1;->setSkipDrawFace(Z)V

    const/4 v0, 0x0

    invoke-interface {p0, v0}, Lv8/d1;->setPinFace(Z)V
...
.method public Fo(Lya/o5;)V
    ...
    iget-object v0, p0, Lq7/l2;->ta:Lsb/g$a;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Ls4/s;->er(Lsb/g$a;)V
...
.method public final Oq(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V
    .locals 5
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/camera/a6;->b4(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {p3}, Lcom/android/camera/ActivityBase;->Qj()Z

    move-result p1

    if-eqz p1, :cond_3

    invoke-static {v1, v2}, Lcom/android/camera/s2;->Y(Landroid/content/Intent;Z)V

    :cond_3
    const p1, 0x8c35

    invoke-static {p3, v1, p1}, Lcom/android/camera/a6;->N4(Landroid/app/Activity;Landroid/content/Intent;I)Z
    ...
    invoke-virtual {p3, p0}, Lcom/android/camera/ActivityBase;->Ej(I)V
...
.method public Um(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2}, Lq7/l2;->Um(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Lm2/h1;->R()Lm2/l;
    ...
    invoke-virtual {p0, p1, p2, v0}, Ls4/s;->Oq(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V

    :cond_2
    iput-boolean v1, p0, Lq7/l2;->da:Z
    ...
    invoke-static {p2, v0}, Leg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public aq()V
    ...
    invoke-static {v1, p0}, Lwa/a;->s(FZ)Z
...
.method public final er(Lsb/g$a;)V
    .locals 13
    ...
    invoke-virtual {p0, v10}, Lq7/l2;->e0(I)V
    ...
    invoke-static {p1}, Lil/c;->f(Ljava/lang/String;)Lil/a$b;

    move-result-object v6

    const/4 v7, 0x0

    iget-object v8, p0, Lq7/l2;->Ja:Lil/a$f;

    move-object v5, v9

    invoke-virtual/range {v1 .. v8}, Lil/c;->d([BII[FLil/a$b;ZLil/a$f;)Landroid/graphics/Bitmap;
    ...
    iget-object v4, p0, Lq7/l2;->Ja:Lil/a$f;

    invoke-virtual {v1, v9, v2, v3, v4}, Lil/c;->r([FIILil/a$f;)[F
    ...
    invoke-virtual {v0, v10}, Lcom/android/camera/f3;->b(Z)I
    ...
    invoke-direct/range {v2 .. v7}, Lye/w;-><init>(IJILjava/lang/String;)V

    invoke-virtual {v9, v8}, Lye/w;->Y0(Z)V
    ...
    invoke-virtual {v9, v0, v2}, Lye/w;->a([BI)V

    goto :goto_0

    :cond_3
    invoke-virtual {v9, v0, v10}, Lye/w;->a([BI)V
    ...
    invoke-direct {v0, v2, v3, v4, p1}, Lye/x$b;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-virtual {v0, p1}, Lye/x$b;->C(I)Lye/x$b;
    ...
    invoke-virtual {v9, p1}, Lye/w;->b(Lye/x;)V

    invoke-static {}, Lid/b;->q2()Lid/b;

    move-result-object p1

    invoke-virtual {p1}, Lid/b;->mb()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-virtual {v9, v8}, Lye/w;->k1(Z)V
    ...
    invoke-virtual {p0, v9, p1, p1, p1}, Ll9/h;->i(Lye/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public fm(I)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/f3;->b(Z)I
...
.method public rm()V
    ...
    invoke-interface {v0, v1}, Lv8/c0;->F4(Z)V
...
.method public sm()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lq7/l2;->Sl(Z)V

    return-object v0

    :cond_0
    invoke-super {p0}, Lq7/l2;->sm()Ljava/lang/String;
...
.method public w0(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p3}, Ls4/s;->Um(Landroid/net/Uri;Ljava/lang/String;)V
