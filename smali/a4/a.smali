...
.method public a(II)V
    ...
    invoke-direct {v0, p1, p2}, Lvl/b;-><init>(II)V

    iput-object v0, p0, La4/a;->e:Lvl/b;
...
.method public b(Lcom/android/camera/effect/renders/b0;IIIIII)V
    ...
    invoke-virtual {p0}, Lam/h;->m()Lyl/h;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lyl/h;->x(F)V
    ...
    invoke-virtual {v0, v3, v4}, Lyl/h;->D(FF)V

    neg-int p4, p4

    int-to-float p4, p4

    invoke-virtual {v0, p4, v1, v1, v2}, Lyl/h;->v(FFFF)V
    ...
    invoke-virtual {v0, p4, v1}, Lyl/h;->D(FF)V

    :cond_0
    sget-object p4, Lwl/e;->w:Lwl/e;

    invoke-virtual {p0, p4}, Lam/h;->g(Lwl/e;)Ldm/q;
    ...
    invoke-virtual {p4, p2, p3}, Ldm/j;->k(Landroid/graphics/Rect;Z)V
    ...
    invoke-static {p2}, Lsg/h;->i(Ljava/lang/String;)I
    ...
    :cond_1
    invoke-virtual {p0}, Lam/h;->k()Lam/a;
    ...
    invoke-virtual {p2, p3}, Lam/a;->i(I)Lam/a;

    move-result-object p2

    invoke-virtual {p2, p5}, Lam/a;->k(I)Lam/a;

    move-result-object p2

    invoke-virtual {p2, p6, p7}, Lam/a;->f(II)Lam/a;

    move-result-object p2

    invoke-virtual {p2}, Lam/a;->a()V

    invoke-virtual {p0}, Lam/h;->y()V
    ...
    invoke-virtual {p0}, Lam/h;->B()V

    invoke-virtual {v0, v2}, Lyl/h;->x(F)V
...
.method public f()Lam/h;
    .locals 3

    iget-object v0, p0, La4/a;->i:Lam/h;
    ...
    iput-object v0, p0, La4/a;->i:Lam/h;

    :cond_0
    iget-object p0, p0, La4/a;->i:Lam/h;
...
.method public h(IIIZLjava/lang/String;IILandroid/util/Size;Lcom/android/camera/effect/b$d;Lt3/q;)Lam/h;
    .locals 13
    ...
    iget-object v2, v0, La4/a;->i:Lam/h;
    ...
    invoke-direct {v2, v3, v4}, Lam/h;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, v0, La4/a;->i:Lam/h;
    ...
    iget-object v4, v0, La4/a;->i:Lam/h;

    sget-object v5, Lwl/e;->t:Lwl/e;

    invoke-virtual {v4, v5, v3}, Lam/h;->h(Lwl/e;Z)Ldm/q;
    ...
    invoke-virtual {p0, v4, v5, v6}, La4/a;->p(Lam/h;Lwl/e;[Ljava/lang/Object;)V
    ...
    sget-object v6, Lwl/e;->e:Lwl/e;

    invoke-virtual {v4, v6}, Lam/h;->g(Lwl/e;)Ldm/q;
    ...
    invoke-virtual {p0, v4, v6, v7}, La4/a;->p(Lam/h;Lwl/e;[Ljava/lang/Object;)V
    ...
    sget-object v5, Lwl/e;->f:Lwl/e;

    invoke-virtual {v4, v5}, Lam/h;->g(Lwl/e;)Ldm/q;
    ...
    :cond_4
    sget v4, Lcom/android/camera/effect/c;->p2:I
    ...
    iget-object v9, v0, La4/a;->i:Lam/h;

    invoke-virtual {v9}, Lam/h;->l()J
    ...
    sget-object v10, Lwl/e;->w:Lwl/e;

    invoke-virtual {v9, v10}, Lam/h;->g(Lwl/e;)Ldm/q;

    :cond_6
    iget-object v9, v0, La4/a;->i:Lam/h;

    sget-object v10, Lwl/e;->h:Lwl/e;
    ...
    invoke-virtual {p0, v9, v10, v11}, La4/a;->p(Lam/h;Lwl/e;[Ljava/lang/Object;)V
    ...
    iget-object v1, v0, La4/a;->i:Lam/h;

    invoke-virtual {v1}, Lam/h;->l()J
    ...
    sget-object v9, Lwl/e;->w:Lwl/e;

    invoke-virtual {v1, v9}, Lam/h;->g(Lwl/e;)Ldm/q;

    :cond_8
    iget-object v1, v0, La4/a;->i:Lam/h;

    sget-object v9, Lwl/e;->i:Lwl/e;
    ...
    invoke-virtual {p0, v1, v9, v6}, La4/a;->p(Lam/h;Lwl/e;[Ljava/lang/Object;)V
    ...
    sget-object v4, Lwl/e;->v:Lwl/e;

    invoke-virtual {v1, v4}, Lam/h;->g(Lwl/e;)Ldm/q;
    ...
    invoke-virtual {p0, v1, v4, v3}, La4/a;->p(Lam/h;Lwl/e;[Ljava/lang/Object;)V
    ...
    sget-object v2, Lwl/e;->w:Lwl/e;

    invoke-virtual {v1, v2}, Lam/h;->g(Lwl/e;)Ldm/q;

    :cond_b
    iget-object v0, v0, La4/a;->i:Lam/h;
...
.method public m(Lsg/a;J)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lam/h;->x(Lsg/a;J)Z
...
.method public o()V
    ...
    invoke-virtual {v0}, Lam/h;->z()V

    iput-object v1, p0, La4/a;->i:Lam/h;

    :cond_3
    return-void
.end method

.method public varargs p(Lam/h;Lwl/e;[Ljava/lang/Object;)V
    .locals 11
    ...
    :cond_1
    new-instance p3, Lxl/e;

    invoke-virtual {p0}, La4/a;->k()Z

    move-result p0

    invoke-direct {p3, p2, p0, v0}, Lxl/e;-><init>(Lwl/e;ZLandroid/graphics/Rect;)V

    invoke-virtual {p1, p3}, Lam/h;->C(Lxl/d;)V
    ...
    iget-object v4, p3, Lt3/q;->s:Ltg/a;
    ...
    invoke-direct/range {v0 .. v9}, Lxl/i;-><init>(Lwl/e;ZLandroid/media/Image;Ltg/a;IILandroid/util/Size;II)V

    invoke-virtual {p1, v10}, Lam/h;->C(Lxl/d;)V
    ...
    invoke-direct {v6, p2}, Lxl/g;-><init>(Lwl/e;)V

    iget-object p2, v6, Lxl/g;->b:Landroid/graphics/RectF;
    ...
    iget-object p2, v6, Lxl/g;->c:Landroid/graphics/PointF;
    ...
    iget-object p2, v6, Lxl/g;->d:Landroid/graphics/PointF;
    ...
    iput p0, v6, Lxl/g;->f:F

    iget p0, v5, Lcom/android/camera/effect/b$d;->d:I

    iput p0, v6, Lxl/g;->e:I

    const/4 p0, 0x0

    iput p0, v6, Lxl/g;->g:F

    iput-boolean v1, v6, Lxl/g;->i:Z

    aget-object p0, p3, v3

    check-cast p0, Landroid/util/Size;

    iput-object p0, v6, Lxl/g;->h:Landroid/util/Size;

    invoke-virtual {p1, v6}, Lam/h;->C(Lxl/d;)V
    ...
    invoke-direct {v0, p2}, Lxl/b;-><init>(Lwl/e;)V
    ...
    iput-object p2, v0, Lxl/b;->b:Ljava/lang/String;
    ...
    iput p2, v0, Lxl/b;->d:I

    iget p2, p0, La4/a;->h:I

    iput p2, v0, Lxl/b;->e:I

    iget p2, p0, La4/a;->f:F

    iput p2, v0, Lxl/b;->g:F

    iget p0, p0, La4/a;->g:F

    iput p0, v0, Lxl/b;->h:F
    ...
    invoke-virtual {v0, p0}, Lxl/b;->c([F)V

    invoke-virtual {p1, v0}, Lam/h;->C(Lxl/d;)V
    ...
    invoke-direct {p0, p2}, Lxl/f;-><init>(Lwl/e;)V
    ...
    invoke-virtual {p1, p0}, Lam/h;->C(Lxl/d;)V
