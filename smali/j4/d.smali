...
.method public static synthetic Aq(Lj4/d;Lu1/m;)V
    .locals 0

    invoke-virtual {p0, p1}, Lj4/d;->Fq(Lu1/m;)V
...
.method public varargs Bi([I)V
    ...
    :cond_0
    invoke-virtual {p0, v2}, Lj4/d;->C6(I)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0}, Lj4/d;->Eq()V
...
.method public final Bq(I)Lu1/m;
    .locals 2
...
.method public final C6(I)V
    ...
    invoke-virtual {p0, p1}, Lj4/d;->Bq(I)Lu1/m;
...
.method public Dm()I
    ...
    invoke-interface {v0}, Lv8/a;->Uh()I
    ...
    invoke-static {p0, v0}, Lcom/android/camera/a6;->j1(II)I
...
.method public Dq(J)V
    ...
    invoke-static {v0}, Lcom/android/camera/v2;->J2(I)Z
...
.method public final Fq(Lu1/m;)V
    .locals 0
    ...
    invoke-interface {p0, p1}, Lv8/a;->ah(Lu1/m;)V
...
.method public Mo(Z)V
    ...
    invoke-interface {p0, v4, v1}, Lcom/android/camera/ui/a1;->Y0(Lwl/e;Z)V
    ...
    :goto_1
    sget-object p1, Lwl/e;->i:Lwl/e;

    invoke-interface {p0, p1, v2}, Lcom/android/camera/ui/a1;->Y0(Lwl/e;Z)V
...
.method public So(Landroid/hardware/camera2/CaptureResult;Lya/s5$b;)V
    ...
    invoke-super {p0, p1, p2}, Lq7/l2;->So(Landroid/hardware/camera2/CaptureResult;Lya/s5$b;)V
    ...
    invoke-virtual {p0, p1, p2}, Lj4/d;->Dq(J)V
...
.method public Yo(I)Z
    ...
    invoke-virtual {p0}, Lj4/d;->Cp()Z

    move-result p1

    if-nez p1, :cond_1

    invoke-virtual {p0}, Lj4/d;->tn()Z
