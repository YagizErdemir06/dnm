...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/l3;->c:Z

    new-instance v0, Lcom/android/camera/l3$a;

    invoke-direct {v0, p0}, Lcom/android/camera/l3$a;-><init>(Lcom/android/camera/l3;)V

    iput-object v0, p0, Lcom/android/camera/l3;->f:Landroid/content/ServiceConnection;

    new-instance v0, Lcom/android/camera/j3;

    invoke-direct {v0, p0}, Lcom/android/camera/j3;-><init>(Lcom/android/camera/l3;)V

    iput-object v0, p0, Lcom/android/camera/l3;->g:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/camera/k3;

    invoke-direct {v0, p0}, Lcom/android/camera/k3;-><init>(Lcom/android/camera/l3;)V

    iput-object v0, p0, Lcom/android/camera/l3;->h:Ljava/lang/Runnable;
...
.method public static synthetic a(Lcom/android/camera/l3;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/l3;->u()V

    return-void
.end method

.method public static synthetic b(Lcom/android/camera/l3;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/l3;->t()V
...
.method public static l(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {p1, p0}, Lcom/android/camera/a6;->w3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
...
.method private synthetic t()V
    ...
    iget-boolean v2, p0, Lcom/android/camera/l3;->c:Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/l3;->k()V

    iget-boolean v1, p0, Lcom/android/camera/l3;->c:Z
    ...
    invoke-virtual {v1, v2, v4}, Lye/d;->a(II)Z
    ...
    iget-object v2, p0, Lcom/android/camera/l3;->f:Landroid/content/ServiceConnection;
...
.method private synthetic u()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/l3;->j()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/l3;->f:Landroid/content/ServiceConnection;
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/camera/l3;->c:Z
...
# virtual methods
.method public final A(Lcom/android/camera/Camera;Lcom/android/camera/m5;Landroid/net/Uri;)Z
    .locals 5
    ...
    invoke-virtual {p2}, Lcom/android/camera/m5;->G()Z
    ...
    invoke-virtual {p0, p3}, Lcom/android/camera/l3;->h(Landroid/net/Uri;)Z
    ...
    invoke-static {p3, p0}, Lcom/android/camera/a6;->w3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
...
.method public final c(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/l3;->o()Lcom/android/camera/p2;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/camera/p2;->d()F
    ...
    invoke-virtual {p0}, Lcom/android/camera/p2;->d()F
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/ActivityBase;->Bj(I)V

    :cond_1
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->si()I
...
.method public final d(Lcom/android/camera/m5;Landroid/content/Intent;)V
    .locals 5

    invoke-virtual {p1}, Lcom/android/camera/m5;->F()Z

    move-result p0

    if-eqz p0, :cond_2

    invoke-virtual {p1}, Lcom/android/camera/m5;->r()I
    ...
    invoke-virtual {p1}, Lcom/android/camera/m5;->q()I
...
.method public final e(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->Qj()Z
    ...
    :cond_0
    invoke-static {p2, v0}, Lcom/android/camera/s2;->Y(Landroid/content/Intent;Z)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/a6;->x2(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final f(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/l3;->p(Ljava/util/ArrayList;)[J
...
.method public g(J)V
    ...
    iget-object v1, p0, Lcom/android/camera/l3;->g:Ljava/lang/Runnable;

    invoke-static {v0, v1, p1, p2}, Leg/i;->s(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/l3;->d:Lio/reactivex/disposables/Disposable;
    ...
    iget-object p0, p0, Lcom/android/camera/l3;->g:Ljava/lang/Runnable;

    invoke-static {p1, p0}, Leg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public final i(Lcom/android/camera/Camera;Lcom/android/camera/m5;Landroid/net/Uri;)Landroid/content/Intent;
    .locals 3

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/l3;->n(Lcom/android/camera/Camera;Landroid/net/Uri;)Landroid/content/Intent;

    move-result-object p3

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/l3;->c(Lcom/android/camera/Camera;Landroid/content/Intent;)V

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/l3;->e(Lcom/android/camera/Camera;Landroid/content/Intent;)V

    if-eqz p2, :cond_0

    invoke-virtual {p0, p2, p3}, Lcom/android/camera/l3;->d(Lcom/android/camera/m5;Landroid/content/Intent;)V

    :cond_0
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/l3;->f(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/m5;->p()J
...
.method public final j()V
    ...
    iget-object v0, p0, Lcom/android/camera/l3;->d:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lcom/android/camera/l3;->d:Lio/reactivex/disposables/Disposable;
...
.method public final k()V
    ...
    iget-object v0, p0, Lcom/android/camera/l3;->e:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lcom/android/camera/l3;->e:Lio/reactivex/disposables/Disposable;
...
.method public final m(Lcom/android/camera/Camera;)V
    ...
    sget-boolean p0, Lcom/android/camera/a6;->u0:Z
...
.method public final o()Lcom/android/camera/p2;
    .locals 0
...
.method public q(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/ThumbnailUpdater;->n()Lcom/android/camera/m5;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0, v1}, Lcom/android/camera/l3;->y(Lcom/android/camera/Camera;Lcom/android/camera/m5;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/l3;->m(Lcom/android/camera/Camera;)V
...
.method public r(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/l3;->w(Lcom/android/camera/Camera;)V

    const/4 v2, 0x0

    invoke-virtual {p0, p1, v2, p2}, Lcom/android/camera/l3;->i(Lcom/android/camera/Camera;Lcom/android/camera/m5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/ActivityBase;->Ej(I)V
...
.method public final s(Ljava/lang/Exception;Landroid/net/Uri;Lcom/android/camera/Camera;Lcom/android/camera/m5;)V
    .locals 2
    ...
    invoke-virtual {p4}, Lcom/android/camera/m5;->s()Z
    ...
    invoke-virtual {p4}, Lcom/android/camera/m5;->C()Ljava/lang/String;
    ...
    invoke-virtual {p4}, Lcom/android/camera/m5;->B()Ljava/lang/String;
...
.method public final v(Lcom/android/camera/m5;Lcom/android/camera/Camera;)V
    .locals 5
    .param p1    # Lcom/android/camera/m5;
    ...
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->Xi()Z
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->z2()Lq7/v4;

    move-result-object p2

    invoke-interface {p2}, Lq7/v4;->Eb()Z
    ...
    invoke-interface {v0, v1, p2}, Lcom/android/camera/ui/a1;->K0(Lwl/a;Z)V

    goto :goto_1

    :cond_2
    sget-object p2, Lwl/a;->g:Lwl/a;

    invoke-interface {v0, p2, v2}, Lcom/android/camera/ui/a1;->b1(Lwl/a;Ljava/lang/Object;)V

    goto :goto_1

    :cond_3
    :goto_0
    sget-object p2, Lwl/a;->a:Lwl/a;

    invoke-interface {v0, p2, v2}, Lcom/android/camera/ui/a1;->b1(Lwl/a;Ljava/lang/Object;)V

    :cond_4
    :goto_1
    iget-object p2, p0, Lcom/android/camera/l3;->b:Landroid/os/Messenger;
    ...
    :cond_5
    invoke-static {}, Lcom/android/camera/b5;->e()Lcom/android/camera/b5;
    ...
    :try_start_0
    invoke-virtual {p1}, Lcom/android/camera/m5;->D()Landroid/net/Uri;
    ...
    invoke-virtual {p2, v1, p1}, Lcom/android/camera/b5;->i(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_6
    :try_start_1
    invoke-virtual {p2}, Lcom/android/camera/b5;->f()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v3, p0, Lcom/android/camera/l3;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p2}, Lcom/android/camera/b5;->g()Landroid/net/Uri;
    ...
    invoke-virtual {p2}, Lcom/android/camera/b5;->c()I
    ...
    invoke-virtual {p2}, Lcom/android/camera/b5;->h()I
    ...
    invoke-virtual {p2}, Lcom/android/camera/b5;->d()I
    ...
    iget-object v2, p0, Lcom/android/camera/l3;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, Lcom/android/camera/l3;->b:Landroid/os/Messenger;
...
.method public final w(Lcom/android/camera/Camera;)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/Camera;->Um()V
...
.method public x(Landroid/os/Messenger;)V
    ...
    iput-object p1, p0, Lcom/android/camera/l3;->b:Landroid/os/Messenger;

    return-void
.end method

.method public final y(Lcom/android/camera/Camera;Lcom/android/camera/m5;)V
    .locals 5

    invoke-virtual {p2}, Lcom/android/camera/m5;->D()Landroid/net/Uri;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera/l3;->A(Lcom/android/camera/Camera;Lcom/android/camera/m5;Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/l3;->v(Lcom/android/camera/m5;Lcom/android/camera/Camera;)V

    invoke-static {p1, v0}, Lcom/android/camera/l3;->l(Lcom/android/camera/Camera;Landroid/net/Uri;)V

    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera/l3;->i(Lcom/android/camera/Camera;Lcom/android/camera/m5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, v1}, Lcom/android/camera/ActivityBase;->Ej(I)V
    ...
    invoke-virtual {p0, v1, v0, p1, p2}, Lcom/android/camera/l3;->s(Ljava/lang/Exception;Landroid/net/Uri;Lcom/android/camera/Camera;Lcom/android/camera/m5;)V
...
.method public z(Z)V
    ...
    iget-object v0, p0, Lcom/android/camera/l3;->h:Ljava/lang/Runnable;

    const-wide/16 v1, 0x2710

    invoke-static {p1, v0, v1, v2}, Leg/i;->s(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/l3;->e:Lio/reactivex/disposables/Disposable;
    ...
    iget-object p0, p0, Lcom/android/camera/l3;->h:Ljava/lang/Runnable;
