...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public constructor <init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/m5;->c:Z

    iput-boolean v0, p0, Lcom/android/camera/m5;->d:Z

    iput-boolean v0, p0, Lcom/android/camera/m5;->e:Z

    iput-boolean v0, p0, Lcom/android/camera/m5;->h:Z

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/camera/m5;->i:I

    iput v1, p0, Lcom/android/camera/m5;->j:I

    const-wide/16 v1, -0x1

    iput-wide v1, p0, Lcom/android/camera/m5;->k:J

    iput-boolean v0, p0, Lcom/android/camera/m5;->l:Z

    iput-object p1, p0, Lcom/android/camera/m5;->a:Landroid/net/Uri;

    invoke-static {p2, p3, p4}, Lcom/android/camera/m5;->a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/m5;->b:Landroid/graphics/Bitmap;
...
.method public static c(Landroid/database/Cursor;)Lcom/android/camera/m5$b;
    .locals 17
    ...
    new-instance v16, Lcom/android/camera/m5$b;
    ...
    invoke-direct/range {v2 .. v14}, Lcom/android/camera/m5$b;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_0
...
.method public static d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcom/android/camera/m5;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V

    return-object v0
.end method

.method public static e([BIILandroid/net/Uri;Z)Lcom/android/camera/m5;
    .locals 4
    ...
    :cond_0
    invoke-static {p0}, Lld/d;->k([B)Lld/e;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lld/e;->M()Landroid/graphics/Bitmap;
    ...
    :cond_3
    invoke-static {p3, v0, p1, p4}, Lcom/android/camera/m5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;
...
.method public static f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/m5;
    .locals 25
    ...
    invoke-static {v6}, Lcom/android/camera/a6;->d1(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v13, v12, v11}, Lcom/android/camera/m5;->A(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    :cond_d
    invoke-static {v6, v13, v12}, Lcom/android/camera/m5;->l(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v7, v4}, Lcom/android/camera/m5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;

    move-result-object v0

    if-eqz v0, :cond_f

    invoke-virtual {v0, v2, v3}, Lcom/android/camera/m5;->J(J)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/m5;->M(Z)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/camera/m5;->j(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
...
.method public static j(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    new-instance p4, Lcom/android/camera/m5$c;

    invoke-direct {p4, p1, v1}, Lcom/android/camera/m5$c;-><init>(Landroid/util/Size;Lcom/android/camera/m5$a;)V
    ...
    invoke-static {p1}, Lmg/c;->a([B)Landroid/graphics/ImageDecoder$Source;
...
.method public static t(Landroid/content/ContentResolver;)Lcom/android/camera/m5$b;
    .locals 11
    ...
    invoke-static {v5}, Lcom/android/camera/m5;->c(Landroid/database/Cursor;)Lcom/android/camera/m5$b;
    ...
    invoke-static {p0}, Lcom/android/camera/m5;->c(Landroid/database/Cursor;)Lcom/android/camera/m5$b;
...
.method public static v(Landroid/content/Context;[Lcom/android/camera/m5;Landroid/net/Uri;Lcom/android/camera/m5$b;)I
    .locals 16
    ...
    invoke-static {v7}, Lcom/android/camera/m5;->t(Landroid/content/ContentResolver;)Lcom/android/camera/m5$b;
    ...
    invoke-static {v0, v1}, Lcom/android/camera/m5;->y(J)Lcom/android/camera/m5;
    ...
    :cond_2
    iget-boolean v4, v2, Lcom/android/camera/m5$b;->i:Z
    ...
    iget-wide v14, v11, Lcom/android/camera/m5$b;->c:J

    invoke-static {v14, v15}, Lcom/android/camera/m5;->y(J)Lcom/android/camera/m5;
    ...
    invoke-virtual {v4}, Lcom/android/camera/m5;->D()Landroid/net/Uri;
    ...
    iget-object v3, v11, Lcom/android/camera/m5$b;->d:Landroid/net/Uri;
    ...
    iget-object v1, v11, Lcom/android/camera/m5$b;->d:Landroid/net/Uri;
    ...
    :cond_6
    iget-object v14, v11, Lcom/android/camera/m5$b;->e:Ljava/lang/String;

    invoke-static {v14}, Lcom/android/camera/a6;->d1(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-wide v2, v11, Lcom/android/camera/m5$b;->a:J

    iget v4, v11, Lcom/android/camera/m5$b;->b:I
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/camera/m5;->z(Landroid/content/Context;JILjava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_7
    iget-wide v0, v11, Lcom/android/camera/m5$b;->a:J
    ...
    iget v0, v11, Lcom/android/camera/m5$b;->f:I

    iget v1, v11, Lcom/android/camera/m5$b;->g:I

    iget v2, v11, Lcom/android/camera/m5$b;->b:I

    invoke-static {v14, v0, v1, v2}, Lcom/android/camera/m5;->A(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v12, Lcom/android/camera/m5$b;->d:Landroid/net/Uri;
    ...
    iget-object v1, v12, Lcom/android/camera/m5$b;->d:Landroid/net/Uri;
    ...
    :cond_a
    iget-object v1, v12, Lcom/android/camera/m5$b;->e:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v10}, Lcom/android/camera/m5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/m5;

    move-result-object v0

    if-eqz v0, :cond_c

    iget-object v0, v0, Lcom/android/camera/m5;->b:Landroid/graphics/Bitmap;
    ...
    :cond_d
    :goto_6
    iget-object v0, v11, Lcom/android/camera/m5$b;->d:Landroid/net/Uri;

    invoke-static {v0, v7}, Lcom/android/camera/a6;->w3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    iget-object v2, v11, Lcom/android/camera/m5$b;->d:Landroid/net/Uri;
    ...
    invoke-static {v0, v1, v10, v10}, Lcom/android/camera/m5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;
    ...
    iget-boolean v1, v11, Lcom/android/camera/m5$b;->h:Z

    if-eqz v1, :cond_e

    invoke-virtual {v0, v13}, Lcom/android/camera/m5;->M(Z)V

    aget-object v0, p1, v10

    iget v1, v11, Lcom/android/camera/m5$b;->f:I

    iget v2, v11, Lcom/android/camera/m5$b;->g:I

    invoke-virtual {v0, v1, v2}, Lcom/android/camera/m5;->L(II)V

    :cond_e
    aget-object v0, p1, v10

    iget-wide v1, v11, Lcom/android/camera/m5$b;->j:J

    invoke-virtual {v0, v1, v2}, Lcom/android/camera/m5;->J(J)V
...
.method public static w(Landroid/content/Context;Landroid/content/ContentResolver;)Lcom/android/camera/m5;
    .locals 18
    ...
    :try_start_0
    sget-object v6, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v8}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V

    invoke-static {v9}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V
    ...
    invoke-static {v6, v1}, Lcom/android/camera/a6;->w3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    sget-object v0, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    sget-object v1, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v6, v0, v1, v1}, Lcom/android/camera/m5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;

    move-result-object v0

    if-eqz v0, :cond_b

    invoke-virtual {v0, v12}, Lcom/android/camera/m5;->M(Z)V

    invoke-virtual {v0, v13, v14}, Lcom/android/camera/m5;->L(II)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/camera/m5;->K(Z)V

    invoke-virtual {v0, v5}, Lcom/android/camera/m5;->N(Z)V

    invoke-virtual {v0, v3, v4}, Lcom/android/camera/m5;->J(J)V
    ...
    :goto_c
    invoke-static {v3}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V
...
.method public static x(Landroid/content/Context;[Lcom/android/camera/m5;Ljava/util/ArrayList;Landroid/net/Uri;)I
    .locals 5
    ...
    invoke-static {v3, v4}, Lcom/android/camera/a6;->w3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    :cond_1
    invoke-static {p0, v3, v0}, Lcom/android/camera/m5;->f(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/m5;
...
.method public static y(J)Lcom/android/camera/m5;
    .locals 6
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/android/camera/m5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/m5;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/m5;->J(J)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public B()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/camera/m5;->g:Ljava/lang/String;
...
.method public C()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/camera/m5;->f:Ljava/lang/String;
...
.method public D()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lcom/android/camera/m5;->a:Landroid/net/Uri;
...
.method public E()Z
    ...
    iget-object v1, p0, Lcom/android/camera/m5;->a:Landroid/net/Uri;
    ...
    iget-boolean v1, p0, Lcom/android/camera/m5;->l:Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/m5;->l:Z
...
.method public F()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/m5;->e:Z
...
.method public G()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/m5;->d:Z
...
.method public H(Ljava/io/File;)V
    ...
    iget-object v0, p0, Lcom/android/camera/m5;->a:Landroid/net/Uri;
    ...
    :try_start_0
    sget-object v3, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_3
    iget-object p1, p0, Lcom/android/camera/m5;->a:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lcom/android/camera/m5;->F()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/m5;->r()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/m5;->q()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/m5;->p()J
    ...
    invoke-virtual {p0}, Lcom/android/camera/m5;->s()Z
    ...
    iget-object p0, p0, Lcom/android/camera/m5;->b:Landroid/graphics/Bitmap;
    ...
    invoke-static {v4}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V

    invoke-static {v5}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V
    ...
    invoke-static {p1}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V

    invoke-static {v5}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V

    invoke-static {v6}, Lcom/android/camera/a6;->F(Ljava/io/Closeable;)V

    sget-object p0, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    sget-object p1, Lcom/android/camera/m5;->r:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public J(J)V
    ...
    iput-wide p1, p0, Lcom/android/camera/m5;->k:J
...
.method public K(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/m5;->c:Z
...
.method public L(II)V
    ...
    iput p1, p0, Lcom/android/camera/m5;->i:I

    iput p2, p0, Lcom/android/camera/m5;->j:I
...
.method public M(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/m5;->e:Z
...
.method public N(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/m5;->h:Z
...
.method public O(J)V
    ...
    iput-object v0, p0, Lcom/android/camera/m5;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/camera/m5;->g:Ljava/lang/String;
...
.method public P(Landroid/net/Uri;)V
    ...
    iput-boolean v2, p0, Lcom/android/camera/m5;->d:Z
...
.method public m()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/m5;->c:Z
...
.method public p()J
    ...
    iget-wide v0, p0, Lcom/android/camera/m5;->k:J
...
.method public q()I
    ...
    iget p0, p0, Lcom/android/camera/m5;->j:I
...
.method public r()I
    ...
    iget p0, p0, Lcom/android/camera/m5;->i:I
...
.method public s()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/m5;->h:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/m5;->b:Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, p0, Lcom/android/camera/m5;->c:Z
    ...
    iget-boolean v1, p0, Lcom/android/camera/m5;->d:Z
    ...
    iget-boolean v1, p0, Lcom/android/camera/m5;->e:Z
    ...
    iget v1, p0, Lcom/android/camera/m5;->i:I
    ...
    iget v1, p0, Lcom/android/camera/m5;->j:I
