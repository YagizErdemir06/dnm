...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/s2$e;,
        Lcom/android/camera/s2$g;,
        Lcom/android/camera/s2$f;,
        Lcom/android/camera/s2$c;,
        Lcom/android/camera/s2$b;,
        Lcom/android/camera/s2$d;,
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/s2;->e:Ljava/util/WeakHashMap;
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/android/camera/s2;->c:Ljava/lang/Boolean;

    iput-object p1, p0, Lcom/android/camera/s2;->a:Landroid/content/Intent;

    invoke-virtual {p0, p1}, Lcom/android/camera/s2;->U(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/s2;->b:Landroid/net/Uri;
...
.method public static N(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/android/camera/s2;->o(Landroid/content/Intent;)I
...
.method public static V()V
    ...
    sget-object v0, Lcom/android/camera/s2;->e:Ljava/util/WeakHashMap;
...
.method public static l(Landroid/content/Intent;)Lcom/android/camera/s2;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/s2;-><init>(Landroid/content/Intent;)V

    sget-object v1, Lcom/android/camera/s2;->e:Ljava/util/WeakHashMap;

    invoke-virtual {v1, p0, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CameraIntentManager"

    invoke-static {v1, p0}, Lcom/android/camera/s2$e;->a(Ljava/lang/String;Landroid/content/Intent;)V
...
.method public G(Landroid/app/Activity;)Z
    ...
    iget-object v0, p0, Lcom/android/camera/s2;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcom/android/camera/s2;->d()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/camera/s2;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/s2;->x(Landroid/app/Activity;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/camera/s2;->F()Z
    ...
    :cond_6
    iget-object p1, p0, Lcom/android/camera/s2;->a:Landroid/content/Intent;
...
.method public a()Z
    ...
    iget-object v0, p0, Lcom/android/camera/s2;->c:Ljava/lang/Boolean;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, Lcom/android/camera/s2;->c:Ljava/lang/Boolean;
...
.method public b(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/s2;->z()Z
...
.method public c()V
    ...
    iget-object v1, p0, Lcom/android/camera/s2;->a:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Ljava/util/WeakHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/camera/s2;->b:Landroid/net/Uri;
...
.method public d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/camera/s2;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/camera/s2;->a:Landroid/content/Intent;

    invoke-virtual {p0, v0}, Lcom/android/camera/s2;->U(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/s2;->b:Landroid/net/Uri;
...
.method public f()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/camera/s2;->M()Z
...
.method public g()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/s2;->f()Ljava/lang/String;
...
.method public w()Ljava/lang/Boolean;
    ...
    invoke-virtual {p0}, Lcom/android/camera/s2;->e()I
...
.method public final x(Landroid/app/Activity;)Z
    ...
    invoke-static {}, Lcom/android/camera/s3;->b()Lcom/android/camera/s3;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/camera/s3;->a()I
