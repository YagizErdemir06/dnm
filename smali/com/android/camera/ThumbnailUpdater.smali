...
# interfaces
.implements Lcom/android/camera/r5;
...
# instance fields
.field public a:Lcom/android/camera/m5;
...
.method public static synthetic e(Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/m5;ZZZ)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->v(Lcom/android/camera/m5;ZZZ)V
...
.method public static j(Z)Landroid/net/Uri;
    ...
    :goto_0
    invoke-static {}, Lcom/android/camera/v2;->f1()Z
...
.method private synthetic r(ZIZ)V
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/m5;

    invoke-interface {v0, p0, p1, p2, p3}, Lv8/d;->P2(Lcom/android/camera/m5;ZIZ)V
...
.method public k()V
    ...
    iget-object v4, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/m5;

    const/4 v5, 0x1

    invoke-direct {v1, v5, v3, p0, v4}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/m5;)V
...
.method public l(Z)V
    ...
    iget-object v8, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/m5;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/m5;)V
...
.method public n()Lcom/android/camera/m5;
    .locals 0
...
.method public t()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/m5;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lcom/android/camera/m5;->m()Z
    ...
    new-array v3, v3, [Lcom/android/camera/m5;
...
.method public u(Lcom/android/camera/m5;ZZ)V
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/camera/ThumbnailUpdater;->v(Lcom/android/camera/m5;ZZZ)V

    return-void
.end method

.method public final v(Lcom/android/camera/m5;ZZZ)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/m5;
...
.method public x()V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/camera/ThumbnailUpdater$a;-><init>(Landroid/os/Handler;Lcom/android/camera/r5;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/camera/ThumbnailUpdater$b;-><init>(Landroid/os/Handler;Lcom/android/camera/r5;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/o5;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public y(ZZ)V
    ...
    new-instance v2, Lcom/android/camera/p5;

    invoke-direct {v2, p0, p1, v0, p2}, Lcom/android/camera/p5;-><init>(Lcom/android/camera/ThumbnailUpdater;ZIZ)V
