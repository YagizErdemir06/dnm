...
.method public static constructor <clinit>()V
    ...
    sput v0, Lcom/android/camera/y2;->g:I
    ...
    sput v0, Lcom/android/camera/y2;->h:I
...
.method public a()V
    ...
    iput v0, p0, Lcom/android/camera/y2;->f:I
...
.method public d(Lcom/android/gallery3d/ui/h;Lcom/android/gallery3d/ui/l;)Z
    ...
    iget-wide v5, v0, Lcom/android/camera/y2;->a:J
    ...
    invoke-virtual {v5}, Lm2/h1;->A0()Llb/m;
    ...
    :goto_0
    iget v7, v0, Lcom/android/camera/y2;->f:I
    ...
    :cond_1
    sget v9, Lcom/android/camera/y2;->g:I
    ...
    sget v7, Lcom/android/camera/y2;->h:I
    ...
    :cond_3
    sget v10, Lcom/android/camera/y2;->g:I
    ...
    :goto_3
    iget v11, v0, Lcom/android/camera/y2;->f:I

    const/4 v12, 0x2

    if-ne v11, v9, :cond_7

    sget v11, Lcom/android/camera/y2;->h:I
    ...
    iget v4, v0, Lcom/android/camera/y2;->d:F

    float-to-int v4, v4

    iget v5, v0, Lcom/android/camera/y2;->e:F

    float-to-int v5, v5

    iget v6, v0, Lcom/android/camera/y2;->b:I

    iget v0, v0, Lcom/android/camera/y2;->c:I
    ...
    iget v11, v0, Lcom/android/camera/y2;->b:I

    iget v12, v0, Lcom/android/camera/y2;->c:I
    ...
    iget v3, v0, Lcom/android/camera/y2;->d:F

    float-to-int v12, v3

    iget v3, v0, Lcom/android/camera/y2;->e:F

    float-to-int v13, v3

    iget v14, v0, Lcom/android/camera/y2;->b:I

    iget v15, v0, Lcom/android/camera/y2;->c:I
    ...
    iget v10, v0, Lcom/android/camera/y2;->b:I

    iget v11, v0, Lcom/android/camera/y2;->c:I
    ...
    iget v13, v0, Lcom/android/camera/y2;->b:I

    iget v14, v0, Lcom/android/camera/y2;->c:I
...
.method public e(Lcom/android/gallery3d/ui/h;Lcom/android/gallery3d/ui/l;)V
    ...
    iget v1, p0, Lcom/android/camera/y2;->d:F

    float-to-int v1, v1

    iget v2, p0, Lcom/android/camera/y2;->e:F

    float-to-int v2, v2

    iget v3, p0, Lcom/android/camera/y2;->b:I

    iget p0, p0, Lcom/android/camera/y2;->c:I
...
.method public f(IIII)V
    ...
    iput-wide v0, p0, Lcom/android/camera/y2;->a:J

    iput p3, p0, Lcom/android/camera/y2;->b:I

    iput p4, p0, Lcom/android/camera/y2;->c:I

    int-to-float p1, p1

    iput p1, p0, Lcom/android/camera/y2;->d:F

    int-to-float p1, p2

    iput p1, p0, Lcom/android/camera/y2;->e:F
