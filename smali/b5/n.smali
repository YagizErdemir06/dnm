...
.method public static synthetic Aq(Lb5/n;I)V
    .locals 0

    invoke-direct {p0, p1}, Lb5/n;->Oq(I)V
...
.method public static synthetic Bq(Landroid/net/Uri;)V
    ...
    invoke-static {p0}, Lb5/n;->Pq(Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic Cq(Lcom/android/camera/Camera;)V
    .locals 0

    invoke-static {p0}, Lb5/n;->Uq(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Dq(Lb5/n;ILv8/v1;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lb5/n;->Nq(ILv8/v1;)V
...
.method public static synthetic Eq()V
    ...
    invoke-static {}, Lb5/n;->Tq()V

    return-void
.end method

.method public static synthetic Fq(Lb5/n;Lv8/a1;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lb5/n;->Rq(Lv8/a1;)Ljava/lang/String;
...
.method public static synthetic Gq(Lv8/n1;)V
    .locals 0

    invoke-static {p0}, Lb5/n;->Vq(Lv8/n1;)V
...
.method public static synthetic Iq(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Lb5/n;->Qq(Landroid/net/Uri;Landroid/net/Uri;)V

    return-void
.end method

.method private synthetic Nq(ILv8/v1;)V
    .locals 0

    invoke-interface {p2, p1}, Lv8/v1;->P3(I)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lq7/i0;->Pj(Z)V

    return-void
.end method

.method private synthetic Oq(I)V
    .locals 2
...
.method public static synthetic Qq(Landroid/net/Uri;Landroid/net/Uri;)V
    .locals 2
...
.method private synthetic Rq(Lv8/a1;)Ljava/lang/String;
    .locals 3
    ...
    invoke-interface {p1}, Lv8/a1;->A6()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lq7/l2;->Sl(Z)V

    return-object p1
.end method

.method public static synthetic Sq()V
    .locals 2
...
.method public static synthetic Tq()V
    .locals 1
...
.method public static synthetic Uq(Lcom/android/camera/Camera;)V
    .locals 1
...
.method public static synthetic Vq(Lv8/n1;)V
    .locals 1
...
.method public final Jq([Ljava/lang/String;Lcom/android/camera/Camera;)V
    .locals 8
    ...
    invoke-virtual {v1, v2}, Lm2/h1;->u0(I)I
    ...
    invoke-static {v3}, Lcom/android/camera/a6;->b4(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->Qj()Z

    move-result p1

    if-eqz p1, :cond_3

    invoke-static {v2, v4}, Lcom/android/camera/s2;->Y(Landroid/content/Intent;Z)V

    :cond_3
    const p1, 0x8c35

    invoke-static {p2, v2, p1}, Lcom/android/camera/a6;->N4(Landroid/app/Activity;Landroid/content/Intent;I)Z
    ...
    invoke-virtual {p2, p1}, Lcom/android/camera/ActivityBase;->Ej(I)V
...
.method public final Kq(Lcom/android/camera/Camera;Landroid/net/Uri;Ljava/lang/String;)Z
    .locals 1
...
.method public final Lq()V
    ...
    invoke-static {p0, v2}, Leg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public Um(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, p1, p2}, Lb5/n;->Kq(Lcom/android/camera/Camera;Landroid/net/Uri;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p2, v1}, Lb5/n;->Jq([Ljava/lang/String;Lcom/android/camera/Camera;)V
...
.method public w0(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p3}, Lb5/n;->Um(Landroid/net/Uri;Ljava/lang/String;)V
