...
.method public constructor <init>(Ll4/c0;)V
    ...
    invoke-interface {p0}, Lv8/m0;->registerProtocol()V

    iget-object p0, p1, Lq7/i0;->b:Lr7/m;
    ...
    invoke-interface {p0}, Lv8/d1;->recreateFaceAnimationView()V
...
.method public Gb(F)V
    ...
    invoke-interface {p1}, Lr7/h;->t()Lcom/android/camera/fragment/beauty/e0;

    move-result-object p1

    invoke-virtual {p0, p1}, Ll4/c0$b;->b(Lcom/android/camera/fragment/beauty/e0;)V
...
.method public a7()V
    ...
    invoke-virtual {p0, v0, v0}, Ll4/c0;->Vm(ZZ)V

    return-void
.end method

.method public b(Lcom/android/camera/fragment/beauty/e0;)V
    .locals 2
    ...
    invoke-direct {v0, p1, v1}, Lcom/android/camera/fragment/beauty/e0;-><init>(Lcom/android/camera/fragment/beauty/e0;F)V
    ...
    invoke-virtual {p0, v0}, Lya/b3;->x3(Lcom/android/camera/fragment/beauty/e0;)V
...
.method public d9()V
    ...
    invoke-interface {p0}, Lv8/m0;->unRegisterProtocol()V

    iget-object v0, p0, Ll4/c0$b;->b:Ll4/c0;

    const/4 v1, 0x0

    invoke-static {v0, v1}, Ll4/c0;->Uq(Ll4/c0;Ll4/c0$b;)Ll4/c0$b;
    ...
    invoke-virtual {v0, v1, v2}, Ll4/c0;->Vm(ZZ)V
    ...
    invoke-virtual {v1}, Lq7/i0;->M9()Lr7/h;
