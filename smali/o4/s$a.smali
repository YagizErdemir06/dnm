...
# direct methods
.method public constructor <init>(Lo4/s;Lq7/i0;)V
    .locals 0

    iput-object p1, p0, Lo4/s$a;->b:Lo4/s;

    invoke-direct {p0, p2}, La8/s;-><init>(Lq7/i0;)V
...
.method public z8([Lya/f3;Lv7/e;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v1}, Lcom/android/camera/ui/a1;->G0()Z
    ...
    invoke-static {v3}, Lo4/s;->Nq(Lo4/s;)J
    ...
    invoke-static {v3, v1, v2}, Lo4/s;->Oq(Lo4/s;J)J
    ...
    invoke-virtual {v1}, Lo4/s;->hg()Lwa/w;

    move-result-object v1

    invoke-virtual {v1}, Lwa/w;->eb()Landroid/util/Range;
