...
.method public static synthetic Aq(Lya/a;)V
    .locals 0

    invoke-static {p0}, Lo5/k;->Fq(Lya/a;)V

    return-void
.end method

.method public static synthetic Bq(Lo5/k;Lcom/android/camera/Camera;)V
    .locals 0

    invoke-direct {p0, p1}, Lo5/k;->Gq(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Cq(Lo5/k;)Z
    .locals 0
...
.method public static synthetic Fq(Lya/a;)V
    .locals 1
...
.method private synthetic Gq(Lcom/android/camera/Camera;)V
    .locals 0
...
.method public varargs Bi([I)V
    ...
    :pswitch_0
    invoke-virtual {p0}, Lo5/k;->Lq()V

    goto :goto_1

    :pswitch_1
    invoke-virtual {p0}, Lo5/k;->Kq()V

    goto :goto_1

    :pswitch_2
    invoke-virtual {p0}, Lo5/k;->Nq()V

    goto :goto_1

    :pswitch_3
    invoke-virtual {p0}, Lo5/k;->Mq()V

    goto :goto_1

    :cond_0
    invoke-virtual {p0}, Lo5/k;->Jq()V
...
.method public Bp(Z)Z
    ...
    invoke-virtual {p0, p1}, Lo5/k;->Yl(Z)Z
...
.method public Dk(Ljava/util/Map;ZLcom/android/camera/fragment/beauty/e0;IZJ)V
    ...
    invoke-virtual {p0, p4, p6, p7}, Lo5/k;->Hq(IJ)V
...
.method public final Hq(IJ)V
    ...
    invoke-static/range {v0 .. v7}, Lk9/a;->w2(Ljava/util/Map;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
...
.method public Nm()Lt7/n1;
    ...
    invoke-direct {v0, p0, p0}, Lo5/k$a;-><init>(Lo5/k;Lq7/v4;)V
...
.method public fg()V
    ...
    invoke-static {v1, p0}, Lcom/android/camera/v2;->h0(ILya/f;)[F
    ...
    invoke-direct {v2, v3, p0}, Lxl/j;-><init>(FF)V

    invoke-interface {v0, v1, v2}, Lcom/android/camera/ui/a1;->L0(Lwl/e;Lxl/d;)V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/a1;->t1(Lwl/e;)V
...
.method public w0(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    iput-boolean p1, p0, Lq7/l2;->da:Z
